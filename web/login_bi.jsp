<%-- 
    Document   : login_bi
    Created on : Oct 13, 2015, 3:52:01 PM
...
if(iCommand==CMD_LOGIN){
	...
	com.dimata.dtaxintegration.session.biadmin.SessUserSession userSess = new com.dimata.dtaxintegration.session.biadmin.SessUserSession(remoteIP );
...
<html class="bg-black">
    <head>
        <meta charset="UTF-8">
        <title>Pemerintah Kabupaten Gianyar | Log in</title>
    ...
    <body class="bg-green">
        ...
        <div class="form-box" id="login-box">
            ...
            <div class="header" style="background: none;color:#404040;">
		<center>
		    <img src="imgcompany/dimata_system_logo.png" width="250" border="none" />
		    <b>
			<h4 class="box-title">
			    Pemerintah Kabupaten Buleleng<br>
			    <font color="yellow" size="3">Aplikasi Informasi Bisnis Intelijen</font><br>
			    Badan Keuangan
			</h4>
		    </b>
		</center>
	    </div>
            <form name="frmLogin" action="" style="box-shadow: 0px 0px 5px #000, 0px 5px 0px #000 inset;border-radius: 5px;">
                ...
                <%
                    if((iCommand==CMD_LOGIN)&&(dologin == SessUserSession.DO_LOGIN_OK)){
                         response.sendRedirect("bi");
                     }
                %>
                <div class="body bg-gray" style="border-top-left-radius: 5px; border-top-right-radius: 5px;">
            ...
            <div class="margin text-center">
                ...
                <span style="color:#f1f1f1">Copyright &copy; 2010 Dimata&reg; IT Solution<br>
                              Jl. Imam Bonjol, Perum Cipta Selaras no. 12, Denpasar 80119 - BALI.<br>
                              Telp. (0361) 499029, 7869752; Fax (0361) 499029<br>
                              Website : <a href="http://www.dimata.com" class="footerLink" style="color:white;">www.dimata.com</a><br>
                              Email : <a href="mailto:marketing@dimata.com" class="footerLink" style="color:white;">marketing@dimata.com</a></span>
