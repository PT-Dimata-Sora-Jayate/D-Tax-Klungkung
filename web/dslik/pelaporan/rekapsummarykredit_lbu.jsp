...
<html>
    <head>
        <meta charset="UTF-8">
        <title>SLIK | Laporan Rekap Summary Kredit Versi LBU</title>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch(){
                ...
                document.driver.action="rekapsummarykredit_lbu.jsp";
                document.driver.submit();
            ...
            function cmdSearchExcel(){
                document.driver.command.value="<%=Command.SEARCH%>";
                document.driver.action="<%=approot%>/dslik/pelaporan/rekapsummarykredit_lbu_excel.jsp";
                document.driver.submit();
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Laporan 
                        <small>Rekap Summary Kredit Versi LBU</small>
                    </h1>
                </section>
                <!-- Main content -->
                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3 class="box-title">Laporan Rekap Summary Kredit Versi LBU</h3>
                                            </div>
                                        </div>
                                        <div class='row'>
                                            <div class='col-md-12'>
