...
<%    
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_LAPORAN, AppObjInfo.G2_NOMINATIF_BANK_GARANSI, AppObjInfo.OBJ_NOMINATIF_BANK_GARANSI, AppObjInfo.COMMAND_VIEW);
    boolean privPrint = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_LAPORAN, AppObjInfo.G2_NOMINATIF_BANK_GARANSI, AppObjInfo.OBJ_NOMINATIF_BANK_GARANSI, AppObjInfo.COMMAND_PRINT);
    ...
    int kodestatus = FRMQueryString.requestInt(request, "kodestatus");
    ...
    statusVal.add("Aktif");
    statusKey.add("2");
    statusVal.add("Aktif Jatuh Tempo");
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>SLIK | Laporan Nominatif Bank Garansi Aktif</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Laporan 
                        <small>Nominatif Bank Garansi Aktif</small>
                    </h1>
                </section>
                <!-- Main content -->
                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3 class="box-title">Laporan Nominatif Bank Garansi Aktif</h3>
                                            </div>
                                        </div>
                                        <div class='row'>
                                            <div class='col-md-12'>
                                                                ...
                                                                <table class='table table-bordered'>
                                                                    <thead>
                                                                        ...
                                                                        <tr>
                                                                            <td colspan='16' align='center'>
                                                                                DAFTAR NOMINATIF BANK GARANSI AKTIF<br>
                                                                                PER : <%= periodeName %><br>
                                                                    ...
                                                                    %>
                                                                            <tbody>
                                                                                ...
                                                                                <%
                                                                                String tglAkadAkhir="";    
                                                                                tglAkadAkhir=" AND ("+PstBankGaransi.fieldNames[PstBankGaransi.FLD_KODE_KONDISI]+"='00' "
                                                                                       // + "    OR ("+PstBankGaransi.fieldNames[PstBankGaransi.FLD_KODE_KONDISI]+"='02' AND "+PstBankGaransi.fieldNames[PstBankGaransi.FLD_TGL_JATUH_TEMPO]+" > '"+Formater.formatDate(periode.getTglAkhir(),"yyyy-MM-dd")+"')"
                                                                                        + "    )";
                                                                                ...
                                                                                if(listBankGaransi.size() > 0){
                                                                                    for(int iA = 0; iA < listBankGaransi.size(); iA++){
                                                                                        ...
                                                                                        nourut=nourut+1;
                                                                                        String noRek = bankGaransi.getNoRekening();//PstKredit.formatCredit("###.##.##.#####-#",bankGaransi.getNoRekening());
                                                                                        %>
                                                                                            <tr>
                                                                                                <td><%= nourut %></td>
                                                                                                <td><%= (iA+1) %></td>
                                                                                                ...
                                                                                                <td><%= Formater.formatDate(bankGaransi.getTglAkadAwal(),"dd-MM-yyyy") %></td>
                                                                                                <td><%= Formater.formatDate(bankGaransi.getTglJatuhTempo(),"dd-MM-yyyy") %></td>
