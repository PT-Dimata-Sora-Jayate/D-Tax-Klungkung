...
<%  
    ...
    statusVal.add("Semua");
    statusKey.add("1");
    statusVal.add("Aktive");
    statusKey.add("2");
    statusVal.add("Aktive Jatuh Tempo");
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>SLIK | Laporan Nominatif Bank Garansi Lunas</title>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch(){
                ...
                document.driver.action="nominatifbankgaransi_lunas.jsp";
                document.driver.submit();
            ...
            function cmdSearchExcel(){
                document.driver.command.value="<%=Command.SEARCH%>";
                document.driver.action="<%=approot%>/dslik/export/exportnominatifbankgaransilunasexcel.jsp";
                document.driver.submit();
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Laporan 
                        <small>Nominatif Bank Garansi Lunas</small>
                    </h1>
                </section>
                <!-- Main content -->
                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3 class="box-title">Laporan Nominatif Bank Garansi Lunas</h3>
                                            </div>
                                        </div>
                                        <div class='row'>
                                            <div class='col-md-12'>
