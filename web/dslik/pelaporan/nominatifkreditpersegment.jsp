...
<%  
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_LAPORAN, AppObjInfo.G2_KREDIT_PER_KOLEKTIBILITAS, AppObjInfo.OBJ_KREDIT_PER_KOLEKTIBILITAS, AppObjInfo.COMMAND_VIEW);
    boolean privPrint = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_LAPORAN, AppObjInfo.G2_KREDIT_PER_KOLEKTIBILITAS, AppObjInfo.OBJ_KREDIT_PER_KOLEKTIBILITAS, AppObjInfo.COMMAND_PRINT);
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>SLIK | Laporan Daftar Nominatif Kredit Per Kolektibiliti</title>
        ...
        <script language="JavaScript">
            ...
            function cmdSearch(){
                ...
                document.driver.action="nominatifkreditpersegment.jsp";
                document.driver.submit();
            ...
            function cmdSearchExcel(){
                document.driver.command.value="<%=Command.SEARCH%>";
                document.driver.action="<%=approot%>/dslik/export/exportnominatifkreditpersegmentexcel.jsp";
                document.driver.submit();
            }
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        Laporan 
                        <small>Daftar Nominatif Kredit Per Kolektibiliti</small>
                    </h1>
                </section>
                <!-- Main content -->
                <%
                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3 class="box-title">Laporan Daftar Nominatif Kredit Per Kolektibiliti</h3>
                                            </div>
                                        </div>
                                        <div class='row'>
                                            <div class='col-md-12'>
                                                <div class="form-group pull-right">
                                                    <%
                                                            if(privPrint && iCommand==Command.SEARCH){
                                                                %>
                                        ...
                                        <%if(iCommand==Command.SEARCH){%>
                                            <div class="row">
                                                <div class="col-md-12" id="reportsummarypersegment">
                                                    <div class='row'>
                                                        <div class='col-md-12'>
                                                            <div class='form-group' id="exportelement" style="overflow: auto;">
                                                                <%
                                                                   ...
                                                                   Vector listContentDataKredit = PstKredit.listDistinct(0, 0, PstKredit.fieldNames[PstKredit.FLD_PERIODE_ID]+"='"+periodeId+"' "
                                                                    ...
                                                                    %>
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td></td>
                                                                                    <td colspan="12" style='mso-number-format:"@"'><%= contentDataJenisKredit.getNoRekening() %></td>
                                                                                </tr>
                                                                                <%
                                                                                    ...
                                                                                    for(int iA = 0; iA < listKredit.size(); iA++){
                                                                                        ...
                                                                                        %>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td></td>
                                                                                                 <td><%= Formater.formatDate(kredit.getTglMulai(), "dd-MM-yyyy") %></td>
                                                                                                <td><%= Formater.formatDate(kredit.getTglTempo(), "dd-MM-yyyy") %></td>
