<%-- 
    Document   : master_cif_hapus_buku
    Created on : Jun 7, 2017, 5:27:31 PM
    Author     : dimata005
--%>
<%@page import="com.dimata.dslik.form.masterdata.FrmMasterCifHapusBuku"%>
...
<%
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_KABUPATEN_KOTA, AppObjInfo.COMMAND_VIEW);
    boolean privAdd = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_KABUPATEN_KOTA, AppObjInfo.COMMAND_ADD);
    boolean privUpdate = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_KABUPATEN_KOTA, AppObjInfo.COMMAND_UPDATE);
    boolean privDelete = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_KABUPATEN_KOTA, AppObjInfo.COMMAND_DELETE);
    boolean privDownload = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_KABUPATEN_KOTA, AppObjInfo.COMMAND_DOWNLOAD);
    
%>
<html>
    <head>
        <meta charset="UTF-8">
        <title>SLIK | Configurasi Master CIF Hapus Buku</title>
                        ...
                        <div class="col-md-12">
                            <div class='box box-primary'>
                                <div class='box-header'>
                                    Cif Hapus Buku ( Pendaftaran cif hapus buku yang mengambil data bulan sebelumnya)
                                </div>
                                        ...
                                        if(privAdd){
                                            %>
                                                ...
                                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showform">
                                                    <i class="fa fa-plus"></i> Add Cif Hapus Buku
                                                </button>
                                            <%
                                        }
                                    %>
                ...
                $(document).ready(function () {
                    ...
                    addeditgeneral = function (elementId) {
                        $(elementId).click(function () {
                            ...
                            if (oid != 0) {
                                if (dataFor == 'showform') {
                                    $(".addeditgeneral-title").html("Edit Data");
                                }

                            } else {
                                if (dataFor == 'showform') {
                                    $(".addeditgeneral-title").html("Add Data");
                                }
                            }
                            ...
                            getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxMasterCifHapusBuku", ".addeditgeneral-body", false, "json");
                        });
                    };
                    ...
                    deletegeneral = function (tableId, elementId) {
                        ...
                        $(tableId).on("click", elementId, function () {
                            ...
                            if (confirm(confirmText)) {
                                ...
                                getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxMasterCifHapusBuku", null, true, "json");
                    ...
                    //FORM HANDLER
              chanelForm = function ()       {
                        validateOptions("#<%=FrmMasterCifHapusBuku.fieldNames[FrmMasterCifHapusBuku.FRM_FIELD_MASTERCIHAPUSBUKU]%>", 'text', 'has-error', 1, null);
                    }
                    ...
                    function runDataTables() {
                        dataTablesOptions("#countryElement", "tableCountryElement", "AjaxMasterCifHapusBuku", "list", callBackDataTables);
                    }
