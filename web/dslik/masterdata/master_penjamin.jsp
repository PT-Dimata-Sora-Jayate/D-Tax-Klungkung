<%-- 
    Document   : master_penjamin
    Created on : Nov 29, 2017, 11:30:24 AM
    Author     : Dimata 007
--%>

<%@page import="com.dimata.dslik.form.masterdata.FrmMasterPenjamin"%>
<%@page import="com.dimata.util.Command"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@include file="../../main/javainit_slik.jsp" %>
<%@include file="../../main/checkuser_slik.jsp" %>
<%
    boolean privAdd = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_PROFILE_BANK, AppObjInfo.OBJ_BANK, AppObjInfo.COMMAND_ADD);
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_PROFILE_BANK, AppObjInfo.OBJ_BANK, AppObjInfo.COMMAND_VIEW);
    boolean privDelete = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_PROFILE_BANK, AppObjInfo.OBJ_BANK, AppObjInfo.COMMAND_DELETE);
    boolean privUpdate = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_PROFILE_BANK, AppObjInfo.OBJ_BANK, AppObjInfo.COMMAND_UPDATE);
%>
<!DOCTYPE html>
<html>
    <head>
                                        ...
                                        if(privAdd){
                                            %>
                                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showform">
                                                    <i class="fa fa-plus"></i> Add Master Penjamin
                                                </button>
                                            <%
                                        }
                                    %>
                ...
                $(document).ready(function () {
                    ...
                    addeditgeneral = function (elementId) {
                        $(elementId).click(function () {
                            ...
                            if (oid != 0) {
                                if (dataFor == 'showform') {
                                    $(".addeditgeneral-title").html("Edit Master Penjamin");
                                }

                            } else {
                                if (dataFor == 'showform') {
                                    $(".addeditgeneral-title").html("Add Master Penjamin");
                                }
                            }
                            ...
                            getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxMasterPenjamin", ".addeditgeneral-body", false, "json");
                        });
                    };
                    ...
                    deletegeneral = function (tableId, elementId) {
                        ...
                        $(tableId).on("click", elementId, function () {
                            ...
                            if (confirm(confirmText)) {
                                ...
                                getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxMasterPenjamin", null, true, "json");
                    ...
                    //FORM HANDLER
              chanelForm = function ()       {
                        validateOptions("#<%=FrmMasterPenjamin.fieldNames[FrmMasterPenjamin.FRM_FIELD_MASTER_PENJAMIN_OID]%>", 'text', 'has-error', 1, null);
                    }
                    ...
                    function runDataTables() {
                        dataTablesOptions("#countryElement", "tableCountryElement", "AjaxMasterPenjamin", "list", callBackDataTables);
                    }
