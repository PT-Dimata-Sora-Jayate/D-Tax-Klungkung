...
<html>
    ...
    <body style="background: none;">
        <div class="login-box" style="margin: 3% auto;">
          ...
          <form name="frmLogin" action="<%=approot%>/dslik/frontend/login.jsp" onsubmit="window.status=''" method="post">
	   <input type="hidden" name="command" value="<%=CMD_LOGIN%>">
		...
		<div class="col-xs-12">
                            ...
                            <div class="col-md-12">
                                <div class="label-danger">
                                    ...
                                    if(appLanguage==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT){
                                        %>
                                        Sedang dalam proses penarikan data, mohon jangan menggunakan aplikasi SLIK dulu
                                        <%
                                    }else{
                                        %>
                                        Sedang dalam proses penarikan data, mohon jangan menggunakan aplikasi SLIK dulu
	      ...
	      <%
                if(MODUS_USER_LOGIN ==MODUS_USER_ONLINE){
                    if((iCommand==CMD_LOGIN && loginonline==2 )){
                         %>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="label-danger">
                                    ...
                                    if(appLanguage==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT){
                                        %>
                                        User tidak mempunya hak akses, hak akses yang di ijinkan SUPERVISI KREDIT <br> PIMPINAN OPERASIONAL<br>SUPERVISI KREDIT<br>ADMIN KEUANGAN KANTOR PUSAT<br> TIA (78)
                                        <%
                                    }else{
                                        %>
                                        User tidak mempunya hak akses, hak akses yang di ijinkan SUPERVISI KREDIT <br> PIMPINAN OPERASIONAL<br>SUPERVISI KREDIT<br>ADMIN KEUANGAN KANTOR PUSAT<br> TIA (78)
                        ...
                        <%
                    }else if((iCommand==CMD_LOGIN && loginonline==1)){
                         %>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="label-danger">
                        ...
                        <%
                    }else if((iCommand==CMD_LOGIN && loginonline==3)){   
                        %>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="label-danger">
                                    ...
                                    if(appLanguage==com.dimata.util.lang.I_Language.LANGUAGE_DEFAULT){
                                        %>
                                        Ada masalah koneksi antara server slik dengan server core, mohon di cek koneksi user/jaringan antara server slik dan core
                                        <%
                                    }else{
                                        %>
                                        Ada masalah koneksi antara server slik dengan server core, mohon di cek koneksi user/jaringan antara server slik dan core
