...
<%
    ...
    fileSent.setCreateInitial(initialProsesPeriode);
    ...
    switch (iCommand) {
        case Command.START:
            ...
            fileSent.setUpdateOnly(false);
            fileSent.setActiveOnly(false);
        ...
        case Command.UPDATE:
            //create file
            fileSent.create(locFile, fileSent.getBulan(), fileSent.getTahun());
            String locationDocumentUpdate=locFile+""+fileSent.getBulan()+"_"+fileSent.getTahun();
            fileSent.setLocation(locationDocumentUpdate);
            fileSent.setUpdateOnly(true);
            fileSent.setActiveOnly(false);
            managerDilimitedText.startDilimitedText(fileSent,outletConnection);
            break;
            
         case Command.UPDATE2:
            //create file
            fileSent.create(locFile, fileSent.getBulan(), fileSent.getTahun());
            String locationDocumentUpdate2=locFile+""+fileSent.getBulan()+"_"+fileSent.getTahun();
            fileSent.setLocation(locationDocumentUpdate2);
            fileSent.setActiveOnly(true);
            fileSent.setUpdateOnly(false);
            managerDilimitedText.startDilimitedText(fileSent,outletConnection);
            break;    
