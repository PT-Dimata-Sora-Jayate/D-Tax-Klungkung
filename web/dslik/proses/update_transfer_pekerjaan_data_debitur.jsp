<%-- 
    Document   : update_transfer_pekerjaan_data_debitur
    Created on : Jan 4, 2018, 11:43:18 AM
    Author     : dimata005
--%>
<%@page import="com.dimata.dslik.session.proses.ManagerUpdateKPTransferDataDebitur"%>
<%@page import="com.dimata.dslik.session.proses.ManagerUpdateTransferDataKredit"%>
...
<%
    ...
    ManagerUpdateKPTransferDataDebitur managerUpdateKPTransferDataDebitur = new ManagerUpdateKPTransferDataDebitur();

    switch (iCommand) {

        case Command.START:
            managerUpdateKPTransferDataDebitur.startTransfer();

            break;

        case Command.STOP:

            managerUpdateKPTransferDataDebitur.stopMonitor();

            break;

    }
    boolean running = managerUpdateKPTransferDataDebitur.getStatus();
...
<html>
  <head>
    <meta charset="UTF-8">
    <title>SLIK | Transfer Debitur Data</title>
    ...
    <script language="JavaScript">
        ...
        function cmdStart(){
            ...
            document.driver.action="update_transfer_pekerjaan_data_debitur.jsp";
	...
	<%@include file="../../template-component/header-component.jsp" %>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Transfer Update
            <small>Debitur Data Kode Pekerjaan</small>
          </h1>
        </section>
        <!-- Main content -->
        <%
                      ...
                      <div class='box box-primary'>
                        ...
                        <%if(dateHost.equals(datePeriodeSlik)){%>
                          <div class="box-body">
                              <div class="row">
                                    <div class="col-md-12">
                                        <b>Update Transfer Data Debitur</b><br>
                                    </div>
                                </div>
