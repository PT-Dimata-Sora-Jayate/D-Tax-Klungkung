<%-- 
    Document   : update_transfer_data_kredit
    Created on : Dec 5, 2017, 7:07:45 PM
    Author     : dimata005
--%>
...
<%
    ...
    ManagerUpdateTransferDataKredit managerUpdateTransferDataKredit = new ManagerUpdateTransferDataKredit();

    switch (iCommand) {

        case Command.START:
            managerUpdateTransferDataKredit.startTransfer();

            break;

        case Command.STOP:

            managerUpdateTransferDataKredit.stopMonitor();

            break;

    }
    boolean running = managerUpdateTransferDataKredit.getStatus();
  ...
  <head>
    ...
    <script language="JavaScript">
        ...
        function cmdStart(){
            ...
            document.driver.action="update_transfer_data_kredit.jsp";
                      ...
                      <div class='box box-primary'>
                        ...
                        <%if(dateHost.equals(datePeriodeSlik)){%>
                          <div class="box-body">
                              <div class="row">
                                    <div class="col-md-12">
                                        <b>Update Transfer Data Kredit</b><br>
                                    </div>
                                </div>
