<%-- 
    Document   : kecamatan
    Created on : Jun 7, 2017, 10:59:30 AM
    Author     : dimata005
--%>
<%@page import="com.dimata.dslik.form.contentdata.FrmContentDataKecamatan"%>
<%-- 
    Document   : kabupatenKota
    Created on : Sep 27, 2016, 9:40:30 AM
    Author     : Dewa
--%>
                ...
                $(document).ready(function () {
                    ...
                    addeditgeneral = function (elementId) {
                        $(elementId).click(function () {
                            ...
                            if (oid != 0) {
                                if (dataFor == 'showform') {
                                    $(".addeditgeneral-title").html("Edit Kecamatan");
                                }

                            } else {
                                if (dataFor == 'showform') {
                                    $(".addeditgeneral-title").html("Add Kecamatan");
                                }
                            }
                            ...
                            getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdKecamatan", ".addeditgeneral-body", false, "json");
                        });
                    };
                    ...
                    deletegeneral = function (tableId, elementId) {
                        ...
                        $(tableId).on("click", elementId, function () {
                            ...
                            if (confirm(confirmText)) {
                                ...
                                getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdKecamatan", null, true, "json");
                    ...
                    //FORM HANDLER
              chanelForm = function ()       {
                        validateOptions("#<%=FrmContentDataKecamatan.fieldNames[FrmContentDataKecamatan.FRM_FIELD_KECAMATANID]%>", 'text', 'has-error', 1, null);
                    }
                    ...
                    function runDataTables() {
                        dataTablesOptions("#countryElement", "tableCountryElement", "AjaxCdKecamatan", "list", callBackDataTables);
                    }
