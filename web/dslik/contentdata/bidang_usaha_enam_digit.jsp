<%-- 
    Document   : bidang_usaha_enam_digit
    Created on : Jan 22, 2018, 10:28:56 AM
    Author     : dimata005
--%>
<%@page import="com.dimata.dslik.form.contentdata.FrmContentDataBidangUsaha"%>
...
<%
    boolean privView = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_BIDANG_USAHA, AppObjInfo.COMMAND_VIEW);
    boolean privAdd = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_BIDANG_USAHA, AppObjInfo.COMMAND_ADD);
    boolean privUpdate = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_BIDANG_USAHA, AppObjInfo.COMMAND_UPDATE);
    boolean privDelete = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_BIDANG_USAHA, AppObjInfo.COMMAND_DELETE);
    boolean privDownload = userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_BIDANG_USAHA, AppObjInfo.COMMAND_DOWNLOAD);
    
%>
<html>
    <head>
        <meta charset="UTF-8">
        <title>SLIK | Maping Bidang Usaha 6 Digit</title>
                                        ...
                                        if(privAdd){
                                            %>
                                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showform">
                                                    <i class="fa fa-plus"></i> Add Bidang Usaha 6 Digit
                                                </button>	
                                            <%
                                        }
                                    %>		
                                        ...
                                        <table class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Kode Core Banking 6 Digit</th>
                                                    <th>Kode Ojk</th>   
                                                    <th>Action</th>
                                                </tr>
                                            </thead>
                ...
                $(document).ready(function(){
                    ...
                    addeditgeneral = function(elementId){
                        $(elementId).click(function(){
                            ...
                            if(oid != 0){
                                if(dataFor == 'showform'){
                                    $(".addeditgeneral-title").html("Edit Bidang Usaha");
                                }

                            }else{
                                if(dataFor == 'showform'){
                                    $(".addeditgeneral-title").html("Add Bidang Usaha");
                                }
                            }
                            ...
                            getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdBidangUsahaEnamDigit", ".addeditgeneral-body", false, "json");
                        });
                    };
                    ...
                    deletegeneral = function(elementId, checkboxelement){
                        ...
                        $(elementId).on("click", checkboxelement, function(){
                            ...
                            if(confirm(confirmText)){
                                ...
                                getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCdBidangUsahaEnamDigit", null, true, "json");
                    ...
                    //FORM HANDLER
                    chanelForm = function(){
                        validateOptions("#<%=FrmContentDataBidangUsaha.fieldNames[FrmContentDataBidangUsaha.FRM_FIELD_BIDANG_USAHA_OID]%>", 'text', 'has-error', 1, null);
                    }
                    ...
                    function runDataTables(){
                        dataTablesOptions("#countryElement", "tableCountryElement", "AjaxCdBidangUsahaEnamDigit", "list", callBackDataTables);
                    }
                    ...
                    runDataTables();
                    deletegeneral("#tableCountryElement", ".btn-delete");
