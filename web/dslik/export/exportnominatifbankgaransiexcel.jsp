...
<%
    ...
    String file = "LAPORAN_NOMINATIF_BANK_GARANSI_AKTIF";
        ...
        <table border="1" cellpadding="0" cellspacing="0" width="100%">
            ...
            %>
                    <tbody>
                        ...
                        <%
                        String tglAkadAkhir="";    
                        tglAkadAkhir=" AND ("+PstBankGaransi.fieldNames[PstBankGaransi.FLD_KODE_KONDISI]+"='00' OR ("+PstBankGaransi.fieldNames[PstBankGaransi.FLD_KODE_KONDISI]+"='02' AND "+PstBankGaransi.fieldNames[PstBankGaransi.FLD_TGL_JATUH_TEMPO]+" > '"+Formater.formatDate(periode.getTglAkhir(),"yyyy-MM-dd")+"'))";
                            ...
                            for(int iA = 0; iA < listBankGaransi.size(); iA++){
                                ...
                                %>
                                    <tr>
                                        <td><%= nourut %></td>
                                        <td><%= (iA+1) %></td>
                                        <td style='mso-number-format:"@"'><%= PstKredit.formatCredit("###.##.##.#####-#",bankGaransi.getNoRekening()) %></td>
                                        <td style='mso-number-format:"@"'><%= bankGaransi.getNamaYgDijamin()%></td>
                                        <td style='mso-number-format:"@"'><%= bankGaransi.getNoAkadAwal()%></td>
                                        <td style='mso-number-format:"@"'><%= bankGaransi.getKodeKolektibilitas()%></td>
                                        <td style='mso-number-format:"@"'><%= bankGaransi.getKodeTujuanGaransi()%></td>
                                        <td><%= Formater.formatDate(bankGaransi.getTglAkadAwal(),"dd-MM-yyyy") %></td>
                                        <td><%= Formater.formatDate(bankGaransi.getTglAkadAkhir(),"dd-MM-yyyy") %></td>
