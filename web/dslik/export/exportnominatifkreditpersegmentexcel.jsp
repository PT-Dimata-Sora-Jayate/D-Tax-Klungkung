                                ...
                                for(int iA = 0; iA < listKredit.size(); iA++){
                                    ...
                                    %>
                                        <tr>
                                            ...
                                            <td style='mso-number-format:"@"'><%= kredit.getNamaSingkat()%></td>
                                            <td></td>
                                            <td style='mso-number-format:"@"'><%= Formater.formatDate(kredit.getTglMulai(), "dd-MM-yyyy") %></td>
                                            <td style='mso-number-format:"@"'><%= Formater.formatDate(kredit.getTglTempo(), "dd-MM-yyyy") %></td>
