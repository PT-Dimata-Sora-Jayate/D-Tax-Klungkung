                            ...
                            for(int iA = 0; iA < listBankGaransi.size(); iA++){
                                ...
                                %>
                                    <tr>
                                        ...
                                        <td style='mso-number-format:"@"'><%= Formater.formatDate(bankGaransi.getTglAkadAwal(),"dd-MM-yyyy") %></td>
                                        <td style='mso-number-format:"@"'><%= Formater.formatDate(bankGaransi.getTglJatuhTempo(),"dd-MM-yyyy") %></td>
