                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-xs-6">
                                            ...
                                            <div class="small-box bg-aqua">
                                                <div class="inner">
                                                    <h3 id="AjaxDebiturIndividuPasangan" class="summary" data-target="AjaxDebiturIndividu" data-for="loadsummaryindividupasangan" data-selector="#AjaxDebiturIndividuPasangan">
                                                        <i class="fa fa-spin fa-refresh"></i>
                                                    </h3>
                                                    <p>
                                                        D.I Tanpa Data Pasangan
                                                    </p>
                                                </div>
                                                <div class="icon">
                                                    <i class="ion ion-bag"></i>
                                                </div>
                                                <a href="javascript:" class="small-box-footer showlist" data-command="<%= Command.NONE %>" data-for="showlistindividuPasangan" data-status="null" data-target="AjaxDebiturIndividu">More info <i class="fa fa-arrow-circle-right"></i>
                                                </a>
                                            </div>
                                        </div><!-- ./col -->
                                        <div class="col-lg-2 col-xs-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-xs-6">
                                            ...
                                            <div class="small-box bg-navy">
                                                <div class="inner">
                                                    <h3 id="AjaxLaporanKeuanganDebiturWajib" class="summary" data-target="AjaxLaporanKeuanganDebitur" data-for="loadsummarylaporankeuanganwajib" data-selector="#AjaxLaporanKeuanganDebiturWajib">
                                                        <i class="fa fa-spin fa-refresh"></i>
                                                    </h3>
                                                    <p>
                                                        Lap.Keuangan Wajib > 5M
                                                    </p>
                                                </div>
                                                <div class="icon">
                                                    <i class="ion ion-ios7-alarm-outline"></i>
                                                </div>
                                                <a href="javascript:" class="small-box-footer showlist" data-command="<%= Command.NONE %>" data-for="showlistlaporankeuangandebiturWajib" data-status="null" data-target="AjaxLaporanKeuanganDebitur">
                                                    More info <i class="fa fa-arrow-circle-right"></i>
                                                </a>
                                            </div>
                                        </div><!-- ./col -->
                                        ...
                                        <div class="col-lg-2 col-xs-6">
                                            ...
                                            <div class="small-box bg-fuchsia">
                                                <div class="inner">
                                                    <h3 id="AjaxPengurusPemilikPangsa" class="summary" data-target="AjaxPengurusPemilik" data-for="loadsummarypangsa" data-selector="#AjaxPengurusPemilikPangsa">
                                                        <i class="fa fa-spin fa-refresh"></i>
                                                    </h3>
                                                    <p>
                                                            Pengurus/Pemilik Yang Pangsa Kurang/Lebih 100%
                                                    </p>
                                                </div>
                                                <div class="icon">
                                                    <i class="ion ion-ios7-pricetag-outline"></i>
                                                </div>
                                                <a href="javascript:" class="small-box-footer showlist" data-command="<%= Command.NONE %>" data-for="showlistpenguruspemilikpangsa" data-status="null" data-target="AjaxPengurusPemilik">
                                                    More info <i class="fa fa-arrow-circle-right"></i>
                                                </a>
                                            </div>
                                        </div><!-- ./col -->
                        ...
                        $(selector).click(function(){
                            ...
                            switch(datafor){
                                ...
                                break;
                                 ...
                                 case "showlistindividuPasangan" :
                                    modaltitle = "Debitur Individu Menikah Tanpa Data Pasangan";
                                break;
                                ...
                                case "showlistlaporankeuangandebiturWajib": 
                                    modaltitle = "Debitur yang Laporan Keuangan Wajib di Input";
                                break;
                                ...
                                case "showlistpenguruspemilikpangsa" :
                                    modaltitle = "Pengurus / Pemilik";
                            }
                            ...
                            if(datafor == "showlistpenguruspemilikpangsa"){
                                modaltitle = "Daftar Data Pengurus yang Memiliki Pangsa Pengurus Kurang/Lebih 100%";
                            }
