        ...
        <ul class="sidebar-menu">
            <% if(userSession.checkPrivG1G2(AppObjInfo.G1_PROSES_INTEGRASI, AppObjInfo.G2_PHR)){ %>
                <li <%=tree==1?"class=\"treeview active\"":"class=\"treeview\""%> >
                    ...
                    <ul class="treeview-menu">
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PHR,AppObjInfo.OBJ_UPLOAD_FILE_PHR)){ %>
                            <li <%=menu==1?"class=\"active\"":""%>>
                                <a href="<%=approot%>/dtaxintegration/data/phr.jsp?menu=1&tree=1">
                                    <i class="fa fa-th"></i> <span>Upload File PHR</span>
                                </a>
                            </li>
                        <%}%>
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PHR,AppObjInfo.OBJ_UPLOAD_OTOMATIS_PHR)){ %>
                            <li <%=menu==24?"class=\"active\"":""%>>
                                <a href="<%=approot%>/dtaxintegration/data/automatic_phr.jsp?menu=24&tree=1">
                                    <i class="fa fa-th"></i> <span>Otomatis Upload PHR</span>
                                </a>
                            </li>
                        <%}%>
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PHR,AppObjInfo.OBJ_UPLOAD_MANUAL_PHR)){ %>
                            <li <%=menu==2?"class=\"active\"":""%>>
                                <a href="<%=approot%>/dtaxintegration/data/manual_phr.jsp?menu=2&tree=1">
                                    <i class="fa fa-th"></i> <span>Upload Manual PHR</span>
                                </a>
                            </li>
                        <%}%>
                        
                        <% if(userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PHR,AppObjInfo.OBJ_DELETE_ALL_INSTANSI_PHR, AppObjInfo.COMMAND_VIEW)){ %>
                            <li <%=menu==31?"class=\"active\"":""%>>
                                <a href="<%=approot%>/dtaxintegration/data/delete_instansi_phr.jsp?menu=31&tree=1">
                                    <i class="fa fa-th"></i> <span>Delete Semua Tagihan PHR </span>
                                </a>
                            </li>
                        <%}%>
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PHR,AppObjInfo.OBJ_DOWNLOAD_PAYMENT_PHR)){ %>
                            <li <%=menu==3?"class=\"active\"":""%>>
                                <a href="<%=approot%>/dtaxintegration/payment/payment_phr.jsp?menu=3&tree=1">
                                    <i class="fa fa-th"></i> <span>Manual Payment PHR </span>
                                </a>
                            </li>
                        <%}%>
                    </ul>
            ...
            <% /*if (true){*/
                ...
                <li <%=tree==2?"class=\"treeview active\"":"class=\"treeview\""%> >
                    ...
                    <ul class="treeview-menu">
						...
						<% /*if (true){*/
                            if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PBB,AppObjInfo.OBJ_UPLOAD_FILE_PBB)){ %>
                            <li <%=menu==99?"class=\"active\"":""%>>
                                 <a href="<%=approot%>/dtaxintegration/data/automatic_pbb.jsp?menu=99&tree=2">
                                    <i class="fa fa-th"></i> <span>Auto Upload File PBB</span>
                                </a>
                            </li>
                        <%}%>
                        <% /*if (true){*/
                ...
                <li <%=tree==3?"class=\"treeview active\"":"class=\"treeview\""%> >
                    ...
                    <ul class="treeview-menu">
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_BPHTB,AppObjInfo.OBJ_UPLOAD_OTOMATIS_BPHTB)){ %>
                            <li <%=menu==98?"class=\"active\"":""%>>
                                 <a href="<%=approot%>/dtaxintegration/data/bphtb.jsp?menu=98&tree=3">
                                    <i class="fa fa-th"></i> <span>Upload File BPHTB</span>
                                </a>
                            </li>
                        <%}%>
						<% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_BPHTB,AppObjInfo.OBJ_UPLOAD_OTOMATIS_BPHTB)){ %>
                            <li <%=menu==98?"class=\"active\"":""%>>
                                 <a href="<%=approot%>/dtaxintegration/data/automatic_bphtb.jsp?menu=7&tree=3">
                                    <i class="fa fa-th"></i> <span>Auto Upload File BPHTB</span>
                                </a>
                            </li>
                        <%}%>
           ...
           <% if(userSession.checkPrivG1G2(AppObjInfo.G1_PROSES_INTEGRASI, AppObjInfo.G2_RETRIBUSI)){ %>
                ...
                <li <%=tree==5?"class=\"treeview active\"":"class=\"treeview\""%> >
                    ...
                    <ul class="treeview-menu">
                        ...
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_REPORT,AppObjInfo.G2_REPORT_PHR, AppObjInfo.OBJ_REPORT_GLOBAL_PHR)){ %>
                            <li <%=menu==190?"class=\"active\"":""%> >
                                <a href="<%=approot%>/dtaxintegration/report/report_phr_harian.jsp?menu=190&tree=5">
                                    <i class="fa fa-th"></i> <span>Report PHR Harian</span>
                                </a>
                            </li>
                        <%}%>
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_REPORT,AppObjInfo.G2_REPORT_PHR, AppObjInfo.OBJ_REPORT_GLOBAL_PHR)){ %>
                            <li <%=menu==14?"class=\"active\"":""%> >
                                <a href="<%=approot%>/dtaxintegration/report/report_global_phr.jsp?menu=14&tree=5">
                                    <i class="fa fa-th"></i> <span>Report PHR Global</span>
                                </a>
                            </li>
                        <%}%>
                        ...
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_REPORT,AppObjInfo.G2_REPORT_PBB, AppObjInfo.OBJ_REPORT_GLOBAL_PBB)){ %>
                            <li <%=menu==25?"class=\"active\"":""%> >
                                <a href="<%=approot%>/dtaxintegration/report/report_global_pbb.jsp?menu=25&tree=5">
                                    <i class="fa fa-th"></i> <span>Report PBB Global</span>
                                </a>
                            </li>
                        <%}%>
                        ...
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_REPORT,AppObjInfo.G2_REPORT_BPHTB, AppObjInfo.OBJ_REPORT_GLOBAL_BPHTB)){ %>
                            <li <%=menu==191?"class=\"active\"":""%> >
                                <a href="<%=approot%>/dtaxintegration/report/report_bphtb_harian.jsp?menu=191&tree=5">
                                    <i class="fa fa-th"></i> <span>Report BPHTB Harian</span>
                                </a>
                            </li>
                        <%}%>
                        <% if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_REPORT,AppObjInfo.G2_REPORT_BPHTB, AppObjInfo.OBJ_REPORT_GLOBAL_BPHTB)){ %>
                            <li <%=menu==26?"class=\"active\"":""%> >
                                <a href="<%=approot%>/dtaxintegration/report/report_global_bphtb.jsp?menu=26&tree=5">
                                    <i class="fa fa-th"></i> <span>Report BPHTB Global</span>
                                </a>
                            </li>
                        <%}%>
                        ...
                        <%}%>
                        <%if(userSession.checkPrivG1G2(AppObjInfo.G1_REPORT,AppObjInfo.G2_CETAK)){ %>
            ...
            <li <%=tree==6?"class=\"treeview active\"":"class=\"treeview\""%> >
                    <a href="#">
                        <i class="fa fa-edit"></i> <span>Otomatis Proses</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <%if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PHR,AppObjInfo.OBJ_DOWNLOAD_ALL_PAYMENT)){ %>
                              <li <%=menu==19?"class=\"active\"":""%>>
                                  <a href="<%=approot%>/dtaxintegration/payment/automatic_payment.jsp?menu=19&tree=6">
                                      <i class="fa fa-th"></i> <span>Otomatis Payment PHR & ABT </span>
                                  </a>
                              </li>
                          <%}%>
                          <%if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_PBB,AppObjInfo.OBJ_DOWNLOAD_PAYMENT_PBB)){ %>
