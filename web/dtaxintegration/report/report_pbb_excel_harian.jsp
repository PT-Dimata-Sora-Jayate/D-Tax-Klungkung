...
<%!//proses yang akan ditampilkan
    ...
    public String drawListDataPaymentPBBDispendaHarian(int iCommand, Vector objectClass, long gradeId) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            rowx.add(""+count);//1
            rowx.add(""+Formater.formatDate(paymentPbb.getTglPembayaranSppt(), "dd-MMM-yy").toUpperCase());//2
...
<% 
	...
	whereClause = PstPaymentPbb.fieldNames[PstPaymentPbb.FLD_TGLPEMBAYARANSPPT]
                  +" BETWEEN convert(DATETIME,'"+startDate+" 00:00:00',102)"
                  +" AND convert(DATETIME,'"+startEnd+" 23:59:00',102)";
