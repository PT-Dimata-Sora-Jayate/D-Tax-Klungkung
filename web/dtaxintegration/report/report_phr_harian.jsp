...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    switch (AppSetting.TYPE_APP_BACKOFFICE) {
        case AppSetting.APP_OPEN_PHR:
            listPaymentPhr = PstPaymentPhrforOpenPhr.listSum(0, 0, whereClause, 
            ""+PstPaymentPhrforOpenPhr.fieldNames[PstPaymentPhrforOpenPhr.FLD_TANGGALAWAL]+" ASC ", 
            ""+PstPaymentPhrforOpenPhr.fieldNames[PstPaymentPhrforOpenPhr.FLD_TANGGALAWAL]);
            break;
        case AppSetting.APP_PHRH:
            listPaymentPhr = PstPaymentPhrforOpenPhr.listSum(0, 0, whereClause, 
            ""+PstPaymentPhrforOpenPhr.fieldNames[PstPaymentPhrforOpenPhr.FLD_TGLTRANSAKSI]+" ASC ", 
            ""+PstPaymentPhrforOpenPhr.fieldNames[PstPaymentPhrforOpenPhr.FLD_TGLTRANSAKSI]);
            break;
        default:
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdPrint(){
                ...
                document.driver.action="report_phr_harian.jsp";
            ...
            function cmdPrintExcel(){
                var myWindow = window.open("report_phr_harian_excel.jsp?tanggalStart=<%=oDate%>&tanggalEnd=<%=oEnd%>&exchangeRate=<%=exchangeRate%>&pemotongan=<%=pemotongan%>", "MsgWindow", "toolbar=no, scrollbars=yes, resizable=yes, top=500, left=500, width=1500, height=800");
                if (window.focus) 
                 {
                   myWindow.focus();
                 }
            ...
            function cmdPrintPdf(){
                var myWindow = window.open("<%=printrootx%>.print.report_phr_harian_pdf?tanggalStart=<%=oDate%>&tanggalEnd=<%=oEnd%>&exchangeRate=<%=exchangeRate%>&pemotongan=<%=pemotongan%>","",'scrollbars=yes,status=yes,width=750,height=600,resizable=yes');
                if (window.focus) 
                 {
                   myWindow.focus();
                 }
