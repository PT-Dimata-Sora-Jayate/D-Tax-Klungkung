<%-- 
    Document   : delete_instansi_phr
    Created on : Aug 2, 2015, 11:19:19 AM
    Author     : xml
--%>
...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    switch (iCommand) {
        case Command.START:
            ...
            tagihanDeleteInstansi.setsUser(AppSetting.USERNAME_PHR);
            tagihanDeleteInstansi.setsPassword(AppSetting.PWD_PHR);
            tagihanDeleteInstansi.setsInstansi(AppSetting.INSTANSI_PHR);
            ...
            if(code.equals("00")){
                ...
                //hapus data di log
                String whereDelete = ""+PstLogHistoryTransaksi.fieldNames[PstLogHistoryTransaksi.FLD_INSTANSI]+"='SIMPATDA_GIANYAR'";
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                               <div class="box">
                                   ...
                                   <div class="box-header">
                                       <div class="col-xs-12"><label>DELETE TAGIHAN INSTANSI PHR</label>
