<%-- 
    Document   : automatic_pbb
    Created on : Feb 16, 2019, 11:43:09 AM
    Author     : IanRizky
--%>
...
<%@page import="com.dimata.dtaxintegration.session.DTaxIntegrationManagerAutoPbb"%>
...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    DTaxIntegrationManagerAutoPbb dTaxIntegrationManagerAutoPbb = new DTaxIntegrationManagerAutoPbb();
    ...
    switch (iCommand) {
        ...
        case Command.START:
            ...
            dTaxIntegrationManagerAutoPbb.startMonitor(fileSent);
        ...
        case Command.STOP:
            ...
            dTaxIntegrationManagerAutoPbb.stopMonitor();

            break;

    }
    boolean running = dTaxIntegrationManagerAutoPbb.getStatus();
                            ...
                            <div class="col-xs-12">
                               <div class="box">
                                   <div class="box-header">
                                        <div class="col-xs-2"><label>Upload Sampai Tahun</label>
                                   ...
                                   <div class="box-header">
                                       <div class="col-xs-12"><label> Upload Otomatis Tagihan PBB</label>
                                           <table width="85%" border="0" cellspacing="1" cellpadding="1" align="center">
                                                                ...
                                                                <tr> 
                                                                    ...
                                                                    <td colspan="3"><%=dTaxManagerPbbx.getStatusAutoUpload()%></td>
