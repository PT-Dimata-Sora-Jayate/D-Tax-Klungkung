...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    switch (iCommand) {
        ...
        case Command.START:
            ...
            fileSent.setsUser(AppSetting.USERNAME_BPHTB);//1
            fileSent.setsPassword(AppSetting.PWD_BPHTB);//2
            fileSent.setsInstansi(AppSetting.INSTANSI_BPHTB);//6
            fileSent.setLocation(AppSetting.PBB_LOCATION_FILE+"\\"+year+"\\"+strMonth+"\\"+Formater.formatDate(transaksiCreate, "yyyyMMdd"));
            fileSent.setFileName(AppSetting.INSTANSI_BPHTB+"_"+Formater.formatDate(transaksiCreate, "yyyy-MM-dd_HHmm")+"");
			fileSent.setFileNameZip(AppSetting.INSTANSI_BPHTB+"_"+Formater.formatDate(transaksiCreate, "yyyy-MM-dd_HHmm")+".zip");
