<%-- 
    Document   : automatic_bphtb
    Created on : May 27, 2015, 7:21:56 PM
    Author     : xml
--%>

<%@page import="com.dimata.dtaxintegration.session.DTaxManagerBphtb"%>
<%-- 
    Document   : automatic_payment
    Created on : May 27, 2015, 7:09:26 PM
    Author     : xml
--%>
...
<%-- 
    ...
    Author     : dimata005
--%>
<%@page import="com.dimata.dtaxintegration.session.DTaxIntegrationManagerAutoBphtb"%>
...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    DTaxIntegrationManagerAutoBphtb dTaxIntegrationManagerAutoBphtb = new DTaxIntegrationManagerAutoBphtb();
    ...
    switch (iCommand) {
        ...
        case Command.START:
           ...
           dTaxIntegrationManagerAutoBphtb.startMonitor();
        ...
        case Command.STOP:
            ...
            dTaxIntegrationManagerAutoBphtb.stopMonitor();

            break;

    }
    boolean running = dTaxIntegrationManagerAutoBphtb.getStatus();
                                       ...
                                       <div class="col-xs-12"><label>Monitoring BPHTB Service</label>
                                           <table width="85%" border="0" cellspacing="1" cellpadding="1" align="center">
                                                                ...
                                                                <tr> 
                                                                    ...
                                                                    <td colspan="3" class="title"><b>Monitoring BPHTB Service</b></td>
																...
																<tr> 
                                                                    ...
                                                                    <td colspan="3"><%=dTaxManagerBphtbx.getStatusAutoUpload()%></td>
                                                                ...
                                                                <% if(userSession.checkPrivG1G2ObjCommand(AppObjInfo.G1_PROSES_INTEGRASI,AppObjInfo.G2_BPHTB,AppObjInfo.OBJ_UPLOAD_OTOMATIS_BPHTB, AppObjInfo.COMMAND_UPLOAD)){ %>
                                                                    <tr> 
