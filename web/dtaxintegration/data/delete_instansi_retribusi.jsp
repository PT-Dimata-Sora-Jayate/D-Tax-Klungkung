<%-- 
    Document   : delete_instansi_retribusi
    Created on : Aug 2, 2015, 11:33:34 AM
    Author     : xml
--%>
...
<%@page import="com.dimata.dtaxintegration.session.DTaxManagerAutomaticPhr"%>
...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    switch (iCommand) {
        case Command.START:
            //dTaxManagerAutomaticPhr.startMonitor();
            TagihanDelete tagihanDeleteInstansi = new TagihanDelete();
            tagihanDeleteInstansi.setsUser(AppSetting.USERNAME_RETRIBUSI);
            tagihanDeleteInstansi.setsPassword(AppSetting.PWD_RETRIBUSI);
            tagihanDeleteInstansi.setsInstansi(AppSetting.INSTANSI_RETRIBUSI);
            ...
            if(code.equals("00")){
                ...
                //hapus data di log
                String whereDelete = ""+PstLogHistoryTransaksi.fieldNames[PstLogHistoryTransaksi.FLD_INSTANSI]+"='RETRIBUSI_GIANYAR'";
        ...
        case Command.STOP:
            ...
            //dTaxManagerAutomaticPhr.stopMonitor();

            break;

    }
    //boolean running = dTaxManagerAutomaticPhr.getStatus();
%>
<html>
    <head>
        <meta charset="UTF-8">
                                       ...
                                       <div class="col-xs-12">
                                           <table width="85%" border="0" cellspacing="1" cellpadding="1" align="center">
                                                                ...
                                                                <tr> 
                                                                    ...
                                                                    <td colspan="3" class="title"><b>DELETE RETRIBUSI</b></td>
                                                                ...
                                                                <tr> 
                                                                    ...
                                                                    <td colspan="2"> 
                                                                        <div align="right"><b><%=result%></b></div>
                                                                    </td>
                                                                </tr>
                                                                <tr> 
                                                                        <td width="40%">&nbsp;</td>
