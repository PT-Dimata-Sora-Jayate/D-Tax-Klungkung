<%-- 
    Document   : automatic_payment_nphtb
    Created on : Sep 15, 2015, 11:34:23 PM
    Author     : Administrator
--%>
<%@page import="com.dimata.dtaxintegration.session.DTaxIntegrationManagerPaymentBphtb"%>
...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    DTaxIntegrationManagerPaymentBphtb dTaxIntegrationManagerPaymentBphtb = new DTaxIntegrationManagerPaymentBphtb();
    ...
    switch (iCommand) {
        ...
        case Command.START:
            ...
            dTaxIntegrationManagerPaymentBphtb.startMonitor();
        ...
        case Command.STOP:
            ...
            dTaxIntegrationManagerPaymentBphtb.stopMonitor();

            break;

    }
    boolean running = dTaxIntegrationManagerPaymentBphtb.getStatus();
%>
<html>
    <head>
        <meta charset="UTF-8">
            ...
            <aside class="right-side">                
                ...
                <section class="content">
                    <form name="fr_syslog"  method ="post" action="" role="form">
                        ...
                        <input type="hidden" name="start" value="<%=start%>">
                        <input type="hidden" name="menu" value="89">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                               <div class="box">
                                   ...
                                   <div class="box-header">
                                       <div class="col-xs-12"><label> Download Otomatis Pembayaran BPHTB</label>
                                           <table width="85%" border="0" cellspacing="1" cellpadding="1" align="center">
																...
																<tr> 
                                                                    ...
                                                                    <td colspan="2"><%=dTaxIntegrationManagerPaymentBphtb.getErorStatus()%></td>
