...
<%@page import="com.dimata.dtaxintegration.session.DTaxIntegrationManagerPaymentPbbYesterday"%>
...
<% //proses yang tidak akan ditampilkan hanya diserver side
    ...
    DTaxIntegrationManagerPaymentPbbYesterday dTaxIntegrationManagerPaymentPbbYesterday = new DTaxIntegrationManagerPaymentPbbYesterday();
    ...
    switch (iCommand) {
        ...
        case Command.START:
            ...
            dTaxIntegrationManagerPaymentPbbYesterday.startMonitor();
        ...
        case Command.STOP:
            ...
            dTaxIntegrationManagerPaymentPbbYesterday.stopMonitor();
                                       ...
                                       <div class="col-xs-12"><label> Download Otomatis Pembayaran PBB</label>
                                           <table width="85%" border="0" cellspacing="1" cellpadding="1" align="center">
                                                                ...
                                                                <tr> 
                                                                    ...
                                                                    <td colspan="2"><%=dTaxIntegrationManagerPaymentPbb.getErorStatus()%></td>
