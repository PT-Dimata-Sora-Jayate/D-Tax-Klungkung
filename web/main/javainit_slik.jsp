...
<%
    ...
    boolean runningProsesDebitur = ManagerTransferDataDebitur.getStatusRunningStatic();
    boolean runningProsesKredit = ManagerTransferDataKredit.getStatusRunningStatic();
    boolean runningProsesBankGaransi = ManagerTransferDataBankGaransi.getStatusRunningStatic();
    boolean runningProsesAgunan = ManagerTransferDataAgunan.getStatusRunningStatic();
    boolean runningProsesPengurus = ManagerTransferDataPengurusPemilik.getStatusRunningStatic();
%>