<%-- 
    Document   : wp-pembayaran
    Created on : Aug 28, 2017, 11:26:49 PM
    Author     : dimata005
--%>
  ...
  <div class="subnavbar-inner">
	...
	<%
	    ...
	    String activeList="";
            ...
            String activePembayaran="active";
	%>
	...
	<div class="modal-content">
	    ...
	    <div class="modal-body" overflow-y: hidden;">
                 <div id="map" style="display:none;">
                    <iframe style="zoom:0.60" width="960" height="520" frameborder="0"></iframe>
                 </div>
	    </div>
	    <div class="modal-footer">
		<button type="button" data-dismiss="modal" class="btn btn-danger">Tutup</button>
