    ...
    $(document).ready(function(){
        function loadTable1(){
            $('#tabledata1').dataTable({
                ...
                "bProcessing" : true,
                "bServerSide" : true,
                "sAjaxSource" : "<%= approot%>/PelaporanPajakHandler?command=<%= Command.LOAD%>&table=1&user=<%= userIdWP%>&approot=<%=approot%>",
                "aoColumns" :   [{"bSearchable" : true, "bVisible" : true, "asSorting" : [ "asc" ] },
                                {"sWidth" : "10%","bSortable" : true },//1
                                {"sWidth" : "10%","bSortable" : true },//1
                                {"sWidth" : "5%","bSortable" : true },//2
                                {"sWidth" : "10%","bSortable" : true,sClass: "alignRight"},//3
                                {"sWidth" : "5%","bSortable" : true },//4
                                {"sWidth" : "10%","bSortable" : true,sClass: "alignRight" },//5
                                {"sWidth" : "10%","bSortable" : true,sClass: "alignRight" },//6
                                {"sWidth" : "10%","bSortable" : true,sClass: "alignRight" },//7
                                {"sWidth" : "5%","bSortable" : true,sClass: "alignRight" },//8
                                {"sWidth" : "10%","bSortable" : true,sClass: "alignRight" },//9
                                {"sWidth" : "10%","bSortable" : true },//10
                                {"sWidth" : "10%","bSortable" : true },//11
        ...
        function loadTable2(){
            $('#tabledata2').dataTable({
                ...
                "aoColumns" :   [{"bSearchable" : true, "bVisible" : true, "asSorting" : [ "asc" ] },
                                ...
                                {"sWidth" : "20%","bSortable" : true },//3
                                {"sWidth" : "10%","bSortable" : true },//4
                                {"sWidth" : "10%","bSortable" : true,sClass: "alignRight" },//5
                                {"sWidth" : "10%","bSortable" : true,sClass: "alignRight" },//6
                                {"sWidth" : "10%","bSortable" : true,sClass: "alignRight" },//7
                                {"sWidth" : "10%","bSortable" : true},//8
                                {"sWidth" : "10%","bSortable" : true}//9
                                ],
                        "initComplete": function(settings, json) {
                            printSptLampiran();
                        },
        ...
        function loadTable3(){
            $('#tabledata3').dataTable({
                ...
                "aoColumns" :   [{"bSearchable" : true, "bVisible" : true, "asSorting" : [ "asc" ] },
                                ...
                                {"sWidth" : "10%","bSortable" : true,sClass: "alignRight" },//6
                                {"sWidth" : "10%","bSortable" : true,sClass: "alignRight" },//7
                                {"sWidth" : "10%","bSortable" : true,sClass: "alignRight" },//8
                                {"sWidth" : "10%","bSortable" : true },//9
                                {"sWidth" : "10%","bSortable" : true },//10
                                {"sWidth" : "10%","bSortable" : true}//11
                                ]
