...
<%
    ...
    if(userIdWP==null){
        ...
        listCompareESPTPD = PstCompareEsptpd.listJoin(0, 0, "viewUser."+PstAppUserWP.fieldNames[PstAppUserWP.FLD_NPWPD]+"='"+idUser+"' and sptpd."+PstESPTPD.fieldNames[PstESPTPD.FLD_MASA_PAJAK]+"='"+paramSplit[1]+"' and sptpd."+PstESPTPD.fieldNames[PstESPTPD.FLD_TAHUN_PAJAK]+"='"+paramSplit[2]+"'", "");
    }else{
        listNamaBadan = PstNamaBadan.listJoinSpt(0, 0, 
	    "viewUser."+PstAppUserWP.fieldNames[PstAppUserWP.FLD_USER_ID]+"='"+ userIdWP +"'", "");
        listCompareESPTPD = PstCompareEsptpd.listJoin(0, 0, "viewUser."+PstAppUserWP.fieldNames[PstAppUserWP.FLD_USER_ID]+"='"+userIdWP+"' and sptpd."+PstESPTPD.fieldNames[PstESPTPD.FLD_MASA_PAJAK]+"='"+paramSplit[1]+"' and sptpd."+PstESPTPD.fieldNames[PstESPTPD.FLD_TAHUN_PAJAK]+"='"+paramSplit[2]+"'", "");
    }
              ...
              <tr>
                ...
                <td style="text-align:center">
                    ...
                    <%}else if(AppSetting.TYPE_KOP_WPONLINE==AppSetting.DISPENDA_KLUNGKUNG){%>
                        ...
                        Semarapura</p>
                    <%}else{%>
                        <h4><%=AppSetting.REPORT_INSTANSI%></h4>
                        <p><%=AppSetting.REPORT_DINAS%><br>
                        <%=AppSetting.REPORT_INSTANSI_ALAMAT%></p>
                    <%}%>
                </td>
                <td rowspan="2" style="text-align:center;">
                    ...
                    <%}else if(AppSetting.TYPE_KOP_WPONLINE==AppSetting.DISPENDA_KLUNGKUNG){%>
                        ...
                        <p>
                     <%}else if(AppSetting.TYPE_KOP_WPONLINE==AppSetting.DISPENDA_TABANAN){%>
                        <p align="left">
                        <label style="font-size:10px;">KODE ID   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <%=compareEsptpd.getKodeId() %></label>
                        <label style="font-size:10px;">MASA PAJAK  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <%= masaPajak.charAt(0) %><%= masaPajak.charAt(1) %></label>
                        <label style="font-size:10px;">TAHUN PAJAK &nbsp;&nbsp;&nbsp;: <%=tahunPajak.charAt(2)%><%=tahunPajak.charAt(3)%></label>
                        <p>        
                    <%}else{%>
                	  ...
                	  <tr>
                	    ...
                	    <td width="79%">
                                ...
                                <%if(AppSetting.TYPE_APP_BACKOFFICE==AppSetting.APP_PHRH){%>
                                    ...
                                    <div class="square3"><%=npwpd.charAt(1)%></div> 
                                    <div class="square3"><%=npwpd.charAt(2)%></div> 
                                    ...
                                    <div class="square3"><%=npwpd.charAt(8)%></div>
                                    <div class="square3"><%=npwpd.charAt(9)%></div>
                                    <div class="square3"><%=npwpd.charAt(10)%></div>
                                    <div class="square3"><%=npwpd.charAt(11)%></div>    
                                    <div class="square3"><%=npwpd.charAt(12)%></div>
                                    <div class="square3"><%=npwpd.charAt(13)%></div>
                                    <div class="square3"><%=npwpd.charAt(14)%></div>
                                    <div class="square3"><%=npwpd.charAt(15)%></div>
                                    <div class="square3"><%=npwpd.charAt(16)%></div>
                                    <div class="square3"><%=npwpd.charAt(17)%></div>
                                <%}else{%>
                                    <div class="square2"><%=npwpd.charAt(0)%></div>
