<%-- 
    Document   : wp-rpt-spt1-back
    Created on : Jan 24, 2017, 1:51:45 PM
    Author     : dimata005
--%>
...
<%
    ...
    String idUser="";
    if(session.getValue(SessUserWPSession.HTTP_SESSION_WPNAME)==null){
        idUser=npwpd;
        listNamaBadan = PstNamaBadan.listJoinSpt(0, 0, 
	    "viewUser."+PstAppUserWP.fieldNames[PstAppUserWP.FLD_NPWPD]+"='"+ idUser +"'", "");
        listCompareESPTPD = PstCompareEsptpd.listJoindua(0, 0, "viewUser."+PstAppUserWP.fieldNames[PstAppUserWP.FLD_NPWPD]+"='"+idUser+"' and sptpd."+PstESPTPD.fieldNames[PstESPTPD.FLD_MASA_PAJAK]+"='"+paramSplit[1]+"' and sptpd."+PstESPTPD.fieldNames[PstESPTPD.FLD_TAHUN_PAJAK]+"='"+paramSplit[2]+"'", "");
    }else{
        listNamaBadan = PstNamaBadan.listJoinSpt(0, 0, 
	    "viewUser."+PstAppUserWP.fieldNames[PstAppUserWP.FLD_USER_ID]+"='"+ session.getValue(SessUserWPSession.HTTP_SESSION_WPNAME) +"'", "");
        listCompareESPTPD = PstCompareEsptpd.listJoindua(0, 0, "viewUser."+PstAppUserWP.fieldNames[PstAppUserWP.FLD_USER_ID]+"='"+session.getValue(SessUserWPSession.HTTP_SESSION_WPNAME)+"' and sptpd."+PstESPTPD.fieldNames[PstESPTPD.FLD_MASA_PAJAK]+"='"+paramSplit[1]+"' and sptpd."+PstESPTPD.fieldNames[PstESPTPD.FLD_TAHUN_PAJAK]+"='"+paramSplit[2]+"'", "");
    }
...
<body class="tablereport">
    	...
    	<div class="row">
        	 <table width="100%" border="1">
              <tr>
                <td style="text-align:center" rowspan="2"><h2>SPTPD</h2>
                DISAMPAIKAN KEPADA<br>
                BUPATI GIANYAR<br>
                MELALUI DINAS PENDAPATAN<br>
                KABUPATEN GIANYAR </td>
                <td style="text-align:center"><h4>SURAT PEMBERITAHUAN PAJAK DAERAH</h4></td>
                <td rowspan="2" style="text-align:center;"><h4>MASA PAJAK</h4><br>
                	  ...
                	  <tr>
                	    ...
                	    <td width="79%">
                        	<div class="square2"><%=npwpd.charAt(0)%></div>
                                ...
                                <div class="square4"><%=npwpd.charAt(7)%></div>
                                <div class="square3"><%=npwpd.charAt(8)%></div>
                                <div class="square4"><%=npwpd.charAt(10)%></div>
