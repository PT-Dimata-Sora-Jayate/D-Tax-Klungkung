            ...
            if(userSession.checkPrivG1(AppObjInfo.G1_HOME)){
                %>
                    <li class="treeview" id="home">
                        ...
                        <i class="fa fa-check"></i> <span>1.Check Data</span>
                      </a>
                    </li>
                    <li class="treeview" id="home">
                        <a href="<%= approot %>/dslik/proses/cek_error_validasi_ojk.jsp">
                        <i class="fa fa-check"></i> <span>2.Cek File Validasi OJK</span>
                      </a>
                    </li>
                    <% if(userSession.checkPrivG1(AppObjInfo.G1_PROSES_TRANSFER_DATA)){%>
                        <li class="treeview" id="home">
                            <a href="<%= approot %>/dslik/pelaporan/konflik_cif.jsp">
                            <i class="fa fa-check"></i> <span>3.Perubahan CIF Fasilitas</span>
                          </a>
                        </li>
                        <li class="treeview" id="home">
                            <a href="<%= approot %>/dslik/pelaporan/error_jenis_debitur_berubah.jsp">
                            <i class="fa fa-check"></i> <span>4.Perubahan Jenis Debitur</span>
                          </a>
                        </li>
                         <li class="treeview" id="home">
                            <a href="<%= approot %>/dslik/pelaporan/hapus_data_segment.jsp">
                            <i class="fa fa-check"></i> <span>(**) Hapus Data Segment</span>
                          </a>
                        </li>
                    <%}%>
                <%
                    ...
                    <li class="treeview" id="masterdata">
                        ...
                        <ul class="treeview-menu">
                          ...
                          <%
                            ...
                            if(userSession.checkPrivG1G2(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_AGUNAN_DATA)){
                                %>
                                    <li id="validasitransfer"><a href="<%= approot %>/dslik/proses/validasi_transfer.jsp"><i class="fa fa-circle-o"></i> Validasi Transfer</a></li>
                                <%
                            }
                            if(userSession.checkPrivG1G2(AppObjInfo.G1_PROSES_TRANSFER_DATA, AppObjInfo.G2_TRANSFER_AGUNAN_DATA)){
                                %>
                                    <li id="validasiojk"><a href="<%= approot %>/dslik/proses/validasi_ojk.jsp"><i class="fa fa-circle-o"></i> Upload Validasi Ojk</a></li>
                                    <%--<li id="validasiojk"><a href="<%= approot %>/dslik/proses/update_transfer_data_kredit.jsp"><i class="fa fa-circle-o"></i> Update Bunga Transfer Kredit Data </a></li>
                                    <li id="validasiojk"><a href="<%= approot %>/dslik/proses/update_transfer_pekerjaan_data_debitur.jsp"><i class="fa fa-circle-o"></i> Update Kode Pekerjaan Transfer Debitur Data </a></li>--%>
                                <%
                            }
                          %>
                        </ul>
                        ...
                        <ul class="treeview-menu">
                            <%
                                if(userSession.checkPrivG1G2(AppObjInfo.G1_MODUL_LAPORAN, AppObjInfo.G2_PER_SEGMENT_SUMMARY)){
                                    %>
                                        <li id="chaneltype"><a href="<%= approot %>/dslik/pelaporan/perbaikan_per_cabang.jsp"><i class="fa fa-circle-o"></i>Summary Error Per Cabang</a></li>
                          ...
                          <%
                            if(userSession.checkPrivG1G2(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_PROFILE_BANK)){
                                %>
                                    ...
                                    <li class="treeview" id="masterpenjamindata">
                                        <a href="#">
                                            <i class="fa fa-th-list"></i>
                                            <span>Profile Master Penjamin</span>
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </a>
                                        <ul class="treeview-menu">
                                            <%                                                                                                
                                                if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_PROFILE_BANK, AppObjInfo.OBJ_CABANG_BANK)){
                                                    %>
                                                        <li id="badanusaha"><a href="<%= approot %>/dslik/masterdata/master_penjamin.jsp"><i class="fa fa-circle-o"></i>Master Penjamin</a></li>
                                                    <%
                                                }
                                            %> 
                                        </ul>
                                        ...
                                        <ul class="treeview-menu">
                                            <%
                                                if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_BENTUK_BADAN_USAHA)){
                                                    %>
                                                        <li id="chaneltype"><a href="<%= approot %>/dslik/contentdata/kantorCabang.jsp"><i class="fa fa-circle-o"></i> Conten Data Kantor Cabang</a></li>
                                                ...
                                                if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_BIDANG_USAHA)){
                                                    %>
                                                        ...
                                                        <li id="chaneltype"><a href="<%= approot %>/dslik/contentdata/bidang_usaha_enam_digit.jsp"><i class="fa fa-circle-o"></i> Bidang Usaha Enam Digit</a></li>
                                                    <%
                                                }
                                                ...
                                                if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_KABUPATEN_KOTA)){
                                                    %>
                                                        <li id="chaneltype"><a href="<%= approot %>/dslik/contentdata/kecamatan.jsp"><i class="fa fa-circle-o"></i> Kecamatan </a></li>
                                                ...
                                                if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_KABUPATEN_KOTA)){
                                                    %>
                                                        <li id="chaneltype"><a href="<%= approot %>/dslik/masterdata/master_cif_hapus_buku.jsp"><i class="fa fa-circle-o"></i> Master cif Hapus Buku </a></li>
                                                ...
                                                if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_KODE_PEKERJAAN)){
                                                    %>
                                                        ...
                                                        <li id="badanusaha"><a href="<%= approot %>/dslik/contentdata/kodeProgramPemerintah.jsp"><i class="fa fa-circle-o"></i>Kode Program Pemerintah</a></li> 
                                                ...
                                                if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_DSLIK_DEBITUR)){
                                                    %>
                                                        <li id="chaneltype"><a href="<%= approot %>/page/masterdata/chaneltype.jsp"><i class="fa fa-circle-o"></i>  Debitur</a></li>
                                                ...
                                                if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_DSLIK_FASILITAS_LAIN)){
                                                    %>
                                                        <li id="chaneltype"><a href="<%= approot %>/page/masterdata/chaneltype.jsp"><i class="fa fa-circle-o"></i>  Fasilitas Lain</a></li>
                                                ...
                                                if(userSession.checkPrivG1G2Obj(AppObjInfo.G1_MODUL_MASTER_DATA, AppObjInfo.G2_MAPPING_CONTENT_DATA, AppObjInfo.OBJ_DSLIK_IRREVICABLE_LC)){
                                                    %>
                                                        <li id="chaneltype"><a href="<%= approot %>/page/masterdata/chaneltype.jsp"><i class="fa fa-circle-o"></i>  Irrevocable LC</a></li>
