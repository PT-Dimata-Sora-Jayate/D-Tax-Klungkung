...
public class PstSettingEmail extends DBHandler implements I_DBInterface, I_DBType, I_Persintent {
    ...
    public static final int FLD_CC_EMAIL                = 5;
    public static final int FLD_DOMAIN_ROOT             = 6;

    public static  final String[] fieldNames = {
        "EMAIL_ID", "EMAIL_NAME", "PASSWORD", "HOST", "PORT","CC_EMAIL","DOMAIN_ROOT"
    } ;

    public static int[] fieldTypes = {
        TYPE_PK + TYPE_LONG + TYPE_ID, TYPE_STRING,   TYPE_STRING,  TYPE_STRING,  TYPE_STRING,  TYPE_STRING,TYPE_STRING,TYPE_STRING
    };
    ...
    public static SettingEmail fetch(long oid) {
        ...
        try {
            ...
            entObj.setCcEmail(pstObj.getString(FLD_CC_EMAIL));
            entObj.setDomainRoot(pstObj.getString(FLD_DOMAIN_ROOT));
        }
        catch(DBException e) {
     ...
     public static long insert(SettingEmail entObj) throws DBException  {
      PstSettingEmail pstObj = new PstSettingEmail(0);
        ...
        pstObj.setString(FLD_CC_EMAIL, entObj.getCcEmail());
        pstObj.setString(FLD_DOMAIN_ROOT, entObj.getDomainRoot());
        pstObj.insert();
    ...
    public static long update(SettingEmail entObj) {
     ...
     private static void resultToObject(ResultSet rs, SettingEmail entObj) {
        try {
            ...
            entObj.setCcEmail(rs.getString(fieldNames[FLD_CC_EMAIL]));
            entObj.setDomainRoot(rs.getString(fieldNames[FLD_DOMAIN_ROOT]));
        }catch(Exception e){
