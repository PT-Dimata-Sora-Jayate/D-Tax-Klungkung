...
d_port = detailSettingEmail.getPort(), //"587";
...
//    props.put("mail.smtp.ssl.enable","false");
    ...
    props.put("mail.smtp.ssl.trust", "mail.bpdbali.co.id");
...
public  String sendEamilNotif(String m_to , String m_subject , String m_text)
{
    ...
    try
    {
        ...
        msg.setFrom(new InternetAddress(d_email));
        msg.addRecipients(Message.RecipientType.TO,(InternetAddress.parse(d_email))); //agar bisa multiple email
        msg.addRecipients(Message.RecipientType.CC, (InternetAddress.parse(m_to)));
        Transport.send(msg);
    }
    catch (Exception mex)
    {
