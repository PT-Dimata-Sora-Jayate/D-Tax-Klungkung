...
//            System.out.println("=============================================");
      ...
      public String action(){
            ...
            try {
                ...
                resp_code =" TIDAK TER KONEKSI DENGAN PAYMENT POINT BANK BPD BALI "+ex.getMessage();
                ex.printStackTrace();
              }
             return resp_code;
      } 
     ...
     public static SOAPMessage createSOAPRequest() throws Exception {
        ...
        soapBodyElem1.addTextNode(""+AppSetting.USERNAME_PBB);
        SOAPElement soapBodyElem2 = soapBodyElem.addChildElement("sPassword", "example");
        soapBodyElem2.addTextNode(""+AppSetting.PWD_PBB);
