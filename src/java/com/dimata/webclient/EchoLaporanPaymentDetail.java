...
import com.dimata.dtaxintegration.session.DTaxIntegrationManagerPaymentPbb;
...
//    }
    ...
    public Vector getListPaymentDetailPBB(LaporanPayment laporanPayment){
		...
		DTaxIntegrationManagerPaymentPbb dtaxPaymentManager = new DTaxIntegrationManagerPaymentPbb();
        try {
			...
			if (!resp_code.equals("00") && !resp_code.equals("")){
				DTaxIntegrationManagerPaymentPbb.erorStatus = dtaxPaymentManager.getErorStatus()+"<br>"+resp_code+" "+resp_message;
			}
			...
			DTaxIntegrationManagerPaymentPbb.erorStatus = dtaxPaymentManager.getErorStatus()+"<br> Tidak Dapat Mengambil Data Payment";
            ex.printStackTrace();
        }
        return listPayment;
    }
   ...
   public Vector getListPaymentDetailPHR(LaporanPayment laporanPayment){
        ...
        try {
            ...
            ex.printStackTrace();
            System.out.println(" eror di cek data di : com.dimata.webclient.EchoLaporanPaymentDetail.getListPaymentDetailPHR()");
        }
        return listPayment;
    }
   
   
   public synchronized Vector getListPaymentDetailPHRforOpenPhr(LaporanPayment laporanPayment){
        String resp_code = new String();
        String resp_message = new String();
        Vector listPayment=new Vector();
        try {
            ...
            Document doc = (Document) result.getNode(); 
             ...
             for (int i = 0; i < list.getLength(); i++) {
                    ...
                    String childKeterangan = "Keterangan";
                    Node nodeKeterangan = (Node) tableNode.getElementsByTagName(childKeterangan).item(0);
                    String keterangan = nodeKeterangan.getTextContent();
                    
                    
                    String childNpwpd = "NPWPD";
                    Node nodeNpwpd = (Node) tableNode.getElementsByTagName(childNpwpd).item(0);
                    String npwpd = nodeNpwpd.getTextContent();
                    
                    String childTanggalAwal = "TanggalAwal";
                    Node nodeTanggalAwal = (Node) tableNode.getElementsByTagName(childTanggalAwal).item(0);
                    String tanggalAwal = nodeTanggalAwal.getTextContent();
                    
                    String childTanggalAkhir = "TanggalAkhir";
                    Node nodeTanggalAkhir = (Node) tableNode.getElementsByTagName(childTanggalAkhir).item(0);
                    String tanggalAkhir = nodeTanggalAkhir.getTextContent();
                    ...
                    payment.setNpwp(npwpd);
                    payment.setTglAwal(tanggalAwal);
                    payment.setTglAkhir(tanggalAkhir);
    ...
    public Vector getListPaymentDetailPHRforPhrH(LaporanPayment laporanPayment){
        String resp_code = new String();
        String resp_message = new String();
        Vector listPayment=new Vector();
        try {
            ...
            Document doc = (Document) result.getNode(); 
             ...
             for (int i = 0; i < list.getLength(); i++) {
                    ...
                    String childTagihanAdmin = "TagihanAdmin";
                    Node nodeTagihanAdmin = (Node) tableNode.getElementsByTagName(childTagihanAdmin).item(0);
                    String tagihanAdmin = nodeTagihanAdmin.getTextContent();
                    
                    String childtglJatuhTempo = "TanggalJatuhTempo";
                    Node nodeTglJatuhTempo = (Node) tableNode.getElementsByTagName(childtglJatuhTempo).item(0);
                    String tglJatuhTempo = nodeTglJatuhTempo.getTextContent();
                    
                    String childtglWaktu = "Waktu";
                    Node nodeWaktu = (Node) tableNode.getElementsByTagName(childtglWaktu).item(0);
                    String tglWaktu = nodeWaktu.getTextContent();
                    ...
                    payment.setTagihanAdmin(tagihanAdmin);
                    payment.setWaktu(tglWaktu);
                    payment.setTanggalJatuhTempo(tglJatuhTempo);
        ...
        try {
            ...
            Document doc = (Document) result.getNode(); 
             ...
             for (int i = 0; i < list.getLength(); i++) {
                    ...
                    String LetakPPAT = nodePPAT.getTextContent();
