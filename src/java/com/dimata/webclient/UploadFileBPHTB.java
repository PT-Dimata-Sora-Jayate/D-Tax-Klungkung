    ...
    public String actionBPHTB(FileSent fileSent) {
        ...
        try {
            ...
            if (resp_code.equals("00")) {
                ...
                DTaxManagerBphtb.statusProses = statusProses + " / Proses pengiriman Gagal ";
            } else if (resp_code.equals("05")) {
                DTaxManagerBphtb.statusProses = statusProses + " / Format atau nama file tidak cocok ";
            } else if (resp_code.equals("01")) {
                DTaxManagerBphtb.statusProses = statusProses + " / Tidak memiliki wewenang akses ";
            } else if (resp_code.equals("06")) {
                DTaxManagerBphtb.statusProses = statusProses + " / Tidak diijinkan mengupload data pada jam operasional bank";
            } else {
                DTaxManagerBphtb.statusProses = statusProses + " / Proses pengiriman Gagal ";
            }
            ...
            ex.printStackTrace();
            DTaxManagerBphtb.statusProses = statusProses + "<br>Gagal Kirim";
        }
        return resp_status;
    }
