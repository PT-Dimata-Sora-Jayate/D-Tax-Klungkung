...
//    public static int LAMPIRAN_PRINT = DISPENDA_BULELENG;
    ...
    public static String REPORT_DINAS ="BADAN PENGELOLAAN KEUANGAN DAN PENDAPATAN DAERAH KABUPATEN KLUNGKUNG";
    public static String REPORT_INSTANSI_ALAMAT ="Jl. Untung Suropati No.2, Semarapura Tengah, Kec. Klungkung, Kabupaten Klungkung, Bali 80761";
    ...
    public static int TYPE_APP_BACKOFFICE=APP_IPROTAX;
...
//    public static String IP_BANK_BPD ="http://wsgen1.bpdbali.co.id:99/index.asmx";
    ...
    public static String PWD_PBB ="i8727rPbb@klkbpdb4l1";
    ...
    public static String PWD_BPHTB ="8v27rHbphTbklk@bpdb41";
