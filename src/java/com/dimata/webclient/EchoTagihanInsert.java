...
import static com.dimata.dtaxintegration.session.DTaxIntegrationMonitor.setLogErorPosting;
...
//    }
    ...
    public synchronized String action(TagihanInsert tagihanInsert){
        ...
        try {
            ...
            ex.printStackTrace();
            setLogErorPosting(""+" Posting Data Pajak : "+" Gagal Cek Koneksi "+resp_code +" Message : "+resp_message);
        }
        return resp_code;
    }
