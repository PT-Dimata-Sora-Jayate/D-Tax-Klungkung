...
public class DTaxIntegrationManagerPaymentPbb {
    ...
    public DTaxIntegrationManagerPaymentPbb() {
    ...
    public void startMonitor() {
        ...
        if(running) return;
			DTaxIntegrationManagerPaymentPbb objMan = new  DTaxIntegrationManagerPaymentPbb();

            Thread thLocker = new Thread(new dTaxMonitorPaymentPbb());
