...
public class report_phr_harian_pdf extends HttpServlet {
            ...
            if (result != null && result.size() > 0) {
                ...
                for (int i = 0; i < result.size(); i++) {
                    ...
                    try {
                        ...
                        cnt = new Cell(new Chunk("" + FRMHandler.userFormatStringDecimal(paymentPhr.getPokok()), fontContentSmall));//3
                        ...
                        cnt = new Cell(new Chunk("", fontContentSmall)); //8
...
//                content.addCell(cnt);
    ...
    public static Table getHeader() throws Exception {
        ...
        int contentWith[] = {10, 20, 20, 20, 30};
        ...
        cnt = new Cell(new Chunk("", fontContentSmall));
