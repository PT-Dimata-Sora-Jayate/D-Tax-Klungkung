...
public class PstPaymentBphtbIprotax extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static PaymentBphtbIprotax fetchExc(long oid) throws DBException {
        try {
            ...
            entPaymentBphtbprotax.setKdProvinsi(pstPaymentBphtbIprotax.getString(FLD_KDPROPINSI));
    ...
    public static synchronized long updateExc(PaymentBphtbIprotax entPaymentBphtbIprotax) throws DBException {
        try {
            ...
            throw new DBException(new PstPaymentBphtbIprotax(0), DBException.UNKNOWN);
        }
        return 0;
    }
    ...
    public static void resultToObject(ResultSet rs, PaymentBphtbIprotax entPaymentBphtbIprotax) {
        try {
            ...
            entPaymentBphtbIprotax.setKdProvinsi(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_KDPROPINSI]));
            entPaymentBphtbIprotax.setKdDati2(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_KDDATI2]));
            entPaymentBphtbIprotax.setThbBphtb(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_THNBPHTB]));
            entPaymentBphtbIprotax.setBlnBphtb(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_BLNBPHTB]));
            entPaymentBphtbIprotax.setTglBphtb(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_TGLBPHTB]));
            entPaymentBphtbIprotax.setNoUrutBphtb(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_NOURUTBPHTB]));
            entPaymentBphtbIprotax.setIndeksBphtb(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_INDEKSBPHTB]));
            entPaymentBphtbIprotax.setKdPejabat(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_KDPEJABAT]));
            entPaymentBphtbIprotax.setKdBankPersepsi(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_KDBANKPERSEPSI]));
            entPaymentBphtbIprotax.setTglPembayaran(rs.getDate(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_TGLPEMBAYARAN]));
            
            entPaymentBphtbIprotax.setNamaWP(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_NAMAWP]));
            entPaymentBphtbIprotax.setBphtbKurangBayar(rs.getDouble(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_BPHTBKURANGBAYAR]));
            entPaymentBphtbIprotax.setBphtbSdhBayar(rs.getDouble(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_BPHTBSUDAHBAYAR]));
            entPaymentBphtbIprotax.setKdTp(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_KDTP]));
            entPaymentBphtbIprotax.setUserBankRekam(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_USERBANKREKAM]));
            entPaymentBphtbIprotax.setNmPenyetor(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_NMPENYETOR]));
            entPaymentBphtbIprotax.setKdSumberData(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_KDSUMBERDATA]));
                entPaymentBphtbIprotax.setNoTransaksiBayarBank(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_NOTRANSAKSIBYRBANK]));
                entPaymentBphtbIprotax.setNoTransaksiBayar(rs.getString(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_NOTRANSAKSIBYR]));
                entPaymentBphtbIprotax.setTglPembayaran(rs.getDate(PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_REKAM_BAYAR]));
    ...
    public static boolean checkOID(long entPaymentBphtbIprotaxId) {
        ...
        try {
            String sql = "SELECT * FROM " + TBL_PAYMENTBPHTBIPROTAX + " WHERE "
                    + PstPaymentBphtbIprotax.fieldNames[PstPaymentBphtbIprotax.FLD_KDPROPINSI] + " = " + entPaymentBphtbIprotaxId;
            dbrs = DBHandler.execQueryResult(sql);
            ResultSet rs = dbrs.getResultSet();
            while (rs.next()) {
                result = true;
