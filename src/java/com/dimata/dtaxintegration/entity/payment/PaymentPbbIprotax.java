...
public class PaymentPbbIprotax extends Entity{
    ...
    //2017-132
    private double jmlpenguranganpokok=0.0;
    private double jmlpengurangandenda=0.0;
    ...
    /**
     * @return the jmlpenguranganpokok
     */
    public double getJmlpenguranganpokok() {
        return jmlpenguranganpokok;
    }

    /**
     * @param jmlpenguranganpokok the jmlpenguranganpokok to set
     */
    public void setJmlpenguranganpokok(double jmlpenguranganpokok) {
        this.jmlpenguranganpokok = jmlpenguranganpokok;
    }

    /**
     * @return the jmlpengurangandenda
     */
    public double getJmlpengurangandenda() {
        return jmlpengurangandenda;
    }

    /**
     * @param jmlpengurangandenda the jmlpengurangandenda to set
     */
    public void setJmlpengurangandenda(double jmlpengurangandenda) {
        this.jmlpengurangandenda = jmlpengurangandenda;
    }
}
