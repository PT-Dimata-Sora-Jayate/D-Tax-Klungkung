 ...
 * @author dimata005
 */
public class PaymentPhrforPhrH extends Entity {
    ...
    private Date tglJatuhTemp = new Date();
    private double tagihanAdmin =0;
    ...
    /**
     * @return the tglJatuhTemp
     */
    public Date getTglJatuhTemp() {
        return tglJatuhTemp;
    }

    /**
     * @param tglJatuhTemp the tglJatuhTemp to set
     */
    public void setTglJatuhTemp(Date tglJatuhTemp) {
        this.tglJatuhTemp = tglJatuhTemp;
    }

    /**
     * @return the tagihanAdmin
     */
    public double getTagihanAdmin() {
        return tagihanAdmin;
    }
     ...
     */
    public void setTagihanAdmin(double tagihanAdmin) {
