...
package com.dimata.saras.entity.admin;
...
import static com.dimata.webclient.AppSetting.DBSVR_MSSQL;
...
public class PstAppPrivilegeObj extends DBHandler implements I_DBInterface, I_DBType, I_Persintent  {
    ...
    public static final String TBL_APP_PRIVILEGE_OBJ = "SARAS_APP_PRIVILEGE_OBJ";
    ...
    public static final String strObjFilter = AppSetting.SQL_VERSION == AppSetting.DBSVR_ORACLE ? FILTER_OBJ_ORACLE : FILTER_OBJ_MYSQL;//"0xFFFFFF00";
    public static final String strCmdFilter = AppSetting.SQL_VERSION == AppSetting.DBSVR_ORACLE ? FILTER_CMD_ORACLE : FILTER_CMD_MYSQL;//"0x000000FF";
    public static final String strSeperator = AppSetting.SQL_VERSION == AppSetting.DBSVR_ORACLE ? SEPERATOR_ORACLE : SEPERATOR_MYSQL;//"0x000000FF";
    public static final String strHexadecimal = AppSetting.SQL_VERSION == AppSetting.DBSVR_ORACLE ? HEXADECIMAL_ORACLE : HEXADECIMAL_MYSQL;//"0x000000FF";
