 ...
 * @author dimata005
 */
public class ManagerDilimitedText {

    public static boolean running = false;

    private static String statusStart = "";

    private static String statusEnd = "";
    ...
    public static void startDilimitedText(FileSent fileSent, OutletConnection outletConnection) {
        ...
        ManagerDilimitedText objMan = new ManagerDilimitedText();

        Thread thLocker = new Thread(new MonitorDilimitedText(fileSent, outletConnection));
