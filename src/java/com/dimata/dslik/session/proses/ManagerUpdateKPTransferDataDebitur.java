 ...
 * @author dimata005
 */
public class ManagerUpdateKPTransferDataDebitur {
    ...
    public static ManagerUpdateKPTransferDataDebitur lck = new ManagerUpdateKPTransferDataDebitur();
    ...
    public static void startTransfer(){    
        ...
        if(running) return;
            ...
            ManagerUpdateKPTransferDataDebitur objMan = new  ManagerUpdateKPTransferDataDebitur();

            Thread thLocker = new Thread(new MonitorUpdateKPTransferDataDebitur());
    ...
    public static String getStatusKreditStatic() {
        return statusKredit;
    }
    ...
    public static String getStatusDebiturStatic() {
        return statusDebitur;
    }
