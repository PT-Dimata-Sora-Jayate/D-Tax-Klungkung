        ...
        try {
            if(periodeId!=0){
                ...
                " SELECT "+
                        ...
                        " NULL AS STATUS_DATA, "+
                        "'"+periodeId+"' AS PERIODE_ID, "+
                        " 1 AS STATUS_OPERASI_DATA, POSISI_LAPORAN_KEUANGAN_TAHUNAN "+
...
//                }
    ...
    public static long deleteDataIntial() throws DBException {
        int iResult = 0;
        DBResultSet dbrs = null;
        String stSql = "DELETE FROM dslik_agunan_initial";
        try {
            iResult = DBHandler.execUpdate(stSql);
        } catch (DBException e) {
            e.printStackTrace();
          ...
          stSql = "DELETE FROM dslik_bank_garansi_initial";
        try {
            iResult = DBHandler.execUpdate(stSql);
        } catch (DBException e) {
            e.printStackTrace();
          ...
          stSql = "DELETE FROM dslik_debitur_initial";
        try {
            iResult = DBHandler.execUpdate(stSql);
        } catch (DBException e) {
            e.printStackTrace();
          ...
          stSql = "DELETE FROM dslik_kredit_initial";
        try {
            iResult = DBHandler.execUpdate(stSql);
        } catch (DBException e) {
            e.printStackTrace();
         ...
         stSql = "DELETE FROM dslik_pengurus_atau_pemilik_initial";
        try {
            iResult = DBHandler.execUpdate(stSql);
        } catch (DBException e) {
            e.printStackTrace();
         ...
         stSql = "DELETE FROM dslik_penjamin_inital";
        try {
            iResult = DBHandler.execUpdate(stSql);
        } catch (DBException e) {
            e.printStackTrace();
    ...
    public static Date tanggalAwalKredit(long periodeId, String noRekening, String cif, FileSent fileSent) throws DBException {
        Date hasil = null;
        DBResultSet dbrs = null;
        try {
            if(periodeId!=0){
                
                //kredit pada periode berjalan
                String sql =" SELECT " +
                            " * " 
                          + " FROM dslik_kredit WHERE dslik_kredit.PERIODE_ID='"+periodeId+"'"
                ...
                //dari data kredit lunas
                if(fileSent.isCreateInitial()){
                    if(hasil==null){
                        sql =" SELECT " +
                                    " * " 
                                  + " FROM dslik_kredit_initial WHERE "
                                  + " dslik_kredit_initial.NO_REKENING='"+noRekening+"'"
                                  + " AND dslik_kredit_initial.CIF='"+cif+"'";
                        dbrs = DBHandler.execQueryResult(sql);
    ...
    public static Date tanggalKondisi(long periodeId, String noRekening, String cif, FileSent fileSent) throws DBException {
        Date hasil = null;
        String kondisi ="";
        DBResultSet dbrs = null;
        try {
            if(periodeId!=0){
                ...
                ResultSet rs = dbrs.getResultSet();
                while (rs.next()) {
                   kondisi=rs.getString("KODE_KONDISI");
                   if(kondisi.equals("02")){
                       hasil=rs.getDate("TGL_KONDISI");
                   }
                }
    ...
    public static Date tanggalAwalBankGaransi(long periodeId, String noRekening, String cif, FileSent fileSent) throws DBException {
        Date hasil = null;
        DBResultSet dbrs = null;
        try {
            if(periodeId!=0){
                ...
                //data bank garansi lunas
                if(fileSent.isCreateInitial()){
                    if(hasil==null){
                        sql =" SELECT " +
                                    " * " 
                                  + " FROM dslik_bank_garansi_initial WHERE "
                                  + " dslik_bank_garansi_initial.NO_REKENING='"+noRekening+"'"
                                  + " AND dslik_bank_garansi_initial.CIF='"+cif+"'";
                        dbrs = DBHandler.execQueryResult(sql);
                         rs = dbrs.getResultSet();
                        while (rs.next()) {
                           hasil=rs.getDate("TGL_DITERBITKAN");
    ...
    public static Date tanggalKondisiBankGaransi(long periodeId, String noRekening, String cif,FileSent fileSent) throws DBException {
        Date hasil = null;
        String kondisi="";
        DBResultSet dbrs = null;
        try {
    ...
    public static long updateDebiturRemoveValue(long periodeId) throws DBException {
        int iResult = 0;
        DBResultSet dbrs = null;
        
        if(periodeId!=0){
            String stSql = "UPDATE dslik_debitur SET NIK = REPLACE(NIK, '-', '') WHERE periode_id='"+periodeId+"'";
            try {
                iResult = DBHandler.execUpdate(stSql);
            } catch (DBException e) {
                e.printStackTrace();
            ...
            stSql = "UPDATE dslik_debitur SET NIK = REPLACE(NIK, ' ', '') WHERE periode_id='"+periodeId+"'";
            try {
                iResult = DBHandler.execUpdate(stSql);
            } catch (DBException e) {
                e.printStackTrace();
            ...
            stSql = "UPDATE dslik_debitur SET NO_IDENTITAS = REPLACE(NO_IDENTITAS, ' ', '') WHERE periode_id='"+periodeId+"'";
            try {
                iResult = DBHandler.execUpdate(stSql);
            } catch (DBException e) {
                e.printStackTrace();
            ...
            stSql = "UPDATE dslik_debitur SET TEMPAT_LAHIR = REPLACE(TEMPAT_LAHIR, ',', '') WHERE periode_id='"+periodeId+"'";
            try {
                iResult = DBHandler.execUpdate(stSql);
            } catch (DBException e) {
                e.printStackTrace();
            ...
            stSql = "UPDATE dslik_debitur SET KELURAHAN = REPLACE(KELURAHAN, ',', '') WHERE periode_id='"+periodeId+"'";
            try {
                iResult = DBHandler.execUpdate(stSql);
            } catch (DBException e) {
                e.printStackTrace();
            ...
            stSql = "UPDATE dslik_debitur SET NPWP = REPLACE(NPWP, ' ', '') WHERE periode_id='"+periodeId+"'";
            try {
                iResult = DBHandler.execUpdate(stSql);
            } catch (DBException e) {
                e.printStackTrace();
            ...
            stSql = "UPDATE dslik_debitur SET NAMA_PASANGAN = REPLACE(NAMA_PASANGAN, ',', '') WHERE periode_id='"+periodeId+"'";
            try {
                iResult = DBHandler.execUpdate(stSql);
            } catch (DBException e) {
                e.printStackTrace();
            ...
            stSql = "UPDATE dslik_pengurus_atau_pemilik SET NO_IDENTITAS = REPLACE(NO_IDENTITAS, '.', '') WHERE periode_id='"+periodeId+"'";
            try {
                iResult = DBHandler.execUpdate(stSql);
            } catch (DBException e) {
                e.printStackTrace();
     ...
     public static long moveDataKreditInitial(long periodeId) throws DBException {
        long hasil = 0;
        try {
            if(periodeId!=0){
                String sql =""+
                " INSERT IGNORE INTO dslik_kredit_initial (KREDIT_OID, FLAG_DETAIL, NO_REKENING, CIF, KODE_SIFAT, KODE_JENIS_KREDIT, KODE_AKAD, NO_AKAD_AWAL, TGL_AKAD_AWAL, NO_AKAD_AKHIR, TGL_AKAD_AKHIR, BARU_PERPANJANGAN, TGL_AWAL, TGL_MULAI, TGL_TEMPO, KODE_KAT_DEBITUR, KODE_JENIS_PENGGUNAAN, KODE_ORIENTASI_PENGGUNAAN, KODE_SEKTOR_EKONOMI, KODE_KAB, NILAI, KODE_VALUTA, PROSENTASE_BUNGA, JENIS_BUNGA, KREDIT_PEMERINTAH, TAKEOVER, SUMBER_DANA, PLAFON_AWAL, PLAFON, REALISASI, DENDA, BAKI_DEBET, NILAI_UANG_ASAL, KODE_KOLEKTIBILITAS, TGL_MACET, KODE_SEBAB_MACET, TUNGGAKAN_POKOK, TUNGGAKAN_BUNGA, JML_HARI_TUNGGAKAN, FREKUENSI_TUNGGAKAN, FREKUENSI_RESTRUKTURISASI, TGL_RESTRUKTURISASI_AWAL, TGL_RESTRUKTURISASI_AKHIR, KODE_CARA, KODE_KONDISI, TGL_KONDISI, KETERANGAN, KODE_KANTOR_CABANG, OPERASI_DATA, OPEN_DATE, STATUS_DATA, PERIODE_ID, APPLID, STATUS_OPERASI_DATA) "
                + " SELECT KREDIT_OID, FLAG_DETAIL, NO_REKENING, CIF, KODE_SIFAT, KODE_JENIS_KREDIT, KODE_AKAD, NO_AKAD_AWAL, TGL_AKAD_AWAL, NO_AKAD_AKHIR, TGL_AKAD_AKHIR, BARU_PERPANJANGAN, TGL_AWAL, TGL_MULAI, TGL_TEMPO, KODE_KAT_DEBITUR, KODE_JENIS_PENGGUNAAN, KODE_ORIENTASI_PENGGUNAAN, KODE_SEKTOR_EKONOMI, KODE_KAB, NILAI, KODE_VALUTA, PROSENTASE_BUNGA, JENIS_BUNGA, KREDIT_PEMERINTAH, TAKEOVER, SUMBER_DANA, PLAFON_AWAL, PLAFON, REALISASI, DENDA, BAKI_DEBET, NILAI_UANG_ASAL, KODE_KOLEKTIBILITAS, TGL_MACET, KODE_SEBAB_MACET, TUNGGAKAN_POKOK, TUNGGAKAN_BUNGA, JML_HARI_TUNGGAKAN, FREKUENSI_TUNGGAKAN, FREKUENSI_RESTRUKTURISASI, TGL_RESTRUKTURISASI_AWAL, TGL_RESTRUKTURISASI_AKHIR, KODE_CARA, KODE_KONDISI, TGL_KONDISI, KETERANGAN, KODE_KANTOR_CABANG, OPERASI_DATA, OPEN_DATE, STATUS_DATA, PERIODE_ID, APPLID, STATUS_OPERASI_DATA "
                + " FROM dslik_kredit where KODE_KONDISI='02' and PERIODE_ID='"+periodeId+"'";
                int result = execUpdate(sql);
    ...
    public static long moveDataDebiturInitial(long periodeId) throws DBException {
        long hasil = 0;
        try {
            if(periodeId!=0){
                String sql =""+
                " INSERT IGNORE INTO dslik_debitur_initial (DEBITUR_OID, KODE_JENIS_NSB, FLAG_DETAIL, CIF, JENIS_IDENTITAS, NIK, NAMA_IDENTITAS, NAMA_LENGKAP, KODE_STATUS_GELAR, JEKEL, TEMPAT_LAHIR, TANGGAL_LAHIR, NPWP, ALAMAT, KELURAHAN, KECAMATAN, KODE_KAB, KODE_POS, TELEPON, NOMOR_HP, EMAIL, KODE_DOMISILI, KODE_PEKERJAAN, TEMPAT_BEKERJA, KODE_USAHA_TEMPAT_BEKERJA, ALAMAT_TEMPAT_BEKERJA, PENGHASILAN_KOTOR, KODE_PENGHASILAN, JML_TANGGUNGAN, KODE_HUB, KODE_GOL, STATUS, NIK_PASANGAN, NAMA_PASANGAN, TGL_LAHIR_PASANGAN, PERJANJIAN_PISAH_HARGA, MELANGGAR_BMPK, MELAMPAUI_BMPK, NAMA_IBU_KANDUNG, KODE_KANTOR_CABANG, NO_IDENTITAS, NAMA_BADAN_USAHA, KODE_JENIS_USAHA, TEMPAT_PENDIRIAN, NO_AKTE, TGL_AKTE_PENDIRIAN, NO_AKTE_PERUBAHAN, TGL_AKTE_PERUBAHAN, KODE_BIDANG_USAHA, KODE_HUB_LJK, GO_PUBLIC, PERINGKAT, LEMBAGA_PEMERINGKAT, TGL_PEMERINGKAT, NAMA_GROUP, OPERASI_DATA, OPEN_DATE, STATUS_DATA, PERIODE_ID, STATUS_OPERASI_DATA) "
              + " SELECT DISTINCT DEBITUR_OID, KODE_JENIS_NSB, FLAG_DETAIL, CIF, JENIS_IDENTITAS, NIK, NAMA_IDENTITAS, NAMA_LENGKAP, KODE_STATUS_GELAR, JEKEL, TEMPAT_LAHIR, TANGGAL_LAHIR, NPWP, ALAMAT, KELURAHAN, KECAMATAN, KODE_KAB, KODE_POS, TELEPON, NOMOR_HP, EMAIL, KODE_DOMISILI, KODE_PEKERJAAN, TEMPAT_BEKERJA, KODE_USAHA_TEMPAT_BEKERJA, ALAMAT_TEMPAT_BEKERJA, PENGHASILAN_KOTOR, KODE_PENGHASILAN, JML_TANGGUNGAN, KODE_HUB, KODE_GOL, STATUS, NIK_PASANGAN, NAMA_PASANGAN, TGL_LAHIR_PASANGAN, PERJANJIAN_PISAH_HARGA, MELANGGAR_BMPK, MELAMPAUI_BMPK, NAMA_IBU_KANDUNG, KODE_KANTOR_CABANG, NO_IDENTITAS, NAMA_BADAN_USAHA, KODE_JENIS_USAHA, TEMPAT_PENDIRIAN, NO_AKTE, TGL_AKTE_PENDIRIAN, NO_AKTE_PERUBAHAN, TGL_AKTE_PERUBAHAN, KODE_BIDANG_USAHA, KODE_HUB_LJK, GO_PUBLIC, PERINGKAT, LEMBAGA_PEMERINGKAT, TGL_PEMERINGKAT, NAMA_GROUP, OPERASI_DATA, OPEN_DATE, STATUS_DATA, PERIODE_ID, STATUS_OPERASI_DATA "
              + " FROM dslik_debitur where PERIODE_ID='"+periodeId+"' AND CIF IN (SELECT DISTINCT CIF FROM dslik_kredit WHERE KODE_KONDISI='02' AND PERIODE_ID='"+periodeId+"' UNION ALL SELECT DISTINCT CIF FROM dslik_bank_garansi WHERE KODE_KONDISI='02' AND PERIODE_ID='"+periodeId+"')";
                int result = execUpdate(sql);
    ...
    public static long moveDataAgunanInitial(long periodeId) throws DBException {
        long hasil = 0;
        try {
            if(periodeId!=0){
                String sql =""+
                " INSERT IGNORE INTO dslik_agunan_initial (AGUNAN_OID, FLAG_DETAIL, KODE_REGISTER_AGUNAN, NO_REKENING, CIF, KODE_STATUS_AGUNAN, KODE_JENIS_AGUNAN, PERINGKAT_AGUNAN, KODE_LEMBAGA_PEMERINGKAT, KODE_JENIS_PENGIKATAN, TGL_PENGIKATAN, NAMA_PEMILIK_AGUNAN, BUKTI_KEPEMILIKAN, ALAMAT_AGUNAN, KODE_KAB_LOKASI_AGUNAN, NILAI_AGUNAN_NJOP, NILAI_AGUNAN_LJK, TGL_PENILAIAN_LJK, NILAI_AGU_PENILAI_INDEP, NAMA_PENILAI_INDEP, TGL_PENILAIAN_PENILAI_INDEP, STATUS_PARIPASU, PROSENTASE_PARIPASU, STATUS_KREDIT_JOIN, DIASURANSIKAN, KETERANGAN, KODE_KANTOR_CABANG, OPERASI_DATA, OPEN_DATE, STATUS_DATA, PERIODE_ID, STATUS_OPERASI_DATA, KODE_JENIS_SEGMENT_FASILITAS)"
              + " SELECT DISTINCT AGUNAN_OID, FLAG_DETAIL, KODE_REGISTER_AGUNAN, NO_REKENING, CIF, KODE_STATUS_AGUNAN, KODE_JENIS_AGUNAN, PERINGKAT_AGUNAN, KODE_LEMBAGA_PEMERINGKAT, KODE_JENIS_PENGIKATAN, TGL_PENGIKATAN, NAMA_PEMILIK_AGUNAN, BUKTI_KEPEMILIKAN, ALAMAT_AGUNAN, KODE_KAB_LOKASI_AGUNAN, NILAI_AGUNAN_NJOP, NILAI_AGUNAN_LJK, TGL_PENILAIAN_LJK, NILAI_AGU_PENILAI_INDEP, NAMA_PENILAI_INDEP, TGL_PENILAIAN_PENILAI_INDEP, STATUS_PARIPASU, PROSENTASE_PARIPASU, STATUS_KREDIT_JOIN, DIASURANSIKAN, KETERANGAN, KODE_KANTOR_CABANG, OPERASI_DATA, OPEN_DATE, STATUS_DATA, PERIODE_ID, STATUS_OPERASI_DATA, KODE_JENIS_SEGMENT_FASILITAS "
              + " FROM dslik_agunan WHERE PERIODE_ID='"+periodeId+"' AND (NO_REKENING, CIF) IN (SELECT DISTINCT NO_REKENING, CIF FROM dslik_kredit WHERE KODE_KONDISI='02' AND PERIODE_ID='"+periodeId+"' UNION ALL SELECT DISTINCT NO_REKENING, CIF FROM dslik_bank_garansi WHERE KODE_KONDISI='02' AND PERIODE_ID='"+periodeId+"') ";
                int result = execUpdate(sql);
                hasil = periodeId;
            }
        }
    ...
    public static long moveDataBankGaransiInitial(long periodeId) throws DBException {
        long hasil = 0;
        try {
            if(periodeId!=0){
                String sql =""+
                  " INSERT IGNORE INTO dslik_bank_garansi_initial (BANK_GARANSI_OID, FLAG_DETAIL, NO_REKENING, CIF, KODE_JENIS_GARANSI, KODE_TUJUAN_GARANSI, TGL_DITERBITKAN, TGL_JATUH_TEMPO, NO_AKAD_AWAL, TGL_AKAD_AWAL, NO_AKAD_AKHIR, TGL_AKAD_AKHIR, NAMA_YG_DIJAMIN, KODE_VALUTA, PLAFON, NOMINAL, SETORAN_JAMINAN, KODE_KOLEKTIBILITAS, TGL_WAN_PRESTASI, KODE_KONDISI, TGL_KONDISI, KETERANGAN, KODE_KANTOR_CABANG, OPERASI_DATA, OPEN_DATE, STATUS_DATA, PERIODE_ID, STATUS_OPERASI_DATA) "
                + " SELECT DISTINCT BANK_GARANSI_OID, FLAG_DETAIL, NO_REKENING, CIF, KODE_JENIS_GARANSI, KODE_TUJUAN_GARANSI, TGL_DITERBITKAN, TGL_JATUH_TEMPO, NO_AKAD_AWAL, TGL_AKAD_AWAL, NO_AKAD_AKHIR, TGL_AKAD_AKHIR, NAMA_YG_DIJAMIN, KODE_VALUTA, PLAFON, NOMINAL, SETORAN_JAMINAN, KODE_KOLEKTIBILITAS, TGL_WAN_PRESTASI, KODE_KONDISI, TGL_KONDISI, KETERANGAN, KODE_KANTOR_CABANG, OPERASI_DATA, OPEN_DATE, STATUS_DATA, PERIODE_ID, STATUS_OPERASI_DATA "
                        + " FROM dslik_bank_garansi WHERE PERIODE_ID='"+periodeId+"' AND KODE_KONDISI='02'";
                int result = execUpdate(sql);
    ...
    public static long moveDataPengurusPemilikInitial(long periodeId) throws DBException {
        long hasil = 0;
        try {
            if(periodeId!=0){
                String sql =""+
                          " INSERT IGNORE INTO dslik_pengurus_atau_pemilik_initial (PENGURUS_OID, FLAG_DETAIL, NO_IDENTITAS, CIF, JENIS_IDENTITAS, NAMA_PENGURUS, JENIS_KELAMIN, ALAMAT, KELURAHAN, KECAMATAN, KODE_KABUPATEN, KODE_JABATAN, PANGSA_KEPEMILIKAN, STATUS_PENGURUS, KODE_KANTOR_CABANG, OPERASI_DATA, OPEN_DATE, STATUS_DATA, PERIODE_ID, STATUS_OPERASI_DATA) "
                        + " SELECT DISTINCT PENGURUS_OID, FLAG_DETAIL, NO_IDENTITAS, CIF, JENIS_IDENTITAS, NAMA_PENGURUS, JENIS_KELAMIN, ALAMAT, KELURAHAN, KECAMATAN, KODE_KABUPATEN, KODE_JABATAN, PANGSA_KEPEMILIKAN, STATUS_PENGURUS, KODE_KANTOR_CABANG, OPERASI_DATA, OPEN_DATE, STATUS_DATA, PERIODE_ID, STATUS_OPERASI_DATA "
                        + " FROM dslik_pengurus_atau_pemilik WHERE PERIODE_ID='"+periodeId+"' AND CIF IN (SELECT DISTINCT CIF FROM dslik_kredit WHERE KODE_KONDISI='02' AND PERIODE_ID='"+periodeId+"' UNION ALL SELECT DISTINCT CIF FROM dslik_bank_garansi WHERE KODE_KONDISI='02' AND PERIODE_ID='"+periodeId+"')";
                int result = execUpdate(sql);
    ...
    public static long moveDataPenjaminInitial(long periodeId) throws DBException {
        long hasil = 0;
        try {
            if(periodeId!=0){
                String sql =""+
                          " INSERT IGNORE INTO dslik_penjamin_inital (PENJAMIN_OID, FLAG_DETAIL, NO_ID_PENJAMIN, NO_REKENING, CIF, JENIS_IDENTITAS, NAMA_IDENTITAS, NAMA_LENGKAP, KODE_GOL_PENJAMIN, ALAMAT_PENJAMIN, PROSENTASE_DIJAMIN, KETERANGAN, KODE_KANTOR_CABANG, OPERASI_DATA, OPEN_DATE, STATUS_DATA, PERIODE_ID, STATUS_OPERASI_DATA, KODE_JENIS_SEGMENT_FASILITAS) "
                        + " SELECT DISTINCT PENJAMIN_OID, FLAG_DETAIL, NO_ID_PENJAMIN, NO_REKENING, CIF, JENIS_IDENTITAS, NAMA_IDENTITAS, NAMA_LENGKAP, KODE_GOL_PENJAMIN, ALAMAT_PENJAMIN, PROSENTASE_DIJAMIN, KETERANGAN, KODE_KANTOR_CABANG, OPERASI_DATA, OPEN_DATE, STATUS_DATA, PERIODE_ID, STATUS_OPERASI_DATA, KODE_JENIS_SEGMENT_FASILITAS "
                        + " FROM dslik_penjamin WHERE PERIODE_ID='"+periodeId+"' AND (CIF, NO_REKENING) IN (NO_REKENING, CIF) IN (SELECT DISTINCT NO_REKENING, CIF FROM dslik_kredit WHERE KODE_KONDISI='02' AND PERIODE_ID='"+periodeId+"' UNION ALL SELECT DISTINCT NO_REKENING, CIF FROM dslik_bank_garansi WHERE KODE_KONDISI='02' AND PERIODE_ID='"+periodeId+"')";
                int result = execUpdate(sql);
    ...
    public static long deleteDataIntialInPeriode(long periodeId) throws DBException {
        int iResult = 0;
        if(periodeId!=0){
            DBResultSet dbrs = null;
            String stSql = "DELETE FROM dslik_kredit_initial WHERE (NO_REKENING,CIF)  IN (SELECT NO_REKENING,CIF FROM dslik_kredit WHERE periode_id='"+periodeId+"')";
            try {
                iResult = DBHandler.execUpdate(stSql);
            } catch (DBException e) {
                e.printStackTrace();
            ...
            stSql = "DELETE FROM dslik_bank_garansi_initial WHERE  (NO_REKENING,CIF)  IN (SELECT NO_REKENING,CIF FROM dslik_bank_garansi WHERE periode_id='"+periodeId+"')";
            try {
                iResult = DBHandler.execUpdate(stSql);
            } catch (DBException e) {
                e.printStackTrace();
             ...
             stSql = "DELETE FROM dslik_debitur_initial WHERE cif IN (SELECT cif FROM dslik_debitur WHERE periode_id='"+periodeId+"')";
            try {
                iResult = DBHandler.execUpdate(stSql);
            } catch (DBException e) {
                e.printStackTrace();
            ...
            stSql = "DELETE FROM dslik_pengurus_atau_pemilik_initial WHERE CIF IN (SELECT CIF FROM dslik_pengurus_atau_pemilik WHERE periode_id='"+periodeId+"')";
            try {
                iResult = DBHandler.execUpdate(stSql);
            } catch (DBException e) {
                e.printStackTrace();
            ...
            stSql = "DELETE FROM dslik_penjamin_inital WHERE (CIF,NO_REKENING) IN (SELECT CIF, NO_REKENING  FROM dslik_penjamin WHERE periode_id='"+periodeId+"')";
            try {
                iResult = DBHandler.execUpdate(stSql);
            } catch (DBException e) {
                e.printStackTrace();
