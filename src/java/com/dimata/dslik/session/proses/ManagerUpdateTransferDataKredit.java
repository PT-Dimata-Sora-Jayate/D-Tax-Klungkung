 ...
 * @author dimata005
 */
public class ManagerUpdateTransferDataKredit {
    ...
    public static ManagerUpdateTransferDataKredit lck = new ManagerUpdateTransferDataKredit();
    ...
    public static void startTransfer(){    
        ...
        if(running) return;
            ...
            ManagerUpdateTransferDataKredit objMan = new  ManagerUpdateTransferDataKredit();

            Thread thLocker = new Thread(new MonitorUpdateTransferDataKredit());
