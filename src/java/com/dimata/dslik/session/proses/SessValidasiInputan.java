        ...
        try {
            if (kodepos != null && !kodepos.equals("") && !kodepos.equals(" ")) {
                ...
                if (hasil.length() < 5) {
                    ...
                    hasil = hasil.trim();
                    boolean validLetter = validateKodePos(hasil);
                    if(!validLetter){
                        hasil="";
                        statusProsesValidasi = statusProsesValidasi + "<br>KODE POS, format data harus angka, Wajib di perbaiki di core";
                    }
                }
            } else {
                hasil = "";
...
//            }
    ...
    public static boolean validateLettersDebiturIndividu(String txt) {
        try{
    ...
    public static boolean validateLettersDebiturBadanUsaha(String txt) {
        try{
            for (int x = 0; x < txt.length(); x++) {
                char ch = txt.charAt(x);
                if (!((ch >= 'a' && ch <= 'z') || (ch >= 'A' && ch <= 'Z') || ch == ' ' || (Character.isDigit(ch)) )) {
                    return false;
                }
            }
        }catch(Exception ex){
    ...
    public static boolean validateNIK(String txt) {
    ...
    public static boolean validateKelurahan(String txt) {
        try{
            for (int x = 0; x < txt.length(); x++) {
                char ch = txt.charAt(x);
                Character.isDigit(ch);
                if (!((ch >= 'a' && ch <= 'z') || (ch >= 'A' && ch <= 'Z') || (Character.isDigit(ch)) || (ch == '.') || (ch == '/') || (ch == '-') || (ch == ' ') )) {
                    return false;
                }
            }
        }catch(Exception ex){
    ...
    public static boolean validateTypeSatu(String txt) {
        try{
            for (int x = 0; x < txt.length(); x++) {
                char ch = txt.charAt(x);
                Character.isDigit(ch);
                if (!((ch >= 'a' && ch <= 'z') || (ch >= 'A' && ch <= 'Z') || (Character.isDigit(ch)) || (ch == ' ') || (ch == '.') || (ch == '/') || (ch == '-') || (ch == ','))) {
                    return false;
                }
            }
        }catch(Exception ex){
    ...
    public static boolean validateTempatLahir(String txt) {
        try{
            for (int x = 0; x < txt.length(); x++) {
                char ch = txt.charAt(x);
                Character.isDigit(ch);
                if (!((ch >= 'a' && ch <= 'z') || (ch >= 'A' && ch <= 'Z') || (Character.isDigit(ch)) || (ch == ' ') || (ch == '-'))) {
                    return false;
                }
            }
        }catch(Exception ex){
    ...
    public static boolean validateKodePos(String txt) {
        try{
            for (int x = 0; x < txt.length(); x++) {
                char ch = txt.charAt(x);
                Character.isDigit(ch);
    ...
    public static boolean validateNpwp(String txt) {
        try{
            for (int x = 0; x < txt.length(); x++) {
                char ch = txt.charAt(x);
                Character.isDigit(ch);
    ...
    public static boolean validateTempatBekerja(String txt) {
       try{
            for (int x = 0; x < txt.length(); x++) {
                char ch = txt.charAt(x);
                Character.isDigit(ch);
                if (!((ch >= 'a' && ch <= 'z') || (ch >= 'A' && ch <= 'Z') || (Character.isDigit(ch)) || (ch == ' ') || (ch == '.') || (ch == '&') || (ch == '-') || (ch == ',') || (ch == '(') || (ch == ')'))) {
                    return false;
                }
            }
        }catch(Exception ex){
    ...
    public static boolean validateTempatPendirian(String txt) {
        try{
            for (int x = 0; x < txt.length(); x++) {
                char ch = txt.charAt(x);
                Character.isDigit(ch);
     ...
     public static boolean validateNoAkte(String txt) {
        try{
            for (int x = 0; x < txt.length(); x++) {
                char ch = txt.charAt(x);
                Character.isDigit(ch);
                if (!((ch >= 'a' && ch <= 'z') || (ch >= 'A' && ch <= 'Z') || (Character.isDigit(ch)) || (ch == ' ') || (ch == '.') || (ch == '_') || (ch == '/')  || (ch == '-') || (ch == ',') || (ch == '(') || (ch == ')'))) {
                    return false;
                }
            }
        }catch(Exception ex){
    ...
    public static boolean validateAlamatTempatBekerja(String txt) {
        try{
            for (int x = 0; x < txt.length(); x++) {
                char ch = txt.charAt(x);
                Character.isDigit(ch);
