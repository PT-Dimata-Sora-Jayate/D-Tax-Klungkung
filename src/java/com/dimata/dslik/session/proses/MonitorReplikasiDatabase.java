...
public class MonitorReplikasiDatabase {
     ...
     public static Vector list(int limitStart, int recordToGet, String whereClause, String order) {
        ...
        pst = null;
        rs = null;
        System.out.println("com.dimata.dslik.session.proses.MonitorReplikasiDatabase.list()");
        String url = "jdbc:mysql://192.168.168.100:3306/d_slik_bpd";
        //String url = "jdbc:mysql://localhost:3308/d_slik_bpd";
        String id  = "root";
        String pass = "dsj4bpdbaliserversql";
        try {
        ...
        System.out.println("Cek Data replikasi");
        try {
            ...
            while (rs.next()) {
                System.out.println("Cek masuk replikasi");
            ...
            System.out.println("Cek sudah masuk replikasi");
            rs.close();
            return lists;
        } catch (Exception e) {
