 ...
 * @author dimata005
 */
//public class ManagerValidasiTransferData {
//    
//}
public class ManagerValidasiTransferData {
    ...
    public static void startTransfer(){    
        ...
        if(running) return;
            ...
            ManagerValidasiTransferData objMan = new  ManagerValidasiTransferData();

            Thread thLocker = new Thread(new MonitorValidasiTransferData());
