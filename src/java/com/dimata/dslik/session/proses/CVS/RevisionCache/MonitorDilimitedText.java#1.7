    ...
    public void run() {
        ...
        while (ManagerDilimitedText.running) {
            ...
            try {
                ...
                /*proses untuk update spasi*/
                long totalMoveKredit = MoveDataCrosPeriode.updateDebiturRemoveValue(fileSent.getPeriodeId());
            ...
            if(fileSent.isCreateInitial()){
                try {
                   newDate = new Date();
                   ManagerDilimitedText.setStatusProses(ManagerDilimitedText.getStatusProses()+"<br> Proses Start Initial Proses: " + Formater.formatDate(newDate, "dd-MM-yyyy kk:mm"));
                   ...
                   /*proses debitur perorangan*/
                   fileSent.setTypeSegment(Configurasi.FLD_SEGMENT_DEBITUR_PERORANGAN);
                   prosesDilimitedText.actionDilimitedTextIntial(fileSent,outletConnection);
