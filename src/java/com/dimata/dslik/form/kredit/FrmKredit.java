...
public class FrmKredit extends FRMHandler implements I_FRMInterface, I_FRMType {
	...
	/*34*/"- Kolom  ini  diisi dengan tanggal  pada  saat  fasilitas  kredit/pembiayaan  dinyatakan macet"
     ...
     public static String[] fieldError = {
        ...
        "Kolom ini harus diisi dengan tanggal Akad Awal",
        ...
        "Kolom ini harus diisi dengan nominal baki debet dalam rupiah (Cth: 2000000000), nilai BAKI DEBET harus sama dengan 0, jika kode kondisi (lunas) dengan kategori kondisi DEBITUR TIDAK MEMILIKI KEWAJIBAN",
        ...
        "Kolom ini harus diisi dengan tanggal pada saat fasilitas kredit/pembiayaan direstrukturisasi pertama kali.",
        "Kolom ini harus diisi dengan tanggal pada saat fasilitas kredit/pembiayaan direstrukturisasi terakhir kali.",
    ...
    public void requestEntityObject(Kredit entKredit) {
        try {
            ...
            entKredit.setProsentaseBunga(getDouble(FRM_FLD_PROSENTASE_BUNGA));
