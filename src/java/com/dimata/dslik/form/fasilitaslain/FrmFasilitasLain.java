...
//            entFasilitasLain.setFasilitasLainOid(getLong(FRM_FIELD_FASILITASLAINOID));
            ...
            entFasilitasLain.setSukuBunga(getDouble(FRM_FIELD_SUKU_BUNGA));
            entFasilitasLain.setKodeValuta(getString(FRM_FIELD_KODE_VALUTA));
            entFasilitasLain.setNominalJmlKewajiban(getDouble(FRM_FIELD_NOMINAL_JML_KEWAJIBAN));
            entFasilitasLain.setNilaiMataUangAsal(getDouble(FRM_FIELD_NILAI_MATA_UANG_ASAL));
            ...
            entFasilitasLain.setTunggakan(getDouble(FRM_FIELD_TUNGGAKAN));
            entFasilitasLain.setJmlHariTunggakan(getDouble(FRM_FIELD_JML_HARI_TUNGGAKAN));
