...
//            entLaporanKeuanganDebitur.setLaporanKeuanganDebiturOid(getLong(FRM_FIELD_LAPORANKEUANGANDEBITUROID));
            ...
            entLaporanKeuanganDebitur.setAset(getDouble(FRM_FIELD_ASET));
            entLaporanKeuanganDebitur.setAsetLancar(getDouble(FRM_FIELD_ASET_LANCAR));
            entLaporanKeuanganDebitur.setKasDanSetaraKas(getDouble(FRM_FIELD_KAS_DAN_SETARA_KAS));
            entLaporanKeuanganDebitur.setPiutangUsahaAstLncr(getDouble(FRM_FIELD_PIUTANG_USAHA_AST_LNCR));
            entLaporanKeuanganDebitur.setInvestasiAstLncr(getDouble(FRM_FIELD_INVESTASI_AST_LNCR));
            entLaporanKeuanganDebitur.setAsetLancarLain(getDouble(FRM_FIELD_ASET_LANCAR_LAIN));
            entLaporanKeuanganDebitur.setAsetTidakLancar(getDouble(FRM_FIELD_ASET_TIDAK_LANCAR));
            entLaporanKeuanganDebitur.setPiutangUsahaAstTdkLncr(getDouble(FRM_FIELD_PIUTANG_USAHA_AST_TDK_LNCR));
            entLaporanKeuanganDebitur.setInvestasiAstTdkLncr(getDouble(FRM_FIELD_INVESTASI_AST_TDK_LNCR));
            entLaporanKeuanganDebitur.setAsetTdkLncrLain(getDouble(FRM_FIELD_ASET_TDK_LNCR_LAIN));
            entLaporanKeuanganDebitur.setLiabilitas(getDouble(FRM_FIELD_LIABILITAS));
            entLaporanKeuanganDebitur.setLiabilitasJnkPndk(getDouble(FRM_FIELD_LIABILITAS_JNK_PNDK));
            entLaporanKeuanganDebitur.setPinjamanJnkPndk(getDouble(FRM_FIELD_PINJAMAN_JNK_PNDK));
            entLaporanKeuanganDebitur.setUtangUsahaLiaJnkPndk(getDouble(FRM_FIELD_UTANG_USAHA_LIA_JNK_PNDK));
            entLaporanKeuanganDebitur.setLiabilitasJnkPndkLain(getDouble(FRM_FIELD_LIABILITAS_JNK_PNDK_LAIN));
            entLaporanKeuanganDebitur.setLiabilitasJnkPnjg(getDouble(FRM_FIELD_LIABILITAS_JNK_PNJG));
            entLaporanKeuanganDebitur.setPinjamanJnkPnjg(getDouble(FRM_FIELD_PINJAMAN_JNK_PNJG));
            entLaporanKeuanganDebitur.setUtangUsahaLiaJnkPnjg(getDouble(FRM_FIELD_UTANG_USAHA_LIA_JNK_PNJG));
            entLaporanKeuanganDebitur.setLiabilitasJnkPnjgLain(getDouble(FRM_FIELD_LIABILITAS_JNK_PNJG_LAIN));
            entLaporanKeuanganDebitur.setEkuitas(getDouble(FRM_FIELD_EKUITAS));
            entLaporanKeuanganDebitur.setPendapatanUsahaOpr(getDouble(FRM_FIELD_PENDAPATAN_USAHA_OPR));
            entLaporanKeuanganDebitur.setBebanPokokPend(getDouble(FRM_FIELD_BEBAN_POKOK_PEND));
            entLaporanKeuanganDebitur.setLabaRugiBruto(getDouble(FRM_FIELD_LABA_RUGI_BRUTO));
            entLaporanKeuanganDebitur.setPendLainNonOpr(getDouble(FRM_FIELD_PEND_LAIN_NON_OPR));
            entLaporanKeuanganDebitur.setBebanLainNonOpr(getDouble(FRM_FIELD_BEBAN_LAIN_NON_OPR));
            entLaporanKeuanganDebitur.setLabaRugiSblmPajak(getDouble(FRM_FIELD_LABA_RUGI_SBLM_PAJAK));
            entLaporanKeuanganDebitur.setLabaRugiPeriode(getDouble(FRM_FIELD_LABA_RUGI_PERIODE));
