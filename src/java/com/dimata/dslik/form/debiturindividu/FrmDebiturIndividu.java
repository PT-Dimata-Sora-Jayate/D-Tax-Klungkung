...
public class FrmDebiturIndividu extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static String[] fieldNames = {
        "FRM_FIELD_DEBITUR_INDIVIDU_OID",//0
        "FRM_FIELD_FLAG_DETAIL",//1
        "FRM_FIELD_CIF",//2
        "FRM_FIELD_JENIS_IDENTITAS",//3
        "FRM_FIELD_NIK",//4
        "FRM_FIELD_NAMA_IDENTITAS",//5
        "FRM_FIELD_NAMA_LENGKAP",//6
        "FRM_FIELD_KODE_STATUS_GELAR",//7
        "FRM_FIELD_JEKEL",//8
        "FRM_FIELD_TEMPAT_LAHIR",//9
        "FRM_FIELD_TGL_LAHIR",//10
        "FRM_FIELD_NPWP",//11
        "FRM_FIELD_ALAMAT",//12
        "FRM_FIELD_KELURAHAN",//13
        "FRM_FIELD_KECAMATAN",//14
        "FRM_FIELD_KODE_KAB",
        "FRM_FIELD_KODE_POS",
        "FRM_FIELD_TELEPON",
        "FRM_FIELD_NOMOR_HP",
        ...
        "FRM_FIELD_KODE_PEKERJAAN",//21
        "FRM_FIELD_TEMPAT_BEKERJA",//22
        "FRM_FIELD_KODE_USAHA_TEMPAT_BEKERJA",//23
        "FRM_FIELD_ALAMAT_TEMPAT_BEKERJA",//24
        "FRM_FIELD_PENGHASILAN_KOTOR",//25
    ...
    public void requestEntityObject(DebiturIndividu entDebiturIndividu) {
        try {
            ...
            entDebiturIndividu.setPenghasilanKotor(getDouble(FRM_FIELD_PENGHASILAN_KOTOR));
