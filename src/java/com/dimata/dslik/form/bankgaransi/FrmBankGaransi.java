...
//            entBankGaransi.setBankGaransiOid(getLong(FRM_FIELD_BANKGARANSIOID));
            ...
            entBankGaransi.setPlafon(getDouble(FRM_FIELD_PLAFON));
            entBankGaransi.setNominal(getDouble(FRM_FIELD_NOMINAL));
            entBankGaransi.setSetoranJaminan(getDouble(FRM_FIELD_SETORAN_JAMINAN));
