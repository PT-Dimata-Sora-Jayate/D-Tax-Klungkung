...
public class FrmKreditJoinAccount extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public void requestEntityObject(KreditJoinAccount entKreditJoinAccount) {
        try {
            ...
            entKreditJoinAccount.setNilaiProyek(getDouble(FRM_FIELD_NILAI_PROYEK));
            ...
            entKreditJoinAccount.setPlafonAwal(getDouble(FRM_FIELD_PLAFON_AWAL));
            entKreditJoinAccount.setPlafon(getDouble(FRM_FIELD_PLAFON));
            entKreditJoinAccount.setRealisasi(getDouble(FRM_FIELD_REALISASI));
            entKreditJoinAccount.setDenda(getDouble(FRM_FIELD_DENDA));
            entKreditJoinAccount.setBakiDebet(getDouble(FRM_FIELD_BAKI_DEBET));
            entKreditJoinAccount.setNilaiUangAsal(getDouble(FRM_FIELD_NILAI_UANG_ASAL));
            ...
            entKreditJoinAccount.setTunggakanPokok(getDouble(FRM_FIELD_TUNGGAKAN_POKOK));
            entKreditJoinAccount.setTunggakanBunga(getDouble(FRM_FIELD_TUNGGAKAN_BUNGA));
