            ...
            case Command.SAVE:
                ...
                if (entDebiturBdnUsaha.getOID() == 0) {
                    ...
                    try {
                        ...
                        DebiturBdnUsaha entDebiturBdnUsahaVal = new DebiturBdnUsaha();
                        if(!entDebiturBdnUsaha.getCif().equals("")){
                            ...
                            try{
                                entDebiturBdnUsahaVal = (DebiturBdnUsaha) entDebiturBdnUsahaVal.getValidasiDetail(this.entDebiturBdnUsaha);
                                if(entDebiturBdnUsahaVal.isIsNotValid()==true){
                                    if(entDebiturBdnUsahaVal.getOID()!=0){
                                        long updateData = PstDebiturBdnUsaha.updateStatusDataNotComplate(entDebiturBdnUsaha.getOID());
                                    }
                                }
                            }catch(Exception es){
                            }
