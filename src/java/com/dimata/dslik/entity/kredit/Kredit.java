 ...
 * @author m20n9
 */
public class Kredit extends Entity implements I_LogHistory,I_Validasi {
    ...
    private double prosentaseBunga = 0;
    ...
    //untuk validasi
    private String validasiObject="";
    private String validasinoRekening = "";
    private String validasikodeSifat = "";
    private String validasikodeJenisKredit = "";
    private String validasikodeAkad = "";
    ...
    private String validasibaruPerpanjangan ="";
    private String validasitglAwal = "";
    private String validasitglMulai = "";
    private String validasitglTempo = "";
    private String validasikodeKatDbitur = "";
    private String validasikodeJenisPenggunaan = "";
    private String validasikodeOrientasiPenggunaan = "";
    private String validasikodeSektorEkonomi = "";
    private String validasikodeKab = "";
    private String validasinilai = "";
    private String validasikodeValuta = "";
    private String validasiprosentaseBunga = "";
    private String validasijenisBunga = "";
    private String validasikreditPemerintah = "";
    private String validasitakeover = "";
    private String validasisumberDana = "";
    private String validasiplafonAwal = "";
    private String validasivalidasiplafon = "";
    private String validasirealisasi = "";
    private String validasidenda = "";
    private String validasibakiDebet = "";
    private String validasinilaiUangAsal = "";
    private String validasikodeKolektibilitas = "";
    private String validasitglMacet = "";
    private String validasikodeSebabMacet = "";
    private String validasitunggakanPokok = "";
    private String validasitunggakanBunga = "";
    private String validasijmlHariTunggakan = "";
    private String validasifrekuensiTunggakan = "";
    private String validasifrekuensiRestrukturisasi ="";
    private String validasitglRestrukturisasiAwal = "";
    private String validasitglRestrukturisasiAkhir = "";
    private String validasikodeCara = "";
    private String validasikodeKondisi = "";
    private String validasitglKondisi = "";
    private String validasiketerangan = "";
    private String validasinamaSifatKredit="";
    private String validasinamaJenisKredit="";
    private String validasinamaAKad = "";
    
    
    private String errortglAkadAwal = "";
    private String errornoAkadAkhir = "";
    private String errorRestrukturisasiAkhir = "";
    private String errortglAwal = "";
    private String errortglAkadAkhir = "";
    private String errortakeover = "";
    private String errorjmlHariTunggakan = "";
    private String errorkodeCara = "";
    private String errorbaruPerpanjangan ="";
    private String errorfrekuensiRestrukturisasi ="";
    private String errortglRestrukturisasiAwal = "";
...
//            }
    ...
    /**
     * @return the validasiObject
     */
    public String getValidasiObject() {
        return validasiObject;
    }

    /**
     * @param validasiObject the validasiObject to set
     */
    public void setValidasiObject(String validasiObject) {
        this.validasiObject = validasiObject;
    }
    ...
    /**
     * @return the validasikodeSifat
     */
    public String getValidasikodeSifat() {
        return validasikodeSifat;
    }

    /**
     * @param validasikodeSifat the validasikodeSifat to set
     */
    public void setValidasikodeSifat(String validasikodeSifat) {
        this.validasikodeSifat = validasikodeSifat;
    }

    /**
     * @return the validasikodeJenisKredit
     */
    public String getValidasikodeJenisKredit() {
        return validasikodeJenisKredit;
    }

    /**
     * @param validasikodeJenisKredit the validasikodeJenisKredit to set
     */
    public void setValidasikodeJenisKredit(String validasikodeJenisKredit) {
        this.validasikodeJenisKredit = validasikodeJenisKredit;
    }

    /**
     * @return the validasikodeAkad
     */
    public String getValidasikodeAkad() {
        return validasikodeAkad;
    }

    /**
     * @param validasikodeAkad the validasikodeAkad to set
     */
    public void setValidasikodeAkad(String validasikodeAkad) {
        this.validasikodeAkad = validasikodeAkad;
    }
    ...
    /**
     * @return the validasibaruPerpanjangan
     */
    public String getValidasibaruPerpanjangan() {
        return validasibaruPerpanjangan;
    }

    /**
     * @param validasibaruPerpanjangan the validasibaruPerpanjangan to set
     */
    public void setValidasibaruPerpanjangan(String validasibaruPerpanjangan) {
        this.validasibaruPerpanjangan = validasibaruPerpanjangan;
    }

    /**
     * @return the validasitglAwal
     */
    public String getValidasitglAwal() {
        return validasitglAwal;
    }

    /**
     * @param validasitglAwal the validasitglAwal to set
     */
    public void setValidasitglAwal(String validasitglAwal) {
        this.validasitglAwal = validasitglAwal;
    }

    /**
     * @return the validasitglMulai
     */
    public String getValidasitglMulai() {
        return validasitglMulai;
    }

    /**
     * @param validasitglMulai the validasitglMulai to set
     */
    public void setValidasitglMulai(String validasitglMulai) {
        this.validasitglMulai = validasitglMulai;
    }

    /**
     * @return the validasitglTempo
     */
    public String getValidasitglTempo() {
        return validasitglTempo;
    }

    /**
     * @param validasitglTempo the validasitglTempo to set
     */
    public void setValidasitglTempo(String validasitglTempo) {
        this.validasitglTempo = validasitglTempo;
    }

    /**
     * @return the validasikodeKatDbitur
     */
    public String getValidasikodeKatDbitur() {
        return validasikodeKatDbitur;
    }

    /**
     * @param validasikodeKatDbitur the validasikodeKatDbitur to set
     */
    public void setValidasikodeKatDbitur(String validasikodeKatDbitur) {
        this.validasikodeKatDbitur = validasikodeKatDbitur;
    }

    /**
     * @return the validasikodeJenisPenggunaan
     */
    public String getValidasikodeJenisPenggunaan() {
        return validasikodeJenisPenggunaan;
    }

    /**
     * @param validasikodeJenisPenggunaan the validasikodeJenisPenggunaan to set
     */
    public void setValidasikodeJenisPenggunaan(String validasikodeJenisPenggunaan) {
        this.validasikodeJenisPenggunaan = validasikodeJenisPenggunaan;
    }

    /**
     * @return the validasikodeOrientasiPenggunaan
     */
    public String getValidasikodeOrientasiPenggunaan() {
        return validasikodeOrientasiPenggunaan;
    }

    /**
     * @param validasikodeOrientasiPenggunaan the validasikodeOrientasiPenggunaan to set
     */
    public void setValidasikodeOrientasiPenggunaan(String validasikodeOrientasiPenggunaan) {
        this.validasikodeOrientasiPenggunaan = validasikodeOrientasiPenggunaan;
    }

    /**
     * @return the validasikodeSektorEkonomi
     */
    public String getValidasikodeSektorEkonomi() {
        return validasikodeSektorEkonomi;
    }

    /**
     * @param validasikodeSektorEkonomi the validasikodeSektorEkonomi to set
     */
    public void setValidasikodeSektorEkonomi(String validasikodeSektorEkonomi) {
        this.validasikodeSektorEkonomi = validasikodeSektorEkonomi;
    }
    ...
    /**
     * @return the validasinilai
     */
    public String getValidasinilai() {
        return validasinilai;
    }

    /**
     * @param validasinilai the validasinilai to set
     */
    public void setValidasinilai(String validasinilai) {
        this.validasinilai = validasinilai;
    }
    ...
    /**
     * @return the validasiprosentaseBunga
     */
    public String getValidasiprosentaseBunga() {
        return validasiprosentaseBunga;
    }

    /**
     * @param validasiprosentaseBunga the validasiprosentaseBunga to set
     */
    public void setValidasiprosentaseBunga(String validasiprosentaseBunga) {
        this.validasiprosentaseBunga = validasiprosentaseBunga;
    }

    /**
     * @return the validasijenisBunga
     */
    public String getValidasijenisBunga() {
        return validasijenisBunga;
    }

    /**
     * @param validasijenisBunga the validasijenisBunga to set
     */
    public void setValidasijenisBunga(String validasijenisBunga) {
        this.validasijenisBunga = validasijenisBunga;
    }

    /**
     * @return the validasikreditPemerintah
     */
    public String getValidasikreditPemerintah() {
        return validasikreditPemerintah;
    }

    /**
     * @param validasikreditPemerintah the validasikreditPemerintah to set
     */
    public void setValidasikreditPemerintah(String validasikreditPemerintah) {
        this.validasikreditPemerintah = validasikreditPemerintah;
    }

    /**
     * @return the validasitakeover
     */
    public String getValidasitakeover() {
        return validasitakeover;
    }

    /**
     * @param validasitakeover the validasitakeover to set
     */
    public void setValidasitakeover(String validasitakeover) {
        this.validasitakeover = validasitakeover;
    }

    /**
     * @return the validasisumberDana
     */
    public String getValidasisumberDana() {
        return validasisumberDana;
    }

    /**
     * @param validasisumberDana the validasisumberDana to set
     */
    public void setValidasisumberDana(String validasisumberDana) {
        this.validasisumberDana = validasisumberDana;
    }

    /**
     * @return the validasiplafonAwal
     */
    public String getValidasiplafonAwal() {
        return validasiplafonAwal;
    }

    /**
     * @param validasiplafonAwal the validasiplafonAwal to set
     */
    public void setValidasiplafonAwal(String validasiplafonAwal) {
        this.validasiplafonAwal = validasiplafonAwal;
    }

    /**
     * @return the validasivalidasiplafon
     */
    public String getValidasivalidasiplafon() {
        return validasivalidasiplafon;
    }

    /**
     * @param validasivalidasiplafon the validasivalidasiplafon to set
     */
    public void setValidasivalidasiplafon(String validasivalidasiplafon) {
        this.validasivalidasiplafon = validasivalidasiplafon;
    }

    /**
     * @return the validasirealisasi
     */
    public String getValidasirealisasi() {
        return validasirealisasi;
    }

    /**
     * @param validasirealisasi the validasirealisasi to set
     */
    public void setValidasirealisasi(String validasirealisasi) {
        this.validasirealisasi = validasirealisasi;
    }

    /**
     * @return the validasidenda
     */
    public String getValidasidenda() {
        return validasidenda;
    }

    /**
     * @param validasidenda the validasidenda to set
     */
    public void setValidasidenda(String validasidenda) {
        this.validasidenda = validasidenda;
    }

    /**
     * @return the validasibakiDebet
     */
    public String getValidasibakiDebet() {
        return validasibakiDebet;
    }

    /**
     * @param validasibakiDebet the validasibakiDebet to set
     */
    public void setValidasibakiDebet(String validasibakiDebet) {
        this.validasibakiDebet = validasibakiDebet;
    }

    /**
     * @return the validasinilaiUangAsal
     */
    public String getValidasinilaiUangAsal() {
        return validasinilaiUangAsal;
    }

    /**
     * @param validasinilaiUangAsal the validasinilaiUangAsal to set
     */
    public void setValidasinilaiUangAsal(String validasinilaiUangAsal) {
        this.validasinilaiUangAsal = validasinilaiUangAsal;
    }
    ...
    /**
     * @return the validasitglMacet
     */
    public String getValidasitglMacet() {
        return validasitglMacet;
    }

    /**
     * @param validasitglMacet the validasitglMacet to set
     */
    public void setValidasitglMacet(String validasitglMacet) {
        this.validasitglMacet = validasitglMacet;
    }

    /**
     * @return the validasikodeSebabMacet
     */
    public String getValidasikodeSebabMacet() {
        return validasikodeSebabMacet;
    }

    /**
     * @param validasikodeSebabMacet the validasikodeSebabMacet to set
     */
    public void setValidasikodeSebabMacet(String validasikodeSebabMacet) {
        this.validasikodeSebabMacet = validasikodeSebabMacet;
    }

    /**
     * @return the validasitunggakanPokok
     */
    public String getValidasitunggakanPokok() {
        return validasitunggakanPokok;
    }

    /**
     * @param validasitunggakanPokok the validasitunggakanPokok to set
     */
    public void setValidasitunggakanPokok(String validasitunggakanPokok) {
        this.validasitunggakanPokok = validasitunggakanPokok;
    }

    /**
     * @return the validasitunggakanBunga
     */
    public String getValidasitunggakanBunga() {
        return validasitunggakanBunga;
    }

    /**
     * @param validasitunggakanBunga the validasitunggakanBunga to set
     */
    public void setValidasitunggakanBunga(String validasitunggakanBunga) {
        this.validasitunggakanBunga = validasitunggakanBunga;
    }

    /**
     * @return the validasijmlHariTunggakan
     */
    public String getValidasijmlHariTunggakan() {
        return validasijmlHariTunggakan;
    }

    /**
     * @param validasijmlHariTunggakan the validasijmlHariTunggakan to set
     */
    public void setValidasijmlHariTunggakan(String validasijmlHariTunggakan) {
        this.validasijmlHariTunggakan = validasijmlHariTunggakan;
    }

    /**
     * @return the validasifrekuensiTunggakan
     */
    public String getValidasifrekuensiTunggakan() {
        return validasifrekuensiTunggakan;
    }

    /**
     * @param validasifrekuensiTunggakan the validasifrekuensiTunggakan to set
     */
    public void setValidasifrekuensiTunggakan(String validasifrekuensiTunggakan) {
        this.validasifrekuensiTunggakan = validasifrekuensiTunggakan;
    }

    /**
     * @return the validasifrekuensiRestrukturisasi
     */
    public String getValidasifrekuensiRestrukturisasi() {
        return validasifrekuensiRestrukturisasi;
    }

    /**
     * @param validasifrekuensiRestrukturisasi the validasifrekuensiRestrukturisasi to set
     */
    public void setValidasifrekuensiRestrukturisasi(String validasifrekuensiRestrukturisasi) {
        this.validasifrekuensiRestrukturisasi = validasifrekuensiRestrukturisasi;
    }

    /**
     * @return the validasitglRestrukturisasiAwal
     */
    public String getValidasitglRestrukturisasiAwal() {
        return validasitglRestrukturisasiAwal;
    }

    /**
     * @param validasitglRestrukturisasiAwal the validasitglRestrukturisasiAwal to set
     */
    public void setValidasitglRestrukturisasiAwal(String validasitglRestrukturisasiAwal) {
        this.validasitglRestrukturisasiAwal = validasitglRestrukturisasiAwal;
    }

    /**
     * @return the validasitglRestrukturisasiAkhir
     */
    public String getValidasitglRestrukturisasiAkhir() {
        return validasitglRestrukturisasiAkhir;
    }

    /**
     * @param validasitglRestrukturisasiAkhir the validasitglRestrukturisasiAkhir to set
     */
    public void setValidasitglRestrukturisasiAkhir(String validasitglRestrukturisasiAkhir) {
        this.validasitglRestrukturisasiAkhir = validasitglRestrukturisasiAkhir;
    }

    /**
     * @return the validasikodeCara
     */
    public String getValidasikodeCara() {
        return validasikodeCara;
    }

    /**
     * @param validasikodeCara the validasikodeCara to set
     */
    public void setValidasikodeCara(String validasikodeCara) {
        this.validasikodeCara = validasikodeCara;
    }
    ...
    /**
     * @return the validasinamaSifatKredit
     */
    public String getValidasinamaSifatKredit() {
        return validasinamaSifatKredit;
    }

    /**
     * @param validasinamaSifatKredit the validasinamaSifatKredit to set
     */
    public void setValidasinamaSifatKredit(String validasinamaSifatKredit) {
        this.validasinamaSifatKredit = validasinamaSifatKredit;
    }

    /**
     * @return the validasinamaJenisKredit
     */
    public String getValidasinamaJenisKredit() {
        return validasinamaJenisKredit;
    }

    /**
     * @param validasinamaJenisKredit the validasinamaJenisKredit to set
     */
    public void setValidasinamaJenisKredit(String validasinamaJenisKredit) {
        this.validasinamaJenisKredit = validasinamaJenisKredit;
    }

    /**
     * @return the validasinamaAKad
     */
    public String getValidasinamaAKad() {
        return validasinamaAKad;
    }

    /**
     * @param validasinamaAKad the validasinamaAKad to set
     */
    public void setValidasinamaAKad(String validasinamaAKad) {
        this.validasinamaAKad = validasinamaAKad;
    }
    
     @Override
    public Entity getValidasiDetail(Entity prevDoc) {
        Kredit kreditValidasi = (Kredit)prevDoc;
        
        kreditValidasi.setIsNotValid(false);
        
        try{
            if(kreditValidasi.getKodeKolektibilitas()!=null){
                    if(kreditValidasi.getKodeKolektibilitas().equals("5")){
                            if(kreditValidasi.getKodeSebabMacet()==null || kreditValidasi.getKodeSebabMacet().equals("")){
                                kreditValidasi.setValidasikodeSebabMacet("data-required='required'");
                                kreditValidasi.setValidasitglMacet("data-required='required'");
                                kreditValidasi.setIsNotValid(true);
                            }
                    }
            }
        }catch(Exception es){
        ...
        if(kreditValidasi.getFrekuensiRestrukturisasi()>0){
                if(kreditValidasi.getKodeCara().equals("")){
                    kreditValidasi.setValidasikodeCara("data-required='required'");
                    kreditValidasi.setErrorkodeCara("KODE CARA RESTRUKTURISASI, wajib diisi. FREKUENSI RESTRUKTURISASI lebih besar 0");
                    kreditValidasi.setIsNotValid(true);
                }
        }
        
        if(kreditValidasi.getKodeKondisi().equals("02")){
            if(kreditValidasi.getBakiDebet()>0){
                //kreditValidasi.setBakiDebet("0");
                kreditValidasi.setValidasibakiDebet("data-required='required'");
                kreditValidasi.setIsNotValid(true);
            }
        }
        
//        if(kreditValidasi.getTglKondisi()){
//            
//        }
        
        try{
            if(kreditValidasi.getBaruPerpanjangan()>0){
                if(kreditValidasi.getTglAkadAwal()!=null){
                    if(kreditValidasi.getTglMulai()!=null){
                        if(kreditValidasi.getTglAkadAwal().after(kreditValidasi.getTglMulai())){
                            kreditValidasi.setTglAkadAwal(null);
                            kreditValidasi.setValidasitglAkadAwal("data-required='required'");
                            kreditValidasi.setErrortglAkadAwal("TANGGAL AKAD AWAL, TANGGAL AKAD AWAL harus lebih kecil TANGGAL MULAI karena BARU / PERPANJANGAN lebih besar dari 0, TANGGAL AKAD AWAL harus lebih kecil/sama dengan TANGGAL MULAI KREDIT");
                        ...
                        if(kreditValidasi.getTglAkadAwal().compareTo(kreditValidasi.getTglMulai())==0){
                            kreditValidasi.setTglAkadAwal(null);
                            kreditValidasi.setValidasitglAkadAwal("data-required='required'");
                            kreditValidasi.setErrortglAkadAwal("TANGGAL AKAD AWAL, TANGGAL AKAD AWAL harus lebih kecil TANGGAL MULAI karena BARU / PERPANJANGAN lebih besar dari 0, TANGGAL AKAD AWAL harus lebih kecil/sama dengan TANGGAL MULAI KREDIT");
                            //SessValidasiInputan.statusProsesValidasiKredit=SessValidasiInputan.statusProsesValidasiKredit+"<br>TANGGAL AKAD AWAL, TANGGAL AKAD AWAL harus lebih kecil TANGGAL MULAI karena BARU / PERPANJANGAN lebih besar dari 0, TANGGAL AKAD AWAL harus lebih kecil/sama dengan TANGGAL MULAI KREDIT, Wajib diperbaiki di core";
        ...
        try{
            if(kreditValidasi.getNoAkadAwal()!=null || kreditValidasi.getNoAkadAkhir()!=null){
                if(kreditValidasi.getNoAkadAwal().trim().equals(kreditValidasi.getNoAkadAkhir().trim())){
                    //cek apakah tanggalnya sama? 
                    if(kreditValidasi.getTglAkadAkhir()!=null || kreditValidasi.getTglAkadAwal()!=null){
                        if(kreditValidasi.getTglAkadAkhir().compareTo(kreditValidasi.getTglAkadAwal())!=0){
                            kreditValidasi.setNoAkadAkhir("");
                            kreditValidasi.setValidasinoAkadAkhir("data-required='required'");
                            kreditValidasi.setErrornoAkadAkhir("NOMOR AKAD AWAL tidak boleh sama dengan NOMOR AKAD AKHIR, karena tanggal akad awal tidak sama dengan tanggal akad akhir, Wajib diperbaiki di core");
                            //SessValidasiInputan.statusProsesValidasiKredit=SessValidasiInputan.statusProsesValidasiKredit+"<br>";
                            kreditValidasi.setIsNotValid(true);
                        }
                    }
                }
        ...
        if(kreditValidasi.getFrekuensiRestrukturisasi()>0){
            if(kreditValidasi.getTglRestrukturisasiAkhir()==null){
                kreditValidasi.setValidasitglRestrukturisasiAkhir("data-required='required'");
                kreditValidasi.setErrorRestrukturisasiAkhir("TANGGAL RESTRUKTURISASI AKHIR, wajib diisi. FREKUENSI RESTRUKTURISASI lebih besar 0");
                kreditValidasi.setIsNotValid(true);
            }
            
            if(kreditValidasi.getTglRestrukturisasiAwal()==null){
                kreditValidasi.setValidasitglRestrukturisasiAwal("data-required='required'");
                kreditValidasi.setErrortglRestrukturisasiAwal("TANGGAL RESTRUKTURISASI AWAL, wajib diisi. FREKUENSI RESTRUKTURISASI lebih besar 0");
                kreditValidasi.setIsNotValid(true);
            }
        }
        
        try{
            if(!kreditValidasi.getKodeSifat().equals("1")){
                if(kreditValidasi.getFrekuensiRestrukturisasi()>0){
                    kreditValidasi.setValidasifrekuensiRestrukturisasi("data-required='required'");
                    kreditValidasi.setErrorfrekuensiRestrukturisasi("FREKUENSI RESTRUKTURISASI, FREKUENSI RESTRUKTURISASI harus = 0, Sifat Kredit Adalah Kredit lainnya.");
                    kreditValidasi.setIsNotValid(true);
                }
            }
        }catch(Exception ex){
        ...
        try{
            if(kreditValidasi.getNoAkadAwal()!=null || kreditValidasi.getNoAkadAkhir()!=null){
                if(!kreditValidasi.getNoAkadAwal().trim().equals(kreditValidasi.getNoAkadAkhir().trim())){
                    if(kreditValidasi.getTglAwal()!=null || kreditValidasi.getTglMulai()!=null){
                        if(kreditValidasi.getTglAwal().compareTo(kreditValidasi.getTglMulai())==0){
                            kreditValidasi.setTglAwal(null);
                            kreditValidasi.setValidasitglAwal("data-required='required'");
                            kreditValidasi.setErrortglAwal("TANGGAL AWAL KREDIT, TANGGAL AWAL KREDIT tidak boleh sama dengan TANGGAL MULAI, karena nomor akad awal tidak sama dengan nomor akad akhir");
                            kreditValidasi.setIsNotValid(true);
                        }
                    }
                }
        ...
        try{
            if(kreditValidasi.getTglAkadAkhir()!=null || kreditValidasi.getTglTempo()!=null){
                if(kreditValidasi.getTglAkadAkhir().after(kreditValidasi.getTglTempo())){
                    kreditValidasi.setTglAkadAkhir(null);
                    kreditValidasi.setValidasitglAkadAkhir("data-required='required'");
                    kreditValidasi.setErrortglAkadAkhir("TANGGAL AKAD AKHIR, TANGGAL AKAD AKHIR harus lebih kecil TANGGAL JATUH TEMPO");
                    kreditValidasi.setIsNotValid(true);
                }
            }
        ...
        try{
            if(kreditValidasi.getKodeSifat()!=null){
                if(kreditValidasi.getKodeSifat().equals("2")){
                    kreditValidasi.setValidasitakeover("data-required='required'");
                    kreditValidasi.setErrortakeover("TAKEOVER DARI, wajib diisi. KODE SIFAT KREDIT sama dengan 2 (kredit subordinasi) ");
                    kreditValidasi.setIsNotValid(true);
        ...
        try{
            if(kreditValidasi.getJmlHariTunggakan()==0){
                if(kreditValidasi.getTunggakanPokok()>0 || kreditValidasi.getTunggakanBunga()>0){
                    kreditValidasi.setValidasijmlHariTunggakan("data-required='required'");
                    kreditValidasi.setErrorjmlHariTunggakan("JUMLAH HARI TUNGGAKAN, JUMLAH HARI TUNGGAKAN harus > 0, karena TUNGGAKAN POKOK>0 atau TUNGGAKAN BUNGA>0");
                    kreditValidasi.setIsNotValid(true);
                }
            }
        }catch(Exception ex){
        ...
        try{
            if(kreditValidasi.getTunggakanPokok()==0 && kreditValidasi.getTunggakanBunga()==0){
                if(kreditValidasi.getJmlHariTunggakan()>0){
                        kreditValidasi.setValidasijmlHariTunggakan("data-required='required'");
                        kreditValidasi.setErrorjmlHariTunggakan("JUMLAH HARI TUNGGAKAN harus = 0, karena TUNGGAKAN POKOK=0 dan TUNGGAKAN BUNGA=0");
                        kreditValidasi.setIsNotValid(true);
                }
            }
        }catch(Exception ex){
        ...
        try{
            if(kreditValidasi.getTglMulai()!=null || kreditValidasi.getTglAwal()!=null){
                if(kreditValidasi.getTglMulai().after(kreditValidasi.getTglAwal())){
                    if(kreditValidasi.getBaruPerpanjangan()==0){
                        kreditValidasi.setValidasibaruPerpanjangan("data-required='required'");
                        kreditValidasi.setErrorbaruPerpanjangan("BARU / PERPANJANGAN, harus > 0, karena TANGGAL MULAI lebih besar dari TANGGAL AWAL KREDIT");
                        kreditValidasi.setIsNotValid(true);
                    }
                }
            }
                ...
                if(kreditValidasi.getNoAkadAwal().trim().equals(kreditValidasi.getNoAkadAkhir().trim())){
                    if(kreditValidasi.getTglAwal()!=null || kreditValidasi.getTglMulai()!=null){
                        if(kreditValidasi.getTglAwal().compareTo(kreditValidasi.getTglMulai())!=0){
                            kreditValidasi.setTglAwal(null);
                            kreditValidasi.setValidasitglAwal("data-required='required'");
                            kreditValidasi.setErrortglAwal("TANGGAL AWAL KREDIT, TANGGAL AWAL KREDIT harus sama dengan TANGGAL MULAI, karena nomor akad awal sama dengan nomor akad akhir");
                            kreditValidasi.setIsNotValid(true);
                        }
                    }
                }
        ...
        try{
            if(kreditValidasi.getKodeSifat().equals("1")){
                if(kreditValidasi.getFrekuensiRestrukturisasi()==0){
                    kreditValidasi.setValidasifrekuensiRestrukturisasi("data-required='required'");
                    kreditValidasi.setErrorfrekuensiRestrukturisasi("FREKUENSI RESTRUKTURISASI harus lebih besar 0, Sifat Kredit Adalah Kredit yang direstrukturisasi");
                    kreditValidasi.setIsNotValid(true);
    ...
    /**
     * @return the errorRestrukturisasiAkhir
     */
    public String getErrorRestrukturisasiAkhir() {
        return errorRestrukturisasiAkhir;
    }

    /**
     * @param errorRestrukturisasiAkhir the errorRestrukturisasiAkhir to set
     */
    public void setErrorRestrukturisasiAkhir(String errorRestrukturisasiAkhir) {
        this.errorRestrukturisasiAkhir = errorRestrukturisasiAkhir;
    }

    /**
     * @return the errortglAwal
     */
    public String getErrortglAwal() {
        return errortglAwal;
    }

    /**
     * @param errortglAwal the errortglAwal to set
     */
    public void setErrortglAwal(String errortglAwal) {
        this.errortglAwal = errortglAwal;
    }
    ...
    /**
     * @return the errortakeover
     */
    public String getErrortakeover() {
        return errortakeover;
    }

    /**
     * @param errortakeover the errortakeover to set
     */
    public void setErrortakeover(String errortakeover) {
        this.errortakeover = errortakeover;
    }

    /**
     * @return the errorjmlHariTunggakan
     */
    public String getErrorjmlHariTunggakan() {
        return errorjmlHariTunggakan;
    }

    /**
     * @param errorjmlHariTunggakan the errorjmlHariTunggakan to set
     */
    public void setErrorjmlHariTunggakan(String errorjmlHariTunggakan) {
        this.errorjmlHariTunggakan = errorjmlHariTunggakan;
    }

    /**
     * @return the errorkodeCara
     */
    public String getErrorkodeCara() {
        return errorkodeCara;
    }

    /**
     * @param errorkodeCara the errorkodeCara to set
     */
    public void setErrorkodeCara(String errorkodeCara) {
        this.errorkodeCara = errorkodeCara;
    }

    /**
     * @return the errorbaruPerpanjangan
     */
    public String getErrorbaruPerpanjangan() {
        return errorbaruPerpanjangan;
    }

    /**
     * @param errorbaruPerpanjangan the errorbaruPerpanjangan to set
     */
    public void setErrorbaruPerpanjangan(String errorbaruPerpanjangan) {
        this.errorbaruPerpanjangan = errorbaruPerpanjangan;
    }

    /**
     * @return the errorfrekuensiRestrukturisasi
     */
    public String getErrorfrekuensiRestrukturisasi() {
        return errorfrekuensiRestrukturisasi;
    }

    /**
     * @param errorfrekuensiRestrukturisasi the errorfrekuensiRestrukturisasi to set
     */
    public void setErrorfrekuensiRestrukturisasi(String errorfrekuensiRestrukturisasi) {
        this.errorfrekuensiRestrukturisasi = errorfrekuensiRestrukturisasi;
    }

    /**
     * @return the errortglRestrukturisasiAwal
     */
    public String getErrortglRestrukturisasiAwal() {
        return errortglRestrukturisasiAwal;
    }

    /**
     * @param errortglRestrukturisasiAwal the errortglRestrukturisasiAwal to set
     */
    public void setErrortglRestrukturisasiAwal(String errortglRestrukturisasiAwal) {
        this.errortglRestrukturisasiAwal = errortglRestrukturisasiAwal;
    }
    ...
    /**
     * @return the prosentaseBunga
     */
    public double getProsentaseBunga() {
        return prosentaseBunga;
    }

    /**
     * @param prosentaseBunga the prosentaseBunga to set
     */
    public void setProsentaseBunga(double prosentaseBunga) {
