...
public class PstMappingKreditBpd extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_KODE_CARA=46;
    ...
    public static String[] fieldNames = {
        ...
        "KODE_JENIS_PENGGUNAAN",//11
        "KODE_ORIENTASI_PENGGUNAAN",//2
        "KODE_KAB",//13
        "NILAI",//14
        "KODE_VALUTA",//15
        "PROSENTASE_BUNGA",//16
    ...
    public static MappingKreditBpd fetchExc(long oid) throws DBException {
        try {
            ...
            entMappingKreditBpd.setProsentaseBunga(pstMappingKreditBpd.getdouble(FLD_PROSENTASE_BUNGA));
            ...
            entMappingKreditBpd.setKodeCaraRestruk(pstMappingKreditBpd.getString(FLD_KODE_CARA));
    ...
    public static synchronized long updateExc(MappingKreditBpd entMappingKreditBpd) throws DBException {
        try {
            if (entMappingKreditBpd.getOID() != 0) {
                ...
                pstMappingKreditBpd.setDouble(FLD_PROSENTASE_BUNGA, entMappingKreditBpd.getProsentaseBunga());
                ...
                pstMappingKreditBpd.setDate(FLD_TGL_RESTRUKTURISASI_AWAL, entMappingKreditBpd.getTanggalRestrukturisasiAwal());
                pstMappingKreditBpd.setDate(FLD_TGL_RESTRUKTURISASI_AKHIR, entMappingKreditBpd.getTanggalRestrukturisasiAkhir());
                pstMappingKreditBpd.setString(FLD_KODE_CARA, entMappingKreditBpd.getKodeCaraRestruk());
    ...
    public static void resultToObject(ResultSet rs, MappingKreditBpd entMappingKreditBpd) {
        try {
            ...
            entMappingKreditBpd.setProsentaseBunga(rs.getDouble(PstMappingKreditBpd.fieldNames[PstMappingKreditBpd.FLD_PROSENTASE_BUNGA]));
            ...
            entMappingKreditBpd.setKodeCaraRestruk(rs.getString(PstMappingKreditBpd.fieldNames[PstMappingKreditBpd.FLD_KODE_CARA]));
