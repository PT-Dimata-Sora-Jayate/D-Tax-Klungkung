...
public class PstMappingDebiturBpd extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_STATUS_DATA=57;
    ...
    public static MappingDebiturBpd fetchExc(long oid) throws DBException {
        try {
            ...
            entMappingDebiturBpd.setStatusData(pstMappingDebiturBpd.getInt(FLD_STATUS_DATA));
    ...
    public static MappingDebiturBpd fetchExc(long oid, MappingDebiturBpd entMappingDebiturBpd) throws DBException {
        try {
            ...
            entMappingDebiturBpd.setPerjanjianPisahHarta(pstMappingDebiturBpd.getString(FLD_PERJANJIAN_PISAH_HARTA));
            entMappingDebiturBpd.setTanggalPemeringkat(pstMappingDebiturBpd.getDate(FLD_TGL_PEMERINGKAT));
            entMappingDebiturBpd.setStatusData(pstMappingDebiturBpd.getIntAllowNull(FLD_STATUS_DATA));
            return entMappingDebiturBpd;
        } catch (DBException dbe) {
            throw dbe;
        } catch (Exception e) {
     ...
     public static MappingDebiturBpd fetchExc(long oid, MappingDebiturBpd entDebitur, MappingDebiturBpd prevEntDebitur) throws DBException {
        try {
            //MappingDebiturBpd entMappingDebiturBpd = new MappingDebiturBpd();
            //PstMappingDebiturBpd pstMappingDebiturBpd = new PstMappingDebiturBpd(oid);
            entDebitur.setOID(oid);
            entDebitur.setFlagDetail(prevEntDebitur.getFlagDetail());
            entDebitur.setCif(prevEntDebitur.getCif());
            entDebitur.setJenisIdentitas(prevEntDebitur.getJenisIdentitas());
            entDebitur.setNik(prevEntDebitur.getNik());
            entDebitur.setNamaIdentitas(prevEntDebitur.getNamaIdentitas());
            entDebitur.setNamaLengkap(prevEntDebitur.getNamaLengkap());
            entDebitur.setKodeStatusGelar(prevEntDebitur.getKodeStatusGelar());
            entDebitur.setJekel(prevEntDebitur.getJekel());
            entDebitur.setTempatLahir(prevEntDebitur.getTempatLahir());
            entDebitur.setTanggalLahir(prevEntDebitur.getTanggalLahir());
            entDebitur.setNpwp(prevEntDebitur.getNpwp());
            entDebitur.setAlamat(prevEntDebitur.getAlamat());
            entDebitur.setKelurahan(prevEntDebitur.getKelurahan());
            entDebitur.setKecamatan(prevEntDebitur.getKecamatan());
            entDebitur.setKodeKab(prevEntDebitur.getKodeKab());
            entDebitur.setKodePos(prevEntDebitur.getKodePos());
            entDebitur.setTelepon(prevEntDebitur.getTelepon());
            entDebitur.setNomorHp(prevEntDebitur.getNomorHp());
            entDebitur.setEmail(prevEntDebitur.getEmail());
            entDebitur.setKodeDomisili(prevEntDebitur.getKodeDomisili());
            entDebitur.setKodePekerjaan(prevEntDebitur.getKodePekerjaan());
            entDebitur.setTempatBekerja(prevEntDebitur.getTempatBekerja());
            entDebitur.setKodeUsahaTempatBekerja(prevEntDebitur.getKodeUsahaTempatBekerja());
            entDebitur.setAlamatTempatBekerja(prevEntDebitur.getAlamatTempatBekerja());
            entDebitur.setPenghasilanKotor(prevEntDebitur.getPenghasilanKotor());
            entDebitur.setJmlTanggungan(prevEntDebitur.getJmlTanggungan());
            entDebitur.setKodeHub(prevEntDebitur.getKodeHub());
            entDebitur.setKodeGol(prevEntDebitur.getKodeGol());
            entDebitur.setStatus(prevEntDebitur.getStatus());
            entDebitur.setMelanggarBmpk(prevEntDebitur.getMelanggarBmpk());
            entDebitur.setMelampuiBmpk(prevEntDebitur.getMelampuiBmpk());
            entDebitur.setNamaIbuKandung(prevEntDebitur.getNamaIbuKandung());
            entDebitur.setKodeKantorCabang(prevEntDebitur.getKodeKantorCabang());
            entDebitur.setNamaBadanUsaha(prevEntDebitur.getNamaBadanUsaha());
            entDebitur.setKodeJenisUsaha(prevEntDebitur.getKodeJenisUsaha());
            entDebitur.setTempatPendirian(prevEntDebitur.getTempatPendirian());
            entDebitur.setNoAkte(prevEntDebitur.getNoAkte());
            entDebitur.setTglAktePendirian(prevEntDebitur.getTglAktePendirian());
            entDebitur.setNoAktePerubahan(prevEntDebitur.getNoAktePerubahan());
            entDebitur.setTglAktePerubahan(prevEntDebitur.getTglAktePerubahan());
            entDebitur.setKodeBidangUsaha(prevEntDebitur.getKodeBidangUsaha());
            entDebitur.setKodeHubLjk(prevEntDebitur.getKodeHubLjk());
            entDebitur.setGoPublic(prevEntDebitur.getGoPublic());
            entDebitur.setPeringkat(prevEntDebitur.getPeringkat());
            entDebitur.setLembagaPemeringkat(prevEntDebitur.getLembagaPemeringkat());
            entDebitur.setNamaGroup(prevEntDebitur.getNamaGroup());
            entDebitur.setKodeJenisNsb(prevEntDebitur.getKodeJenisNsb());
            entDebitur.setOpenDate(prevEntDebitur.getOpenDate());//16
            entDebitur.setPeriodeId(prevEntDebitur.getPeriodeId());
            entDebitur.setNoIdentitas(prevEntDebitur.getNoIdentitas());
            entDebitur.setKodePenghasilan(prevEntDebitur.getKodePenghasilan());
            
            entDebitur.setNikPassportPasangan(prevEntDebitur.getNikPassportPasangan());
            entDebitur.setNamaPasangan(prevEntDebitur.getNamaPasangan());
            entDebitur.setTglLahirPasangan(prevEntDebitur.getTglLahirPasangan());
            entDebitur.setPerjanjianPisahHarta(prevEntDebitur.getPerjanjianPisahHarta());
            entDebitur.setTanggalPemeringkat(prevEntDebitur.getTanggalPemeringkat());
            
            entDebitur.setStatusData(prevEntDebitur.getStatusData());
    ...
    public static synchronized long updateExc(MappingDebiturBpd entMappingDebiturBpd) throws DBException {
        try {
            if (entMappingDebiturBpd.getOID() != 0) {
                ...
                pstMappingDebiturBpd.setInt(FLD_STATUS_DATA, entMappingDebiturBpd.getStatusData());
    ...
    public static void resultToObject(ResultSet rs, MappingDebiturBpd entMappingDebiturBpd) {
        try {
            ...
            entMappingDebiturBpd.setStatusData(rs.getInt(PstMappingDebiturBpd.fieldNames[PstMappingDebiturBpd.FLD_STATUS_DATA]));
        } catch (Exception e) {
        }
    }
    ...
    public static boolean checkDebiturHapusBuku(String cif) {
        DBResultSet dbrs = null;
        boolean result = false;
        try {
            String sql = "SELECT * FROM  dslik_debitur_hapus_buku WHERE "
                    + " CIF_HAPUS_BUKU='"+cif+"'";
            dbrs = DBHandler.execQueryResult(sql);
            ResultSet rs = dbrs.getResultSet();
            while (rs.next()) {
