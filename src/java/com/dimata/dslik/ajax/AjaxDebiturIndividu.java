...
import com.dimata.dslik.entity.contentdata.ContentDataBentukBadanUsaha;
...
public class AjaxDebiturIndividu extends HttpServlet {
	...
	if(this.dataFor.equals("showform")){
        ...
        }else if(this.dataFor.equals("showlistindividuPasangan")){
            this.htmlReturn = showListForm(request);    
        ...
        }else if(this.dataFor.equals("loadsummaryindividupasangan")){
            this.htmlReturn = getSummaryPasangan(request);    
   ...
   public void commandSave(HttpServletRequest request){
	...
	String cif = FRMQueryString.requestString(request, "cif");
        ...
        }else if(dataFor.equals("showlistindividuPasangan")){
            
            whereClause = " r."+PstDebitur.fieldNames[PstDebitur.FLD_PERIODE_ID]+"='"+periodeId+"' AND r."+PstDebitur.fieldNames[PstDebitur.FLD_KODE_JENIS_NSB]+"='1' AND r."+PstDebitur.fieldNames[PstDebitur.FLD_STATUS]+"='1' "
                    + " AND (r."+PstDebitur.fieldNames[PstDebitur.FLD_NIK_PASANGAN]+"='' OR r."+PstDebitur.fieldNames[PstDebitur.FLD_NAMA_PASANGAN]+"='' OR r."+PstDebitur.fieldNames[PstDebitur.FLD_PERJANJIAN_PISAH_HARGA]+"='' OR r."+PstDebitur.fieldNames[PstDebitur.FLD_TGL_LAHIR_PASANGAN]+" IS NULL) "
                    + " AND l."+PstKredit.fieldNames[PstKredit.FLD_TGL_MULAI]+" >= '2016-06-01' ";
            
            if(!kodeCabang.equals("")){
                whereClause = whereClause +  " AND l."+PstKredit.fieldNames[PstKredit.FLD_KODE_KANTOR_CABANG]+"='"+kodeCabang+"'";
            }
            
            if (!searchTerm.equals("")) {
                whereClause += " AND (r." + PstDebitur.fieldNames[PstDebitur.FLD_CIF] + " LIKE '%" + searchTerm + "%' "
                    + " OR r." + PstDebitur.fieldNames[PstDebitur.FLD_NIK] + " LIKE '%" + searchTerm + "%'"
                    + " OR r." + PstDebitur.fieldNames[PstDebitur.FLD_NAMA_IDENTITAS] + " LIKE '%" + searchTerm + "%')";
            } 
	...
	if(dataFor.equals("listdatasearch")){
	    ...
	    total = SessionProsesPerlengkapan.getCountJoinDebiturMenikahTidakPunyaPasangan(whereClause);  
    ...
    public JSONObject getData(int total, HttpServletRequest request, String datafor){
        ...
        if(datafor.equals("listdatasearchglobal")){
            ...
            listData = SessionProsesPerlengkapan.getListJoinDebiturMenikahTidakPunyaPasangan(start, amount, whereClause);  
        }else{
    ...
    public String showForm(HttpServletRequest request){
        ...
        DebiturIndividu debiturIndividuValidasi = new DebiturIndividu();
        di.setKodeKantorCabang(kodeCabang);
        String tglLahir = "";
        String tglLahirPasangan = "";
        String mandatoryNIKPasangan="";
        String mandatoryNamaPasangan="";
        String mandatoryTglLahirPasangan="";
        String mandatoryPerjanjianPisahHarta="";
        if(oid != 0){
             try {
                debiturIndividuValidasi = PstDebiturIndividu.fetchExc(oid);
                di = (DebiturIndividu) di.getValidasiDetail(debiturIndividuValidasi);
            } catch (Exception e) {
            ...
            if(di.getStatus().equals("1")){ //jika status kawin
                if(di.getNikPasangan().equals("")){
                    mandatoryNIKPasangan ="data-required='required'";
                }
                if( di.getNamaPasangan().equals("")){
                    mandatoryNamaPasangan ="data-required='required'";
                }
                if(tglLahirPasangan.equals("")){
                    mandatoryTglLahirPasangan ="data-required='required'";
                }
                if(mandatoryPerjanjianPisahHarta.equals("")){
                    mandatoryPerjanjianPisahHarta ="data-required='required'";
                }
            }
	...
	+ "<div class='row'>"
		...
		+ "<div class='form-horizontal' style='padding:10px;background:#fff;border:5px solid #f1f1f1;'>"
			...
			+ "</div><i style='color:red'>"+di.getErrorNik()+"</i>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>";
                                String whereClausex="";
                                if(!di.getKodeKab().equals("")){
                                   whereClausex=" KODE_DATI_II='"+di.getKodeKab()+"'";
                                }
                                Vector vKecamatan =  PstContentDataBentukBadanUsaha.listKecamatanWithoutOid(0,0,""+whereClausex,"");
                                Vector valueKecamatan = new Vector();
                                Vector keyKecamatan = new Vector();
                                valueKecamatan.add("");
                                keyKecamatan.add("-- Pilih --");
                                for (int i = 0; i < vKecamatan.size(); i++) {
                                    ContentDataBentukBadanUsaha KdKab = (ContentDataBentukBadanUsaha) vKecamatan.get(i);
                                    valueKecamatan.add(String.valueOf(KdKab.getKodeOjk()));
                                    keyKecamatan.add(KdKab.getKodeOjk()+"-"+KdKab.getBentukBadanUsaha());
                                }
                                returnData += ControlCombo.draw(""+FrmDebiturIndividu.fieldNames[FrmDebiturIndividu.FRM_FIELD_KECAMATAN], null, ""+di.getKecamatan(), valueKecamatan, keyKecamatan, "data-required='required'  data-error-message='"+FrmDebiturIndividu.fieldError[FrmDebiturIndividu.FRM_FIELD_KECAMATAN]+"' data-required='required' data-type='text'", "form-control");
                          returnData +=""  
		...
		+ "<h4>Job Information</h4>"
			...
			+ "<div class='col-sm-8'>"
			    + "<input type='text' "+di.getValidasiTempatBekerja()+" value='"+di.getTempatBekerja()+"' name='"+ FrmDebiturIndividu.fieldNames[FrmDebiturIndividu.FRM_FIELD_TEMPAT_BEKERJA] +"' id='"+ FrmDebiturIndividu.fieldNames[FrmDebiturIndividu.FRM_FIELD_TEMPAT_BEKERJA] +"' class='form-control' data-required='required' data-error-message='"+FrmDebiturIndividu.fieldError[FrmDebiturIndividu.FRM_FIELD_TEMPAT_BEKERJA]+"' data-type='text' data-number='true' data-alpha='true' data-special=\"&-',.() \">"
			+ "</div><i style='color:red'>"+di.getErrorTempatBekerja()+"</i>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>"
			    + "<input type='text' "+di.getValidasiAlamatTempatBekerja()+" name='"+ FrmDebiturIndividu.fieldNames[FrmDebiturIndividu.FRM_FIELD_ALAMAT_TEMPAT_BEKERJA] +"' id='"+ FrmDebiturIndividu.fieldNames[FrmDebiturIndividu.FRM_FIELD_ALAMAT_TEMPAT_BEKERJA] +"' data-error-message='"+FrmDebiturIndividu.fieldError[FrmDebiturIndividu.FRM_FIELD_ALAMAT_TEMPAT_BEKERJA]+"' data-type='text' class='form-control' value='"+di.getAlamatTempatBekerja()+"' data-number='true' data-alpha='true' data-special=\"&-',.()/ \">"
			+ "</div><i style='color:red'>"+di.getErrorAlamatTempatBekerja()+"</i>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
		...
		+ "<div class='form-horizontal' style='padding:10px;background:#fff;border:5px solid #f1f1f1;'>"
			...
			+ "<div class='col-sm-8'>"
			    + "<input type='text' name='"+ FrmDebiturIndividu.fieldNames[FrmDebiturIndividu.FRM_FIELD_NIK_PASANGAN] +"' id='"+ FrmDebiturIndividu.fieldNames[FrmDebiturIndividu.FRM_FIELD_NIK_PASANGAN] +"' "+mandatoryNIKPasangan+" value='"+di.getNikPasangan()+"' data-error-message='"+FrmDebiturIndividu.fieldError[FrmDebiturIndividu.FRM_FIELD_NIK_PASANGAN]+"' data-type='text' class='form-control nospecial' data-number='true' data-alpha='true' data-special=\"\">"
			+ "</div>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>"
			    + "<input type='text' name='"+ FrmDebiturIndividu.fieldNames[FrmDebiturIndividu.FRM_FIELD_NAMA_PASANGAN] +"' id='"+ FrmDebiturIndividu.fieldNames[FrmDebiturIndividu.FRM_FIELD_NAMA_PASANGAN] +"' value='"+di.getNamaPasangan()+"' "+mandatoryNamaPasangan+" data-error-message='"+FrmDebiturIndividu.fieldError[FrmDebiturIndividu.FRM_FIELD_NAMA_PASANGAN]+"' data-type='text' class='form-control' data-number='false' data-alpha='true' data-special=\" -.'\">"
			+ "</div>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>"
			    + "<div class='input-group'>"
				+ "<input type='text' name='"+ FrmDebiturIndividu.fieldNames[FrmDebiturIndividu.FRM_FIELD_TGLLAHIR_PASANGAN] +"' id='"+ FrmDebiturIndividu.fieldNames[FrmDebiturIndividu.FRM_FIELD_TGLLAHIR_PASANGAN] +"' "+mandatoryTglLahirPasangan+" value='"+tglLahirPasangan+"' data-error-message='"+FrmDebiturIndividu.fieldError[FrmDebiturIndividu.FRM_FIELD_TGLLAHIR_PASANGAN]+"' data-type='text' class='form-control datepicker'>"
				+ "<div class='input-group-addon'>"
				    + "<i class='fa fa-calendar'></i>"
				+ "</div>"
			    + "</div>"
		...
		+ "<div class='form-horizontal' style='padding:10px;background:#fff;border:5px solid #f1f1f1;'>"
			...
			+ "<label class='control-label col-sm-4'>"
                                    ...
                                    + "Perjanjian Pisah Harta <i style='color:red;'>(o*</i></label>"
			+ "<div class='col-sm-8'>";
                            ...
                            returnData+=""
			    + ControlCombo.draw(FrmDebiturIndividu.fieldNames[FrmDebiturIndividu.FRM_FIELD_PERJANJIAN_PISAH_HARGA], "-- Pilih --", ""+di.getPerjanjianPisahHarga(), pisahHargaKey, pisahHargaVal, " data-error-message='"+FrmDebiturIndividu.fieldError[FrmDebiturIndividu.FRM_FIELD_PERJANJIAN_PISAH_HARGA]+"' "+mandatoryPerjanjianPisahHarta+" data-type='text'", "form-control")
			+ "</div>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
    ...
    public String getSummaryPasangan(HttpServletRequest request){
        String returnData = "";
        int userGroup = FRMQueryString.requestInt(request, "usergroup");
        String kodeCabang = FRMQueryString.requestString(request, "kodecabang");
        long periodeId = FRMQueryString.requestLong(request, "periode");
        ...
        summary = SessionProsesPerlengkapan.getCountJoinDebiturMenikahTidakPunyaPasangan(whereClause);
        returnData +=""+summary;
        return returnData;
    }
