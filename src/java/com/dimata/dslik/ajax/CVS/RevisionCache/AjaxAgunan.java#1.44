...
//                }
    ...
    public String showForm2(HttpServletRequest request){
        ...
        String mandatoryTanggalPenilaian="";
        String mandatoryTanggalPengikatan="";
        if (oid != 0) {
            try {
            ...
            if(agunan.getKodeStatusAgunan().equals("1")){
                ...
                if(agunan.getTglPenilaianLjk()==null){
                    mandatoryTanggalPenilaian="data-required='required'";
                }
                if(agunan.getTglPengikatan()==null){
                    mandatoryTanggalPengikatan="data-required='required'";
                }
            }
	...
	+ "<div class='row'>"
		...
		+ "<div class='form-horizontal' style='padding:10px;background:#fff;border:5px solid #f1f1f1;'>"
			...
			+ "<div class='col-sm-8'>"
			    + "<input type='text' class='form-control' name='"+ FrmAgunan.fieldNames[FrmAgunan.FRM_FIELD_PERINGKAT_AGUNAN] +"' id='"+ FrmAgunan.fieldNames[FrmAgunan.FRM_FIELD_PERINGKAT_AGUNAN] +"' value='"+agunan.getPeringkatAgunan()+"' data-number='true' data-alpha='true' data-special='_/()+-' data-error-message='"+FrmAgunan.fieldError[FrmAgunan.FRM_FIELD_PERINGKAT_AGUNAN]+"' data-type='text'>"
			+ "</div>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>";
			    ...
			    Vector vCdLembaga =  PstContentDataLembagaPemeringkat.list(0,0,"","");
                            ...
                            returnData += ControlCombo.draw(""+FrmAgunan.fieldNames[FrmAgunan.FRM_FIELD_KODE_LEMBAGA_PEMERINGKAT], null, ""+agunan.getKodeLembagaPemeringkat(), valueCdLembaga, keyCdLembaga, "  onchange=\"javascript:changeFunc();\"  data-error-message='"+FrmAgunan.fieldError[FrmAgunan.FRM_FIELD_KODE_LEMBAGA_PEMERINGKAT]+"' data-type='text'", "form-control");
                            returnData += "</div>"
                            //end comboBox
		    + "</div>"
		    + "<div class='form-group'>"
			...
			+ "<div class='col-sm-8'>"
				...
				+ "<input type='text' class='form-control datepicker' name='"+ FrmAgunan.fieldNames[FrmAgunan.FRM_FIELD_TGL_PENGIKATAN] +"' id='"+ FrmAgunan.fieldNames[FrmAgunan.FRM_FIELD_TGL_PENGIKATAN] +"' value='"+tglPengikatan+"' data-error-message='"+FrmAgunan.fieldError[FrmAgunan.FRM_FIELD_TGL_PENGIKATAN]+"' "+mandatoryTanggalPengikatan+" data-type='text'>"
		...
		+ "<div class='form-horizontal' style='padding:10px;background:#fff;border:5px solid #f1f1f1;'>"
			...
			+ "<div class='col-sm-8'>"
			    + "<div class='input-group'>"
				+ "<input type='text' class='form-control datepicker' name='"+ FrmAgunan.fieldNames[FrmAgunan.FRM_FIELD_TGL_PENILAIAN_LJK] +"' id='"+ FrmAgunan.fieldNames[FrmAgunan.FRM_FIELD_TGL_PENILAIAN_LJK] +"' value='"+tglPenilaianLjk+"' data-error-message='"+FrmAgunan.fieldError[FrmAgunan.FRM_FIELD_TGL_PENILAIAN_LJK]+"' "+mandatoryTanggalPenilaian+" data-type='text'>"
				+ "<div class='input-group-addon'>"
				    + "<i class='fa fa-calendar'></i>"
				+ "</div>"
			    + "</div>"
