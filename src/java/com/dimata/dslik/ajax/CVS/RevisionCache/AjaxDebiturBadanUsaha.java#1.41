...
//                }
    ...
    public String showForm(HttpServletRequest request){
        ...
        DebiturBdnUsaha debiturBdnUsahaValidasi = new DebiturBdnUsaha();
        ...
        if (oid != 0) {
            try {
                ...
                debiturBdnUsahaValidasi = PstDebiturBdnUsaha.fetchExc(oid);
                debiturBdnUsaha = (DebiturBdnUsaha) debiturBdnUsaha.getValidasiDetail(debiturBdnUsahaValidasi);
            ...
            if(debiturBdnUsaha.getKodeGol().equals("9000")){
                debiturBdnUsaha.setKodeGol("");
            }
        }
        else {
	...
	+ "<div class='row'>"
		...
		+ "<div class='form-horizontal' style='padding:10px;background:#fff;border:5px solid #f1f1f1;'>"
			...
			+ "<div class='col-sm-8'>"
			    + "<input type='text' "+debiturBdnUsaha.getValidasiTempat()+" name='"+ FrmDebiturBdnUsaha.fieldNames[FrmDebiturBdnUsaha.FRM_FIELD_TEMPAT] +"' id='"+ FrmDebiturBdnUsaha.fieldNames[FrmDebiturBdnUsaha.FRM_FIELD_TEMPAT] +"' value='"+debiturBdnUsaha.getTempat()+"' class='form-control' data-required='required' data-number='false' data-alpha='true' data-special=\" -'.,\"  data-error-message='"+FrmDebiturBdnUsaha.fieldError[FrmDebiturBdnUsaha.FRM_FIELD_TEMPAT]+"' data-type='text'>"
			+ "</div><i style='color:red'>"+debiturBdnUsaha.getErrorTempat()+"</i>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<label class='control-label col-sm-4'>"
                                ...
                                + "No Akte Perubahan Terakhir <i style='color:red;'>(m**</i></label>"
			+ "<div class='col-sm-8'>"
			    + "<input type='text' "+debiturBdnUsaha.getValidasiNoAktePerubahan()+" name='"+ FrmDebiturBdnUsaha.fieldNames[FrmDebiturBdnUsaha.FRM_FIELD_NO_AKTE_PERUBAHAN] +"' id='"+ FrmDebiturBdnUsaha.fieldNames[FrmDebiturBdnUsaha.FRM_FIELD_NO_AKTE_PERUBAHAN] +"' value='"+debiturBdnUsaha.getNoAktePerubahan()+"' class='form-control nospecial' data-required='required' data-number='true' data-alpha='true' data-special=\"-\"  data-error-message='"+FrmDebiturBdnUsaha.fieldError[FrmDebiturBdnUsaha.FRM_FIELD_NO_AKTE_PERUBAHAN]+"' data-type='text'>"
			+ "</div><i style='color:red'>"+debiturBdnUsaha.getErrorNoAktePerubahan()+"</i>"
		    + "</div>"
                    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>";
                                ...
                                if(!debiturBdnUsaha.getKodeKab().equals("")){
                                   whereClausex=" KODE_DATI_II='"+debiturBdnUsaha.getKodeKab()+"'";
                                }
                                ...
                                returnData += ControlCombo.draw(""+FrmDebiturBdnUsaha.fieldNames[FrmDebiturBdnUsaha.FRM_FIELD_KECAMATAN], null, ""+debiturBdnUsaha.getKecamatan(), valueKecamatan, keyKecamatan, "data-required='required'  data-error-message='"+FrmDebiturBdnUsaha.fieldError[FrmDebiturBdnUsaha.FRM_FIELD_KECAMATAN]+"' data-required='required' data-type='text'", "form-control");
                                //returnData += "</div>"
			    //+ "<input type='text' name='"+ FrmDebiturBdnUsaha.fieldNames[FrmDebiturBdnUsaha.FRM_FIELD_KODE_JENIS] +"' id='"+ FrmDebiturBdnUsaha.fieldNames[FrmDebiturBdnUsaha.FRM_FIELD_KODE_JENIS] +"' value='"+debiturBdnUsaha.getKodeJenis()+"' class='form-control' data-required='required'>"
			returnData +=""
		...
		+ "<div class='form-horizontal' style='padding:10px;background:#fff;border:5px solid #f1f1f1;'>"
			...
			+ "<div class='col-sm-8'>";
                                //start comboBox
                                Vector vCdGolDeb =  PstContentDataGolonganDebitur.listBadanUsahaWithoutOid(0,0,"KODE_OJK NOT IN ('9000','9700')","KODE_OJK");
			...
			+ "<div class='col-sm-8'>"
			    + "<input type='text' "+debiturBdnUsaha.getValidasiPeringkat()+" name='"+ FrmDebiturBdnUsaha.fieldNames[FrmDebiturBdnUsaha.FRM_FIELD_PERINGKAT] +"' id='"+ FrmDebiturBdnUsaha.fieldNames[FrmDebiturBdnUsaha.FRM_FIELD_PERINGKAT] +"' value='"+debiturBdnUsaha.getPeringkat()+"' class='form-control nospecial' data-number='true' data-alpha='true' data-special=\"-/()_+\" data-error-message='"+FrmDebiturBdnUsaha.fieldError[FrmDebiturBdnUsaha.FRM_FIELD_PERINGKAT]+"' data-type='text'>"
			+ "</div><i style='color:red'>"+debiturBdnUsaha.getErrorPeringkat()+"</i>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>";
                                ...
                                returnData += ControlCombo.draw(""+FrmDebiturBdnUsaha.fieldNames[FrmDebiturBdnUsaha.FRM_FIELD_LEMBAGA_PEMERINGKAT], null, ""+debiturBdnUsaha.getLembagaPemeringkat(), valueCdLembaga, keyCdLembaga, " "+debiturBdnUsaha.getValidasiLembagaPemeringkat()+" onchange=\"javascript:changeFunc();\"  data-error-message='"+FrmDebiturBdnUsaha.fieldError[FrmDebiturBdnUsaha.FRM_FIELD_LEMBAGA_PEMERINGKAT]+"' data-type='text'", "form-control");
                                returnData += "</div><i style='color:red'>"+debiturBdnUsaha.getErrorLembagaPemeringkat()+"</i>"
                                //end comboBox
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
