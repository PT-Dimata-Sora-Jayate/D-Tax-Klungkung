            ...
            case SEGMEN_AGUNAN:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    if (agunan.getTglPengikatan() != null) {
                        try {
                            tglPengikatan = Formater.formatDate(agunan.getTglPengikatan(), "dd-MM-yyyy");
                        } catch (Exception ex) {
                            tglPengikatan = "";
                        }
                    }
                    ...
                    String tglPenilaian = "";
                    try {
                        tglPenilaian = Formater.formatDate(agunan.getTglPenilaianLjk(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglPenilaian = "";
                    }
                    ...
                    try {
                        tglPenilaianPenilaiIndep = Formater.formatDate(agunan.getTglPenilaianPenilaiIndep(), "dd-MM-yyyy");
                    } catch (Exception ex) {
...
//                    }
            ...
            case SEGMEN_DEBITUR_BADAN_USAHA:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    rowx.add("" + Formater.formatDate(debiturBdnUsaha.getTglAkadAkhir(), "dd-MM-yyyy"));//2
...
//                    }
            ...
            case SEGMEN_FASILITAS_LAINNYA:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    String tglMulai = "";
                    try {
                        tglMulai = Formater.formatDate(fasilitasLain.getTglMulai(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglMulai = "";
                    }
                    rowx.add("" + tglMulai);//6
                    ...
                    try {
                        tglJatuhTempo = Formater.formatDate(fasilitasLain.getTglJatuhTempo(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglJatuhTempo = "";
                    }
                    ...
                    String tglMacet = "";
                    try {
                        tglMacet = Formater.formatDate(fasilitasLain.getTglMacet(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglMacet = "";
                    }
                    ...
                    String tglKondisi = "";
                    try {
                        tglKondisi = Formater.formatDate(fasilitasLain.getTglKondisi(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglKondisi = "";
                    }
...
//                    }
            ...
            case SEGMEN_IRREVOCABLE_LC:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    String tglKeluar = "";
                    try {
                        tglKeluar = Formater.formatDate(irrevocableLc.getTglKeluar(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglKeluar = "";
                    }
                    ...
                    String tglJatuhTempo = "";
                    try {
                        tglJatuhTempo = Formater.formatDate(irrevocableLc.getTglJatuhTempo(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglJatuhTempo = "";
                    }
                    rowx.add("" + tglJatuhTempo);//7
                    ...
                    String tglAkadAwal = "";
                    try {
                        tglAkadAwal = Formater.formatDate(irrevocableLc.getTglAkadAwal(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglAkadAwal = "";
                    }
                    ...
                    String tglAkadAkhir = "";
                    try {
                        tglAkadAkhir = Formater.formatDate(irrevocableLc.getTglAkadAkhir(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglAkadAkhir = "";
                    }
                    ...
                    try {
                        tglWanPrestasi = Formater.formatDate(irrevocableLc.getTglWanPrestasi(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglWanPrestasi = "";
                    }
                    ...
                    String tglKondisi = "";
                    try {
                        tglKondisi = Formater.formatDate(irrevocableLc.getTglKondisi(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglKondisi = "";
                    }
...
//                    }
            ...
            case SEGMEN_KREDIT:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    String tglAkadAwal = "";
                    try {
                        tglAkadAwal = Formater.formatDate(kredit.getTglAkadAwal(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglAkadAwal = "";
                    }
                    ...
                    String tglAkadAkhir = "";
                    try {
                        tglAkadAkhir = Formater.formatDate(kredit.getTglAkadAkhir(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglAkadAkhir = "";
                    }
                    ...
                    String tglAwal = "";
                    try {
                        tglAwal = Formater.formatDate(kredit.getTglAwal(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglAwal = "";
                    }
                    rowx.add("" + tglAwal);//12
                    String tglMulai = "";
                    try {
                        tglMulai = Formater.formatDate(kredit.getTglMulai(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglMulai = "";
                    }
                    ...
                    String tglTempo = "";
                    try {
                        tglTempo = Formater.formatDate(kredit.getTglTempo(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglTempo = "";
                    }
                    ...
                    String tglMacet = "";
                    try {
                        tglMacet = Formater.formatDate(kredit.getTglMacet(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglMacet = "";
                    }
                    ...
                    try {
                        tglRestrukturisasiAwal = Formater.formatDate(kredit.getTglRestrukturisasiAwal(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                    ...
                    String tglres = "";
                    try {
                        tglres = Formater.formatDate(kredit.getTglRestrukturisasiAkhir(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglres = "";
                    }
                    rowx.add("" + tglres);//42
                    ...
                    String tglKondisi = "";
                    try {
                        tglKondisi = Formater.formatDate(kredit.getTglKondisi(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglKondisi = "";
                    }
...
//                    }
            ...
            case SEGMEN_SURAT_BERHARGA:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    String tglTerbit = "";
                    try {
                        tglTerbit = Formater.formatDate(suratBerharga.getTglTerbit(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglTerbit = "";
                    }
                    ...
                    String tglBeli = "";
                    try {
                        tglBeli = Formater.formatDate(suratBerharga.getTglBeli(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglBeli = "";
                    }
                    rowx.add("" + tglBeli);//10
                    String tglJatuhTempo = "";
                    try {
                        tglJatuhTempo = Formater.formatDate(suratBerharga.getTglJatuhTempo(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglJatuhTempo = "";
                    }
                    ...
                    String tglMacet = "";
                    try {
                        tglMacet = Formater.formatDate(suratBerharga.getTglMacet(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglMacet = "";
                    }
                    ...
                    String tglKondisi = "";
                    try {
                        tglKondisi = Formater.formatDate(suratBerharga.getTglKondisi(), "dd-MM-yyyy");
                    } catch (Exception ex) {
                        tglKondisi = "";
                    }
...
//                    }
            ...
            default:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    rowx.add("" + Formater.formatDate(debiturIndividu.getTglAkadAkhir(), "dd-MM-yyyy"));//2
                    ...
                    if (debiturIndividu.getTglLahir() != null) {
                        rowx.add("" + Formater.formatDate(debiturIndividu.getTglLahir(), "dd-MM-yyyy"));//10
                    } else {
                        rowx.add("");//10
                    }
                    ...
                    try {
                        rowx.add("" + Formater.formatDate(debiturIndividu.getTglLahirPasangan(), "dd-MM-yyyy"));//33
                    } catch (Exception es) {
                        rowx.add("");//33
                    }
...
//                        + "AND " + PstDebitur.fieldNames[PstDebitur.FLD_KODE_JENIS_NSB] + "!='1'");
    ...
    public static Vector drawRowHapusData(Vector listObj, int segment, Vector listData, int type, long periode, String cif) {
        Vector vKredit  = PstKredit.list(0, 0, PstKredit.fieldNames[PstKredit.FLD_CIF]+"='"+cif+"' AND "+PstKredit.fieldNames[PstKredit.FLD_PERIODE_ID]+"='"+periode+"'", ""+PstKredit.fieldNames[PstKredit.FLD_TGL_MULAI]+" ASC ");
        Vector vBankGaransi  = PstBankGaransi.list(0, 0, PstBankGaransi.fieldNames[PstBankGaransi.FLD_CIF]+"='"+cif+"' AND "+PstBankGaransi.fieldNames[PstBankGaransi.FLD_PERIODE_ID]+"='"+periode+"'", ""+PstBankGaransi.fieldNames[PstBankGaransi.FLD_TGL_DITERBITKAN]+" ASC ");
        Vector vDebitur  = PstDebitur.list(0, 0, PstDebitur.fieldNames[PstDebitur.FLD_CIF]+"='"+cif+"' AND "+PstDebitur.fieldNames[PstDebitur.FLD_PERIODE_ID]+"='"+periode+"' AND KODE_JENIS_NSB=1", "");
        Vector vBadanUsaha  = PstDebitur.list(0, 0, PstDebitur.fieldNames[PstDebitur.FLD_CIF]+"='"+cif+"' AND "+PstDebitur.fieldNames[PstDebitur.FLD_PERIODE_ID]+"='"+periode+"' AND KODE_JENIS_NSB!=1", "");
        Vector vPenjamin  = PstPenjamin.list(0, 0, PstPenjamin.fieldNames[PstPenjamin.FLD_CIF]+"='"+cif+"' AND "+PstPenjamin.fieldNames[PstPenjamin.FLD_PERIODE_ID]+"='"+periode+"'", "");
        Vector vPengurusPemilik  = PstPengurusAtauPemilik.list(0, 0, PstPengurusAtauPemilik.fieldNames[PstPengurusAtauPemilik.FLD_CIF]+"='"+cif+"' AND "+PstPengurusAtauPemilik.fieldNames[PstPengurusAtauPemilik.FLD_PERIODE_ID]+"='"+periode+"'", "");
        ...
        switch (segment) {
            case SEGMEN_AGUNAN:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    rowx.add("<button type='button' name='seach' id='search-btn-segment' class='btn btn-danger' onclick=\"javascript:cmdChangeJenisDebitur('"+agunan.getOID()+"','"+SEGMEN_AGUNAN+"')\"><i class='fa fa-remove'></i></button>");
                    rowx.add("" + agunan.getKodeKantorCabang());//1
                    rowx.add("" + agunan.getKodeRegisterAgunan());//2
                    rowx.add("" + agunan.getNoRekening());//3
                    rowx.add("" + agunan.getCif());//4
                    ...
                    if (oid != 0) {
                        rowx = new Vector(1, 1);
                        rowx.add("");//0
                        rowx.add("Data Segment Relasi : ");//0
                        rowx.add("<td colspan ='22' > Debitur Badan Usaha:"+vBadanUsaha.size()+" <br> Debitur Individu : "+vDebitur.size()+" <br> Kredit: "+vKredit.size()+" <br> Bank Garansi :"+vBankGaransi.size()+"<br> Pengurus / Pemilik : "+vPengurusPemilik.size()+" <br> Penjamin :"+vPenjamin.size()+"</td>");//1
                        listData.add(rowx);
            ...
            case SEGMEN_BANK_GARANSI:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    noUrut = noUrut + 1;
                    BankGaransi bankGaransi = (BankGaransi) listObj.get(i);
                    rowx.add("<button type='button' name='seach' id='search-btn-segment' class='btn btn-danger' onclick=\"javascript:cmdChangeJenisDebitur('"+bankGaransi.getOID()+"','"+SEGMEN_BANK_GARANSI+"')\"><i class='fa fa-remove'></i></button>");
                    rowx.add("" + bankGaransi.getKodeKantorCabang());//2
                    rowx.add("" + bankGaransi.getNoRekening());//2
                    rowx.add("" + bankGaransi.getCif());//3
                    rowx.add("" + bankGaransi.getKodeJenisGaransi());//4
            ...
            case SEGMEN_DEBITUR_BADAN_USAHA:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    rowx.add("<button type='button' name='seach' id='search-btn-segment' class='btn btn-danger' onclick=\"javascript:cmdChangeJenisDebitur('"+debiturBdnUsaha.getOID()+"','"+SEGMEN_DEBITUR_BADAN_USAHA+"')\"><i class='fa fa-remove'></i></button>");
                    rowx.add("" + debiturBdnUsaha.getKodeKtrCabang());//2
                    rowx.add("" + debiturBdnUsaha.getCif());//2
                    rowx.add("" + debiturBdnUsaha.getNoRekening());//2
                    rowx.add("" + Formater.formatDate(debiturBdnUsaha.getTglAkadAkhir(), "dd-MM-yyyy"));//2
...
//                    rowx.add("" + debiturBdnUsaha.getOperasiData());//30
            ...
            case SEGMEN_FASILITAS_LAINNYA:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    noUrut = noUrut + 1;
                    //rowx.add("" + noUrut);//2
                    rowx.add("<button type='button' name='seach' id='search-btn-segment' class='btn btn-danger' onclick=\"javascript:cmdChangeJenisDebitur('"+fasilitasLain.getOID()+"','"+SEGMEN_FASILITAS_LAINNYA+"')\"><i class='fa fa-remove'></i></button>");
                    rowx.add("" + fasilitasLain.getKodeKantorCabang());//2
                    rowx.add("" + fasilitasLain.getNoRekening());//2
                    rowx.add("" + fasilitasLain.getCif());//3
                    rowx.add("" + fasilitasLain.getKodeJenisFasilitas());//4
...
//                    rowx.add("" + irrevocableLc.getOperasiData()+ "");
            ...
            case SEGMEN_KREDIT:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    noUrut = noUrut + 1;
                    //rowx.add("" + noUrut);//0
                    rowx.add("<button type='button' name='seach' id='search-btn-segment' class='btn btn-danger' onclick=\"javascript:cmdChangeJenisDebitur('"+kredit.getOID()+"','"+SEGMEN_KREDIT+"')\"><i class='fa fa-remove'></i></button>");
                    rowx.add("" + kredit.getKodeKantorCabang());//1
                    rowx.add("" + kredit.getNoRekening());//2
                    rowx.add("" + kredit.getCif());//3
                    rowx.add("" + kredit.getKodeSifat());//4
...
//                    rowx.add("" + laporanKeuanganDebitur.getOperasiData() ); //31
            ...
            case SEGMEN_PENGURUS_PEMILIK:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    noUrut = noUrut + 1;
                    //rowx.add("" + noUrut);//2
                    rowx.add("<button type='button' name='seach' id='search-btn-segment' class='btn btn-danger' onclick=\"javascript:cmdChangeJenisDebitur('"+pengurusAtauPemilik.getOID()+"','"+SEGMEN_PENGURUS_PEMILIK+"')\"><i class='fa fa-remove'></i></button>");
                    rowx.add("" + pengurusAtauPemilik.getKodeKantorCabang());//2
                    rowx.add("" + pengurusAtauPemilik.getNoIdentitas());//2
                    rowx.add("" + pengurusAtauPemilik.getCif());//3
                    rowx.add("" + pengurusAtauPemilik.getJenisIdentitas());//4
...
//                    rowx.add("" + pengurusAtauPemilik.getOperasiData());
            ...
            case SEGMEN_PENJAMIN:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    noUrut = noUrut + 1;
                    //rowx.add("" + noUrut);//2
                    rowx.add("<button type='button' name='seach' id='search-btn-segment' class='btn btn-danger' onclick=\"javascript:cmdChangeJenisDebitur('"+penjamin.getOID()+"','"+SEGMEN_PENJAMIN+"')\"><i class='fa fa-remove'></i></button>");
                    rowx.add("" + penjamin.getKodeKantorCabang());//2
                    rowx.add("" + penjamin.getNoIdPenjamin());//2
                    rowx.add("" + penjamin.getNoRekening());//3
                    rowx.add("" + penjamin.getCif());//4
...
//                    rowx.add("" + penjamin.getOperasiData());
            ...
            default:
                ...
                for (int i = 0; i < listObj.size(); i++) {
                    ...
                    noUrut = noUrut + 1;
                    //rowx.add("" + noUrut);//0
                    rowx.add("<button type='button' name='seach' id='search-btn-segment' class='btn btn-danger' onclick=\"javascript:cmdChangeJenisDebitur('"+debiturIndividu.getOID()+"','"+SEGMEN_DEBITUR_INDIVIDU+"')\"><i class='fa fa-remove'></i></button>");
                    rowx.add("" + debiturIndividu.getKodeKantorCabang());//1
                    rowx.add("" + debiturIndividu.getCif());//2
                    rowx.add("" + debiturIndividu.getNoRekening());//2
                    rowx.add("" + Formater.formatDate(debiturIndividu.getTglAkadAkhir(), "dd-MM-yyyy"));//2
