...
import com.dimata.dslik.session.proses.ManagerUpdateKPTransferDataDebitur;
import com.dimata.dslik.session.proses.ManagerUpdateTransferDataKredit;
import com.dimata.dslik.session.proses.ManagerValidasiTransferData;
                        ...
                        case 8:
                            ...
                            if(vReplikasiDatabase!=null){
                                if(vReplikasiDatabase.size()>0){
                                    ...
                                    System.out.println("tidak ada data master");
                                }
                            }else{
                                System.out.print("tidak ada data replikasi");
                            }
...
//                            htlm = htlm + "<b>LastError : </b>" + replikasiDatabase.getLastError()+ "<br>";
                        ...
                        case 9:
                            ...
                            htlm = htlm + "<div class='row'>";
                            htlm = htlm + "<div class='col-md-12'>";
                            htlm = htlm + "<b>Start : </b>" + ManagerValidasiTransferData.getStart() + "<br>";
                            htlm = htlm + " </div>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "<div class='row'>";
                            htlm = htlm + "<div class='col-md-12'>";
                            htlm = htlm + "<b>Proses : </b>" + ManagerValidasiTransferData.getStatusProsesStatic() + "<br>";
                            htlm = htlm + " </div>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "<div class='row'>";
                            htlm = htlm + " <div class='col-md-12'>";
                            htlm = htlm + " <b>Validasi Transfer : </b>" + ManagerValidasiTransferData.getStatusPengurusStatic() + "<br>";
                            htlm = htlm + "</div>";
                            htlm = htlm + " </div>      ";
                            htlm = htlm + "<div class='row'>";
                            htlm = htlm + "<div class='col-md-12'>";
                            htlm = htlm + "<b>End : </b>" + ManagerValidasiTransferData.getEnd() + "<br>";
                            htlm = htlm + " </div>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "<div id='countryElement'>";
                            htlm = htlm + "</div>";
                        ...
                        case 10:
                            //update transfer data kredit
                            htlm = "";
                            htlm = htlm + "<div class='box-body'>";
                            htlm = htlm + "<div class='row'>";
                            htlm = htlm + "<div class='col-md-12'>";
                            htlm = htlm + "<b>Start : </b> " + ManagerUpdateTransferDataKredit.getStart() + "<br>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "<div class='row'>";
                            htlm = htlm + "<div class='col-md-12'>";
                            htlm = htlm + "<b>Proses : </b> " + ManagerUpdateTransferDataKredit.getStatusProsesStatic() + "<br>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "<div class='row'>";
                            htlm = htlm + "<div class='col-md-12'>";
                            htlm = htlm + "<b>Update Kredit : </b> " + ManagerUpdateTransferDataKredit.getStatusKreditStatic() + "<br>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "<div class='row'>";
                            htlm = htlm + "<div class='col-md-12'>";
                            htlm = htlm + "<b>End : </b> " + ManagerUpdateTransferDataKredit.getEnd() + "<br>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "<div id='countryElement'>";
                            htlm = htlm + "</div>";
                        ...
                        case 11:
                            ...
                            htlm = htlm + "<div class='row'>";
                            htlm = htlm + "<div class='col-md-12'>";
                            htlm = htlm + "<b>Start : </b> " + ManagerUpdateKPTransferDataDebitur.getStart() + "<br>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "<div class='row'>";
                            htlm = htlm + "<div class='col-md-12'>";
                            htlm = htlm + "<b>Proses : </b> " + ManagerUpdateKPTransferDataDebitur.getStatusProsesStatic() + "<br>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "<div class='row'>";
                            htlm = htlm + "<div class='col-md-12'>";
                            htlm = htlm + "<b>Update Debitur : </b> " + ManagerUpdateKPTransferDataDebitur.getStatusDebiturStatic() + "<br>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "<div class='row'>";
                            htlm = htlm + "<div class='col-md-12'>";
                            htlm = htlm + "<b>End : </b> " + ManagerUpdateKPTransferDataDebitur.getEnd() + "<br>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "</div>";
                            htlm = htlm + "<div id='countryElement'>";
                            htlm = htlm + "</div>";
                ...
                case 1:
                    ...
                    switch (type) {
                        ...
                        case 6:
                            ...
                            if (ManagerDilimitedTextSummary.getStatus()==false) {
                        ...
                        case 7:
                            ...
                            if(xxx==0){
                                ...
                                htlm = htlm + "<div class='box-footer'>";
                                    ...
                                    if(privStart){
                                        htlm = htlm + "<button class=\"btn btn-primary btnaddgeneral\" onClick=\"javascript:cmdUpdate()\" data-oid=\"0\" data-for=\"showform\" "+startSts+">";
                                            htlm = htlm + "<i class=\"fa fa-star\"></i> Start With Active Update Only";
                                        htlm = htlm + "</button>";
                                    }
                                    
                                     if(privStart){
                                        htlm = htlm + "<button class=\"btn btn-primary btnaddgeneral\" onClick=\"javascript:cmdActive()\" data-oid=\"0\" data-for=\"showform\" "+startSts+">";
                                            htlm = htlm + "<i class=\"fa fa-star\"></i> Start With Active Only";
                                        htlm = htlm + "</button>";
                                    }
                                ...
                                String cabangBelumApprove = PstPeriodeCabang.getStringCabangOpen("dpc."+PstPeriodeCabang.fieldNames[PstPeriodeCabang.FLD_STATUS]+"=0 AND dpc."+PstPeriodeCabang.fieldNames[PstPeriodeCabang.FLD_PERIODE_ID]+"='"+periodeId+"'");
                                htlm = htlm + "<div class='box-body'>";
                                htlm = htlm + "<div class='row'>";
                                htlm = htlm + "<div class='col-md-12'>";
                                htlm = htlm + "<b>Proses Delimited Text Belum Bisa di Lakukan, Data Belum Semua di Approve di Cabang</b>";
                                htlm = htlm + "<br><b>"+cabangBelumApprove+"</b>";
                                htlm = htlm + " </div>";
                                htlm = htlm + "</div>";
                                htlm = htlm + " </div>";
                            }    
