...
//                }
    ...
    public String showForm2(HttpServletRequest request){
        Kredit kreditValidasi = new Kredit();
        Kredit kredit = new Kredit();
        ...
        //kode compliment mandatory
        String kodesebabmacet="";
        String tglsebabmacet="";
        String bakiDebet="";
        String sJumlHariTunggakan="";
        String sBaruPerpanjang="";
        String sFrekuensiResturk="";
        if(oid != 0){
            
            try {
                kreditValidasi = PstKredit.fetchExc(oid);
                kredit = (Kredit) kredit.getValidasiDetail(kreditValidasi);
            } catch (Exception e) {
                String returnData = "alert('Terjadi Kesalahan "+e.getStackTrace()+"')";
                e.printStackTrace();
            }
            ...
            if(kredit.getKodeKolektibilitas()!=null){
                if(kredit.getKodeKolektibilitas().equals("5")){
                        kodesebabmacet=kredit.getValidasikodeSebabMacet();///"data-required='required'";
                        tglsebabmacet=kredit.getValidasitglMacet();//"data-required='required'";
                }
            }
            
            if(kredit.getValidasibakiDebet().equals("")){
                bakiDebet = Formater.formatNumber(kredit.getBakiDebet(),"###,###,##0");
            }
            
            if(kredit.getValidasijmlHariTunggakan().equals("")){
                sJumlHariTunggakan = ""+kredit.getJmlHariTunggakan();
            }
            
            if(kredit.getValidasibaruPerpanjangan().equals("")){
                sBaruPerpanjang = ""+kredit.getBaruPerpanjangan();
            }
            
            if(kredit.getValidasifrekuensiRestrukturisasi().equals("")){
                sFrekuensiResturk = ""+kredit.getFrekuensiRestrukturisasi();
            }
	...
	+ "<div class='row'>"
		...
		+ "<div class='form-horizontal' style='padding:10px;background:#fff;border:5px solid #f1f1f1;'>"
			...
			+ "<div class='col-sm-8'>"
				...
				+ "<input type='text' class='form-control datepicker' name='"+ FrmKredit.fieldNames[FrmKredit.FRM_FLD_TGL_AKAD_AWAL] +"' id='"+ FrmKredit.fieldNames[FrmKredit.FRM_FLD_TGL_AKAD_AWAL] +"' value='"+tglAkadAwal+"' "+kredit.getValidasitglAkadAwal()+"  data-type='text' data-error-message='"+FrmKredit.fieldError[FrmKredit.FRM_FLD_TGL_AKAD_AWAL]+"'>"
				+ "<div class='input-group-addon'>"
				    + "<i class='fa fa-calendar'></i>"
				+ "</div>"
			    + "</div>"
			+ "</div> <i style='color:red'>"+kredit.getErrortglAkadAwal()+"</i>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>"
			    + "<div class='input-group'>"
				+ "<input type='text' class='form-control datepicker' name='"+ FrmKredit.fieldNames[FrmKredit.FRM_FLD_TGL_AKAD_AKHIR] +"' id='"+ FrmKredit.fieldNames[FrmKredit.FRM_FLD_TGL_AKAD_AKHIR] +"' value='"+tglAkadAkhir+"' "+kredit.getValidasitglAkadAkhir() +" data-type='text' data-error-message='"+FrmKredit.fieldError[FrmKredit.FRM_FLD_TGL_AKAD_AKHIR]+"'>"
				+ "<div class='input-group-addon'>"
				    + "<i class='fa fa-calendar'></i>"
				+ "</div>"
			    + "</div>"
			+ "</div> <i style='color:red'>"+kredit.getErrortglAkadAkhir()+"</i>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>"
				...
				+ "</div>"
			    + "</div>"
			+ "</div><i style='color:red'>"+kredit.getErrortglAwal()+"</i>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>";
			        //start comboBox
                                ...
                                returnData += ControlCombo.draw(""+FrmKredit.fieldNames[FrmKredit.FRM_FLD_TAKEOVER], null, ""+kredit.getTakeover(), valueCdTakeOver, keyCdTakeOver, "onchange=\"javascript:changeFunc();\"  "+kredit.getValidasitakeover()+" data-type='text' data-error-message='"+FrmKredit.fieldError[FrmKredit.FRM_FLD_TAKEOVER]+"'", "form-control");
                                returnData += "</div>"
                                //end comboBox
		    + "</div>"
		+ "</div>"
		...
		+ "<div class='form-horizontal' style='padding:10px;background:#fff;border:5px solid #f1f1f1;'>"
			...
			+ "<div class='col-sm-8'>"
			    + "<input type='text' class='form-control numeric' name='"+ FrmKredit.fieldNames[FrmKredit.FRM_FLD_BAKI_DEBET] +"' id='"+ FrmKredit.fieldNames[FrmKredit.FRM_FLD_BAKI_DEBET] +"' value='"+bakiDebet+"' data-required='required' data-number='true' data-alpha='false' data-special='' data-type='text' data-error-message='"+FrmKredit.fieldError[FrmKredit.FRM_FLD_BAKI_DEBET]+"'>"
			+ "</div>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>"
			    + "<input type='text' class='form-control' name='"+ FrmKredit.fieldNames[FrmKredit.FRM_FLD_JML_HARI_TUNGGAKAN] +"' id='"+ FrmKredit.fieldNames[FrmKredit.FRM_FLD_JML_HARI_TUNGGAKAN] +"' value='"+sJumlHariTunggakan+"' data-required='required' data-number='true' data-alpha='false' data-special='' data-type='text' data-error-message='"+FrmKredit.fieldError[FrmKredit.FRM_FLD_JML_HARI_TUNGGAKAN]+"'>"
			+ "</div><i style='color:red'>"+kredit.getErrorjmlHariTunggakan()+"</i>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>"
			    + "<input type='text' class='form-control' name='"+ FrmKredit.fieldNames[FrmKredit.FRM_FLD_FREKUENSI_RESTRUKTURISASI] +"' id='"+ FrmKredit.fieldNames[FrmKredit.FRM_FLD_FREKUENSI_RESTRUKTURISASI] +"' value='"+sFrekuensiResturk+"' "+kredit.getValidasifrekuensiRestrukturisasi()+" data-number='true' data-alpha='false' data-special='' data-type='text' data-error-message='"+FrmKredit.fieldError[FrmKredit.FRM_FLD_FREKUENSI_RESTRUKTURISASI]+"'>"
			+ "</div><i style='color:red'>"+kredit.getErrorfrekuensiRestrukturisasi()+"</i>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>"
			    + "<div class='input-group'>"
				+ "<input type='text' class='form-control datepicker' name='"+ FrmKredit.fieldNames[FrmKredit.FRM_FLD_TGL_RESTRUKTURISASI_AWAL] +"' id='"+ FrmKredit.fieldNames[FrmKredit.FRM_FLD_TGL_RESTRUKTURISASI_AWAL] +"' value='"+tglRestrukturisasiAwal+"'  data-type='text' "+kredit.getValidasitglRestrukturisasiAwal()+" data-error-message='"+FrmKredit.fieldError[FrmKredit.FRM_FLD_TGL_RESTRUKTURISASI_AWAL]+"'>"
				+ "<div class='input-group-addon'>"
				    + "<i class='fa fa-calendar'></i>"
				+ "</div>"
			    + "</div><i style='color:red'>"+kredit.getErrortglRestrukturisasiAwal()+"</i>"
			+ "</div>"
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
			...
			+ "<div class='col-sm-8'>";
                                ...
                                returnData += ControlCombo.draw(""+FrmKredit.fieldNames[FrmKredit.FRM_FLD_KODE_CARA], null, ""+kredit.getKodeCara(), valueCdCara, keyCdCara, " onchange=\"javascript:changeFunc();\" "+kredit.getValidasikodeCara()+" data-type='text' data-error-message='"+FrmKredit.fieldError[FrmKredit.FRM_FLD_KODE_CARA]+"'", "form-control");
                                returnData += "</div> <i style='color:red'>"+kredit.getErrorkodeCara()+"</i>"
                                //end comboBox
		    + "</div>"
		    + "<div class='form-group'>"
			+ "<label class='control-label col-sm-4'>"
