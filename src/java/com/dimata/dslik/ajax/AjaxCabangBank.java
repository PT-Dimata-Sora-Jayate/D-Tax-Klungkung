        ...
        String returnData = ""
            + "<div class='row'>"
                + "<div class='col-md-12'>"
                    ...
                    + "</div>"
                    + "<div class='form-group'>"
                        + "<label>Kode Parent Cabang Bank</label>"
                        + "<input type='text' class='form-control' name='" + FrmCabangBank.fieldNames[FrmCabangBank.FRM_FIELD_PARENT_KODE] + "' value='" + cabangBank.getKodeParentCabang()+ "'>"
                    + "</div>"
                + "</div>"
            + "</div>";
