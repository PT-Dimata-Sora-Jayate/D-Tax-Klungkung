...
public class PstAppUserWP extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final String TBL_APPUSERWP_PHR_H = "view_user_update_pass";
    ...
    public static int findLimitCommand(int start, int recordToGet, int vectSize) {
     ...
     public static int updateNewPasswordPhrH(String userId, String currentPass, String newPass) throws DBException {
        DBResultSet dbrs = null;
        int result=1;
        try {
            String sql = "UPDATE " + TBL_APPUSERWP_PHR_H + " SET " +
                    fieldNames[FLD_PASSWORD] + " = '" + newPass +"'"+
                    " WHERE " +fieldNames[FLD_NPWPD] +" = '" + userId+"'";
            int Result = DBHandler.execUpdate(sql);
