...
public class Formater {
    ...
    public static String formatNumberNew(double number, String format) {
        DecimalFormatSymbols dfs = new DecimalFormatSymbols();
        dfs.setDecimalSeparator(SYSTEM_DECIMAL_SYMBOL.charAt(0));
        dfs.setGroupingSeparator(SYSTEM_DIGIT_GROUP.charAt(0));
    ...
    */
    ...
    public static String formatNumberNoDecimal(double d) {
        ...
        try{
//            if(d == (long) d){
//                //nilai =  String.format("%d",(long)d);
//                nilai = String.format("%d",d);
//            }else{
//                nilai = String.format("%d",d);
//            }
               double nilaiPembulatan = Math.round(d);
              nilai = formatNumber(nilaiPembulatan, "###");
        }catch(Exception ex){
            nilai="0";
        }
        return nilai;
    ...
    public static String formatNumberWithDecimal(double d) {
        String nilai="0";
        try{
//            if(d == (long) d){
//                //nilai =  String.format("%d",(long)d);
