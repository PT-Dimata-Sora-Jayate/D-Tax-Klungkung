...
public class DBHandler implements I_DBType {
    ...
    public static String CONFIG_FILE = com.dimata.RootClass.getThisClassPath()+
            System.getProperty("file.separator") + "pos.xml";
    ...
    public static final int DBSVR_TYPE  = AppSetting.SQL_VERSION;  // this is a DB Handler for MySQL
    
    protected static String connLog = "tmsconn.log";
    protected static String dbDriver = "com.mysql.jdbc.Driver";
    protected static String dbUrl = "jdbc:mysql://mysql/lascolonias";
    protected static String dbUser = "lascolonias";
    protected static String dbPwd = "WRFO1JlX";
    ...
    throws DBException {
        ...
        if(connPool == null)
            try {
                connPool = new DBConnectionBroker(dbDriver, dbUrl, dbUser, dbPwd, dbMinConn, dbMaxConn + 1, connLog, 0.1D);
            }
            catch(Exception _ex) {
    ...
    /**
     * Handle to data value of null
     * written by Mirahu, modified by ktanjana
     * 20111013
     * @param i
     * @return
     * @throws DBException
    ...
    public int getIntAllowNull(int i)
    throws DBException {
        try {
            NumberFormat numberformat = NumberFormat.getNumberInstance();
            Object obj = getObject(i);
...
//            }
    ...
    throws DBException {
        ...
        try {
            ...
            //System.out.println("update sql : " + getUpdateSQL());
            //dbLog.info("Execute updateSQL: " + getUpdateSQL());
    ...
    public static DBResultSet execQueryResultNew(String sql)
